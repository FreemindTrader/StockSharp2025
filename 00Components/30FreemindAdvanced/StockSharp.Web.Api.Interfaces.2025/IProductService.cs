...
using Client = StockSharp.Web.DomainModel.Client;
...
namespace StockSharp.Web.Api.Interfaces
{
    public interface IProductService : IBaseEntityService<Product>
    {
        ...
        Task AddReleaseNotesAsync( (long productId, string version, string text) [ ] releaseNotes, CancellationToken cancellationToken = default( CancellationToken ) );
        ...
        Task<string> OpenAccountAsync(
          long domainId,
          long productId,
          CancellationToken cancellationToken = default( CancellationToken ) );

        Task<Product> GetProductByUrlPartAsync(
          string urlPart,
          CancellationToken cancellationToken = default( CancellationToken ) );
