...
// Type: StockSharp.Web.Api.Interfaces.IStrategyParamService
...
{
    public interface IStrategyParamService : IBaseEntityService<StrategyParam>
    {
        Task<BaseEntitySet<StrategyParam>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
