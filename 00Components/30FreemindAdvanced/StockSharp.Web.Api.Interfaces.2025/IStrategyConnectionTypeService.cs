...
// Type: StockSharp.Web.Api.Interfaces.IStrategyConnectionTypeService
...
{
    public interface IStrategyConnectionTypeService : IBaseEntityService<StrategyConnectionType>
    {
        Task<BaseEntitySet<StrategyConnectionType>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
