...
// Type: StockSharp.Web.Api.Interfaces.ISocialTokenService
...
{
    public interface ISocialTokenService : IBaseEntityService<SocialToken>
    {
        Task<BaseEntitySet<SocialToken>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
