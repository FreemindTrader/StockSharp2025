...
// Type: StockSharp.Web.Api.Interfaces.IDynamicMenuGroupService
...
{
    public interface IDynamicMenuGroupService : IBaseEntityService<DynamicMenuGroup>
    {
        Task<BaseEntitySet<DynamicMenuGroup>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
