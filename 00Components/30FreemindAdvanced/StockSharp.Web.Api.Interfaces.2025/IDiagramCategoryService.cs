...
// Type: StockSharp.Web.Api.Interfaces.IDiagramCategoryService
...
{
    public interface IDiagramCategoryService : IBaseEntityService<DiagramCategory>
    {
        Task<BaseEntitySet<DiagramCategory>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
