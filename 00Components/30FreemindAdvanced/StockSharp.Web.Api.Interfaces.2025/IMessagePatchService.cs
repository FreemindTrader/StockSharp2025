...
// Type: StockSharp.Web.Api.Interfaces.IMessagePatchService
...
{
    public interface IMessagePatchService : IBaseEntityService<MessagePatch>
    {
        Task<BaseEntitySet<MessagePatch>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
