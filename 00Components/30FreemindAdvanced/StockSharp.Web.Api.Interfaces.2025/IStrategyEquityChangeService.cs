...
// Type: StockSharp.Web.Api.Interfaces.IStrategyEquityChangeService
...
{
    public interface IStrategyEquityChangeService : IBaseEntityService<StrategyEquityChange>
    {
        Task<BaseEntitySet<StrategyEquityChange>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
