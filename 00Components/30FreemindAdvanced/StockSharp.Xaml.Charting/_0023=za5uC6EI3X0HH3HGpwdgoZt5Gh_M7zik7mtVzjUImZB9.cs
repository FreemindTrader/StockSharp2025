  ...
  \u0023\u003DziARJyOecclYiJO5UbZqQJ8tTDgXi4mHI9\u0024dB3n962FPd
{
    ...
    IComparable _param2)
  {
    ...
    if (lqkdKbY6smnsRhNQalw.HasExponent)
    {
      ...
      lqkdKbY6smnsRhNQalw.Separator = mrfV9Sq7FuggeEjd.ScientificNotation == \u0023\u003Dz9V3XmNblPtIESO78oE\u0024lpcGozNFuVHzTBvU7g3nrOy\u0024a.Normalized ? \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539337168) : text[num].ToString((IFormatProvider) CultureInfo.InvariantCulture);
    }
  ...
  {
    string str = string.Format(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539430209) + _param1 + \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539430223), (object) _param0);
    if (StringHelper.IsEmpty(str) && _param0 is double num)
      str = ((Decimal) num).ToString(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539337869));
    return str;
  }

  public override string \u0023\u003DzkqN2vZ4\u003D(IComparable _param1)
  {
    return string.Format(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539430209) + this.\u0023\u003DzHZDgUSdfqmkx().get_TextFormatting() + \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539430223), (object) _param1);
  }
}
