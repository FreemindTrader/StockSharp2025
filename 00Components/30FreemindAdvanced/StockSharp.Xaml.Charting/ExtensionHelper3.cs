...
internal static class ExtensionHelper3
{
  ...
  public static Color \u0023\u003Dz3XFp9f4\u003D(this object _param0)
  {
    switch (_param0)
    {
      ...
      default:
        ...
        return Color.FromArgb(settingsStorage.GetValue<byte>("", (byte) 0), settingsStorage.GetValue<byte>("", (byte) 0), settingsStorage.GetValue<byte>("", (byte) 0), settingsStorage.GetValue<byte>("", (byte) 0));
    }
  }
  ...
  public static SettingsStorage SaveBrush(this Brush myBrush)
  {
    ...
    if (!(myBrush is SolidColorBrush solidColorBrush))
    {
      if (!(myBrush is LinearGradientBrush linearGradientBrush))
      {
        ...
        settingsStorage.SetValue<SettingsStorage[]>("", radialGradientBrush.GradientStops.\u0023\u003Dzpns3ZB6WZd\u00243Lc\u0024VVA\u003D\u003D());
      ...
      else
      {
        ...
        settingsStorage.SetValue<SettingsStorage[]>("", linearGradientBrush.GradientStops.\u0023\u003Dzpns3ZB6WZd\u00243Lc\u0024VVA\u003D\u003D());
      }
    }
    else
    {
  ...
  public static Brush \u0023\u003DzMlbK6H8\u003D(this SettingsStorage _param0)
  {
    ...
    if (actualValue == typeof (SolidColorBrush))
    {
      ...
      solidColorBrush.Color = _param0.GetValue<object>("", (object) null).\u0023\u003Dz3XFp9f4\u003D();
    ...
    if (actualValue == typeof (LinearGradientBrush))
    {
      ...
      linearGradientBrush.\u0023\u003DzsPT8Hz9P\u0024YcS(_param0.GetValue<IEnumerable<SettingsStorage>>("", (IEnumerable<SettingsStorage>) null));
    ...
    radialGradientBrush.\u0023\u003DzsPT8Hz9P\u0024YcS(_param0.GetValue<IEnumerable<SettingsStorage>>("", (IEnumerable<SettingsStorage>) null));
    ...
    IEnumerable<SettingsStorage> _param1)
  {
    ...
    {
      Color color = settingsStorage.GetValue<object>("", (object) null).\u0023\u003Dz3XFp9f4\u003D();
  ...
  {
    return new Thickness(_param0.GetValue<double>("", 0.0), _param0.GetValue<double>("", 0.0), _param0.GetValue<double>("", 0.0), _param0.GetValue<double>("", 0.0));
  }

  public static SettingsStorage SaveBrush(this Thickness _param0)
  {
    return new SettingsStorage().Set<double>("", _param0.Left).Set<double>("", _param0.Top).Set<double>("", _param0.Right).Set<double>("", _param0.Bottom);
  }
