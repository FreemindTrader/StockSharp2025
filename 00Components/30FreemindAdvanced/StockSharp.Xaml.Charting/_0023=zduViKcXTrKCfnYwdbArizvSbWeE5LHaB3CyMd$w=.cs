  ...
  \u0023\u003DzjIfS4CbXGFDPWmVOPAZGmt9VmM5IkN_VTVwybkk\u003D
{
  ...
  public void \u0023\u003DzeHF6BUxLFClh(ResourceDictionary _param1)
  {
    ...
    this.GridBorderBrush = (Brush) _param1[(object) ""];
    this.GridBackgroundBrush = (Brush) _param1[(object) ""];
    this.UltrachartBackground = (Brush) _param1[(object) ""];
    this.TickTextBrush = (Brush) _param1[(object) ""];
    this.MajorGridLinesBrush = (Brush) _param1[(object) ""];
    this.MinorGridLinesBrush = (Brush) _param1[(object) ""];
    this.RolloverLineStroke = (Brush) _param1[(object) ""];
    this.RolloverLabelBorderBrush = (Brush) _param1[(object) ""];
    this.RolloverLabelBackgroundBrush = (Brush) _param1[(object) ""];
    this.DefaultCandleUpWickColor = (Color) _param1[(object) ""];
    this.DefaultCandleDownWickColor = (Color) _param1[(object) ""];
    this.DefaultCandleUpBodyBrush = (Brush) _param1[(object) ""];
    this.DefaultCandleDownBodyBrush = (Brush) _param1[(object) ""];
    this.DefaultColumnOutlineColor = (Color) _param1[(object) ""];
    this.DefaultColumnFillBrush = (Brush) _param1[(object) ""];
    this.DefaultLineSeriesColor = (Color) _param1[(object) ""];
    this.DefaultMountainAreaBrush = (Brush) _param1[(object) ""];
    this.DefaultMountainLineColor = (Color) _param1[(object) ""];
    this.DefaultColorMapBrush = (Brush) _param1[(object) ""];
    this.DefaultDownBandFillColor = (Color) _param1[(object) ""];
    this.DefaultUpBandFillColor = (Color) _param1[(object) ""];
    this.DefaultUpBandLineColor = (Color) _param1[(object) ""];
    this.DefaultDownBandLineColor = (Color) _param1[(object) ""];
    this.RubberBandFillBrush = (Brush) _param1[(object) ""];
    this.RubberBandStrokeBrush = (Brush) _param1[(object) ""];
    this.CursorLabelForeground = (Brush) _param1[(object) ""];
    this.CursorLabelBackgroundBrush = (Brush) _param1[(object) ""];
    this.CursorLabelBorderBrush = (Brush) _param1[(object) ""];
    this.CursorLineBrush = (Brush) _param1[(object) ""];
    this.OverviewFillBrush = (Brush) _param1[(object) ""];
    this.ScrollbarFillBrush = (Brush) _param1[(object) ""];
    this.LegendBackgroundBrush = (Brush) _param1[(object) ""];
    this.DefaultTextAnnotationBackground = (Brush) _param1[(object) ""];
    this.DefaultTextAnnotationForeground = (Brush) _param1[(object) ""];
    this.DefaultAxisMarkerAnnotationBackground = (Brush) _param1[(object) ""];
    this.DefaultAxisMarkerAnnotationForeground = (Brush) _param1[(object) ""];
    this.AxisBandsFill = (Color) _param1[(object) ""];
    this.BoxVolumeTimeframe2Color = (Color) _param1[(object) ""];
    this.BoxVolumeTimeframe2FrameColor = (Color) _param1[(object) ""];
    this.BoxVolumeTimeframe3Color = (Color) _param1[(object) ""];
    this.BoxVolumeCellFontColor = (Color) _param1[(object) ""];
    this.BoxVolumeHighVolColor = (Color) _param1[(object) ""];
    this.ClusterProfileSeparatorLineColor = (Color) _param1[(object) ""];
    this.ClusterProfileLineColor = (Color) _param1[(object) ""];
    this.ClusterProfileTextColor = (Color) _param1[(object) ""];
    this.ClusterProfileClusterColor = (Color) _param1[(object) ""];
    this.ClusterProfileClusterMaxColor = (Color) _param1[(object) ""];
  }
  ...
  public Color BoxVolumeTimeframe2Color
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003DzIofb0iw4SlBVjCJ8eVV0YUNsdp2B, value, "");
    }
  }
  ...
  public Color BoxVolumeTimeframe2FrameColor
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003DzcIz1D66ueGH4ksNMfPW2YZTA7NHC, value, "");
    }
  }
  ...
  public Color BoxVolumeTimeframe3Color
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003DzlzAfzI2VYa0KbIVncvBFXBt36bnV, value, "");
    }
  }
  ...
  public Color BoxVolumeCellFontColor
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003Dz8cVhrEgqpp0yBk9Chw\u003D\u003D, value, "");
    }
  }
  ...
  public Color BoxVolumeHighVolColor
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003DzK\u0024_HFKxIyVRF7UOjjQ\u003D\u003D, value, "");
    }
  }
  ...
  public Color ClusterProfileSeparatorLineColor
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003Dz8irkkLlHyMoYrRC8ONqJmOU\u003D, value, "");
    }
  }
  ...
  public Color ClusterProfileLineColor
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003DzKreKVOTT14wmqVT4SJblWBI\u003D, value, "");
    }
  }
  ...
  public Color ClusterProfileTextColor
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003Dzi7gMwBaEi25hMUFE1Zcyejk\u003D, value, "");
    }
  }
  ...
  public Color ClusterProfileClusterColor
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003DzGUo7xQ0pG5bHr76JuUCiQKQ\u003D, value, "");
    }
  }
  ...
  public Color ClusterProfileClusterMaxColor
  {
    ...
    set
    {
      this.\u0023\u003DzwGPLgl8\u003D<Color>(ref this.\u0023\u003DzCQBrhh\u0024vUP6E80YOsyu6M38\u003D, value, "");
    }
  }
}
