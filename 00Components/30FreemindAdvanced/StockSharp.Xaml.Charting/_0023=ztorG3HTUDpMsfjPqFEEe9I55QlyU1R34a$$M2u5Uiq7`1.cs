...
#nullable disable
internal sealed class \u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T> : 
  \u0023\u003DzBQI7r_wiRKcCdd7zOgb7xAm_Ca5jQWV7qTLlcbbCsg9V98qcX3BV8d1LwxB\u0024<ChartBandElement>
  where T : struct, IComparable
{
  
  private readonly \u0023\u003DzpKvy0OA0_My0Sg27HiUJaXC_MvbCQSSYY52HUUP8Kgkq<T, double> \u0023\u003DzDh1lJfFlHUWk;
  
  private readonly \u0023\u003DzdPAQRlt3VWWvvKbSPLZ0IV6_IiM70jMp5uwjMXR4ajr_<T, double> \u0023\u003Dzva\u002460XCiLL2n;
  
  private readonly \u0023\u003DzdPAQRlt3VWWvvKbSPLZ0IV6_IiM70jMp5uwjMXR4ajr_<T, double> \u0023\u003DzRSDkBpQ1QWG0;
    ...
    : base(_param1)
  {
    ...
    this.\u0023\u003DzDh1lJfFlHUWk = new \u0023\u003DzpKvy0OA0_My0Sg27HiUJaXC_MvbCQSSYY52HUUP8Kgkq<T, double>();
    this.\u0023\u003Dzva\u002460XCiLL2n = new \u0023\u003DzdPAQRlt3VWWvvKbSPLZ0IV6_IiM70jMp5uwjMXR4ajr_<T, double>();
    this.\u0023\u003DzRSDkBpQ1QWG0 = new \u0023\u003DzdPAQRlt3VWWvvKbSPLZ0IV6_IiM70jMp5uwjMXR4ajr_<T, double>();
  }
  ...
  protected override void \u0023\u003DzY0x9JtY\u003D()
  {
    ...
    \u0023\u003DzBQI7r_wiRKcCdd7zOgb7xAm_Ca5jQWV7qTLlcbbCsg9V98qcX3BV8d1LwxB\u0024<ChartBandElement>.\u0023\u003Dz9tL3mkpMz5PJ<DrawStyles>((IfxChartElement) this.\u0023\u003DzeaszzAAoBOY9().Line1, "", drawStylesArray);
    \u0023\u003DzBQI7r_wiRKcCdd7zOgb7xAm_Ca5jQWV7qTLlcbbCsg9V98qcX3BV8d1LwxB\u0024<ChartBandElement>.\u0023\u003Dz9tL3mkpMz5PJ<DrawStyles>((IfxChartElement) this.\u0023\u003DzeaszzAAoBOY9().Line2, "", drawStylesArray);
    string[] strArray = new string[2]
    {
      "",
      ""
    };
    this.GetParentVM().\u0023\u003Dzfc4TzKM\u003D(this.\u0023\u003Dzh0ozsIDILK5b = new \u0023\u003Dza5uC6EI3X0HH3HGpwdgoZvdCgmE37pS0x\u0024GHuPMdKXH0icPdKkp5z7HSJCOy((INotifyPropertyChanged) this.\u0023\u003DzeaszzAAoBOY9().Line1, new Func<\u0023\u003DzYH1zUE63H2wnu5PkgVdj8C0KCtI6r27_gg\u003D\u003D, Color>(this.\u0023\u003Dzgl15kO2PtK5giK8GzTIwj08\u003D), \u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T>.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzQKnO3tXJvatO0gqnsg\u003D\u003D ?? (\u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T>.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzQKnO3tXJvatO0gqnsg\u003D\u003D = new Func<\u0023\u003DzYH1zUE63H2wnu5PkgVdj8C0KCtI6r27_gg\u003D\u003D, string>(\u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T>.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzhxV_97w\u003D.\u0023\u003Dz_kGaLH\u0024IiOuHLLvhkS2WN_s\u003D)), strArray));
    this.GetParentVM().\u0023\u003Dzfc4TzKM\u003D(this.\u0023\u003DzXNWLRaQhQW_0 = new \u0023\u003Dza5uC6EI3X0HH3HGpwdgoZvdCgmE37pS0x\u0024GHuPMdKXH0icPdKkp5z7HSJCOy((INotifyPropertyChanged) this.\u0023\u003DzeaszzAAoBOY9().Line2, new Func<\u0023\u003DzYH1zUE63H2wnu5PkgVdj8C0KCtI6r27_gg\u003D\u003D, Color>(this.\u0023\u003Dz7GRJChTRxjdOfay3RCW2oqs\u003D), \u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T>.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzuwIb9LpQWiX75WO6PQ\u003D\u003D ?? (\u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T>.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzuwIb9LpQWiX75WO6PQ\u003D\u003D = new Func<\u0023\u003DzYH1zUE63H2wnu5PkgVdj8C0KCtI6r27_gg\u003D\u003D, string>(\u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T>.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzhxV_97w\u003D.\u0023\u003DzMUMqMtnuX9rATNeQa7kIAUA\u003D)), strArray));
    this.\u0023\u003DzZcbqdpE\u003D((IfxChartElement) this.\u0023\u003DzeaszzAAoBOY9().Line1);
    this.\u0023\u003DzZcbqdpE\u003D((IfxChartElement) this.\u0023\u003DzeaszzAAoBOY9().Line2);
    ...
    this.\u0023\u003Dz7GhHTEkMkDYT(this.\u0023\u003DzYirGqB2gXz09.RenderSeries, (IfxChartElement) this.\u0023\u003DzeaszzAAoBOY9().Line1, "", "");
    this.\u0023\u003Dz7GhHTEkMkDYT(this.\u0023\u003DzIHjxTqC159pe.RenderSeries, (IfxChartElement) this.\u0023\u003DzeaszzAAoBOY9().Line2, "", "");
  ...
  private void \u0023\u003DzcIqdE4oVd9lsrOCnFSgflME\u003D()
  {
    ...
    xc8MfylkhywkcxaEjd.SetBindings(dje_zHZJUNELMY3BAWUYNNRAVXVEJSHT9V29B8J9F3NL335LNBX9S38NTQ32RC2TS5VYKTNJEX9XC8MFYLKHYWKCXA_ejd.\u0023\u003DzqXdfa4iudfGA, (object) this.\u0023\u003DzeaszzAAoBOY9().Line1, "");
    xc8MfylkhywkcxaEjd.SetBindings(dje_zHZJUNELMY3BAWUYNNRAVXVEJSHT9V29B8J9F3NL335LNBX9S38NTQ32RC2TS5VYKTNJEX9XC8MFYLKHYWKCXA_ejd.\u0023\u003DzJJDbrFb7cXV\u0024, (object) this.\u0023\u003DzeaszzAAoBOY9().Line2, "");
  }
    ...
    \u0023\u003Dza5uC6EI3X0HH3HGpwdgoZvdCgmE37pS0x\u0024GHuPMdKXH0icPdKkp5z7HSJCOy _param3)
  {
    if (!(_param1.RenderSeries is FastLineRenderableSeries mq47Z7V297V2U22Ejd))
    {
      ...
      Binding[] bindingArray = new Binding[3]
      {
        ...
        new Binding("")
        {
          Source = (object) ((IfxChartElement) this.\u0023\u003DzeaszzAAoBOY9()).RootElement
        }
      };
    ...
    where TX1 : struct, IComparable
  {
    ...
    foreach (ChartDrawData.sxTuple<TX1> z6MdlWkBsH4 in (IEnumerable<ChartDrawData.sxTuple<TX1>>) _param1)
    {
      ...
      switch (zulcL8Ra.CompareTo((object) comparable))
      {
        ...
        case 0:
          this.\u0023\u003Dzva\u002460XCiLL2n.\u0023\u003DzFkV86a8\u003D(zulcL8Ra, z6MdlWkBsH4.ValueOne());
          this.\u0023\u003DzRSDkBpQ1QWG0.\u0023\u003DzFkV86a8\u003D(zulcL8Ra, z6MdlWkBsH4.ValueTwo());
          this.\u0023\u003DzDh1lJfFlHUWk.\u0023\u003DzFkV86a8\u003D(zulcL8Ra, z6MdlWkBsH4.ValueOne(), z6MdlWkBsH4.ValueTwo());
          --count;
          break;
        default:
          ++index;
    ...
    this.\u0023\u003Dzva\u002460XCiLL2n.\u0023\u003Dznc8esWY\u003D((IEnumerable<T>) array1, (IEnumerable<double>) array2);
    this.\u0023\u003DzRSDkBpQ1QWG0.\u0023\u003Dznc8esWY\u003D((IEnumerable<T>) array1, (IEnumerable<double>) array3);
    this.\u0023\u003DzDh1lJfFlHUWk.\u0023\u003Dznc8esWY\u003D((IEnumerable<T>) array1, (IEnumerable<double>) array2, (IEnumerable<double>) array3);
  ...
  {
    public static readonly \u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T>.\u0023\u003Dz7qOdpi4\u003D \u0023\u003DzhxV_97w\u003D = new \u0023\u003DztorG3HTUDpMsfjPqFEEe9I55QlyU1R34a\u0024\u0024M2u5Uiq7Pu7_oc1A1JQ8nQQRm<T>.\u0023\u003Dz7qOdpi4\u003D();
