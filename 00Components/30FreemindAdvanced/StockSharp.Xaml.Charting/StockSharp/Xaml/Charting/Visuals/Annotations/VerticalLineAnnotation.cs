...
{
  public new static readonly DependencyProperty VerticalAlignmentProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539427465), typeof (VerticalAlignment), typeof (VerticalLineAnnotation), new PropertyMetadata((object) VerticalAlignment.Stretch, new PropertyChangedCallback(VerticalLineAnnotation.OnVerticalAlignmentChanged)));
  public static readonly DependencyProperty LabelsOrientationProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539440851), typeof (Orientation), typeof (VerticalLineAnnotation), new PropertyMetadata((object) Orientation.Vertical, new PropertyChangedCallback(VerticalLineAnnotation.OnLabelsOrientationChanged)));
