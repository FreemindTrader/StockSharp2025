...
{
  public static readonly DependencyProperty CornerRadiusProperty = DependencyProperty.Register("", typeof (CornerRadius), typeof (BoxAnnotation), new PropertyMetadata((object) new CornerRadius()));
