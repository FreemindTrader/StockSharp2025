...
{
  public static readonly DependencyProperty ShowLabelProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539434314), typeof (bool), typeof (LineAnnotationWithLabelsBase), new PropertyMetadata((object) false, new PropertyChangedCallback(LineAnnotationWithLabelsBase.OnShowLabelChanged)));
  protected internal static readonly DependencyProperty DefaultLabelValueProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539343065), typeof (IComparable), typeof (LineAnnotationWithLabelsBase), new PropertyMetadata((PropertyChangedCallback) null));
  protected static readonly DependencyProperty DefaultTextFormattingProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539430181), typeof (string), typeof (LineAnnotationWithLabelsBase), new PropertyMetadata((PropertyChangedCallback) null));
  public static readonly DependencyProperty LabelPlacementProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539434362), typeof (LabelPlacement), typeof (LineAnnotationWithLabelsBase), new PropertyMetadata((object) LabelPlacement.Auto));
  public static readonly DependencyProperty LabelValueProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539343020), typeof (IComparable), typeof (LineAnnotationWithLabelsBase), new PropertyMetadata((object) null));
  public static readonly DependencyProperty LabelTextFormattingProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539343089), typeof (string), typeof (LineAnnotationWithLabelsBase), new PropertyMetadata((object) string.Empty, new PropertyChangedCallback(LineAnnotationWithLabelsBase.OnLabelTextFormattingChanged)));
  public static readonly DependencyProperty FormattedLabelProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539343087), typeof (string), typeof (LineAnnotationWithLabelsBase), new PropertyMetadata((object) string.Empty));
  public static readonly DependencyProperty AnnotationLabelsProperty = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539342852), typeof (ObservableCollection<dje_zN5RZ9FJPADKV6EEGGFEMB6VJK4MEZ85NW8C52EKQS76HUN2_ejd>), typeof (LineAnnotationWithLabelsBase), new PropertyMetadata(new PropertyChangedCallback(LineAnnotationWithLabelsBase.OnAnnotationLabelsChanged)));
  ...
  protected LineAnnotationWithLabelsBase()
  {
    ...
    Binding binding = new Binding(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539343020))
    {
      Source = (object) this,
  ...
  private void BindDefaultLabelValue()
  {
    ...
    Binding binding1 = new Binding(usedAxis == null || !usedAxis.\u0023\u003DzFrVmckt\u0024NpG6() ? \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539434262) : \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539434477))
    {
      Source = (object) this,
    ...
    if (usedAxis == null)
      return;
    Binding binding2 = new Binding(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539433005))
    {
  ...
  public override void OnApplyTemplate()
  {
    ...
    this.\u0023\u003DzkgqGljJ50Pjey0H53Q\u003D\u003D<Line>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539343005));
  ...
  public dje_zN5RZ9FJPADKV6EEGGFEMB6VJK4MEZ85NW8C52EKQS76HUN2_ejd AddLabel()
  {
    ...
    Binding binding1 = new Binding(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539434362))
    {
      Source = (object) this,
      Mode = BindingMode.OneWay
    };
    c52EkqS76HuN2Ejd.SetBinding(dje_zN5RZ9FJPADKV6EEGGFEMB6VJK4MEZ85NW8C52EKQS76HUN2_ejd.\u0023\u003DzbhlExb5p620n, (BindingBase) binding1);
    Binding binding2 = new Binding(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539342907))
    {
      Source = (object) this,
      Mode = BindingMode.OneWay
    };
