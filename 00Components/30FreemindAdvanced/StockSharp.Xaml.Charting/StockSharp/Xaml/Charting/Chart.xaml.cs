  ...
  IComponentConnector
{
  ...
  public Chart()
  {
    ...
    ucNpCcsOdkLfs7Ks.\u0023\u003DzgE4mCHaKpzj3mF7k57tWsbQ\u003D = new string[7]
    {
      ...
      \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432892),
      \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432879),
      \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432926),
      \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432952),
      \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432941),
      \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432706)
    };
  ...
  /// <summary>Default settings for the candles subscription.</summary>
  public MarketDataMessage DefaultCandlesSettings
  {
    get => this.\u0023\u003DzbEOGQO_Gw5r5YQ6kr3Jalls\u003D;
    set
    {
      this.\u0023\u003DzbEOGQO_Gw5r5YQ6kr3Jalls\u003D = value ?? throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432762));
    }
  }
  ...
  public bool IsAutoScroll
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432741));
    }
  }
  ...
  public bool IsAutoRange
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432796));
    }
  }
  ...
  public TimeSpan AutoRangeInterval
  {
    ...
    set
    {
      this.\u0023\u003Dz9Ee3umvrluGn = !(value <= TimeSpan.Zero) ? value : throw new ArgumentOutOfRangeException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432778), (object) value, LocalizedStrings.InvalidValue);
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432821));
    }
  }
  ...
  public void AddElement(IChartArea area, IChartElement element)
  {
    ...
    if (gncgo1okL0HgWiq5JrU.\u0023\u003Dzy_5REws\u003D == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432813));
    if (gncgo1okL0HgWiq5JrU.\u0023\u003Dz_i6sZDg\u003D == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432092));
  ...
  {
    if (area == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432071));
    if (element == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432078));
    if (subscription == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432121));
  ...
  {
    if (area == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432104));
    if (element == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432147));
    if (indicator == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432154));
    if (subscription != null)
      this.\u0023\u003DzvWHSaOs\u003D.Add((IChartElement) element, subscription);
  ...
  {
    if (area == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432133));
    if (element == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432180));
    if (subscription == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432191));
    this.\u0023\u003DzvWHSaOs\u003D.Add((IChartElement) element, subscription);
    this.AddElement(area, (IChartElement) element);
  }
  ...
  {
    if (area == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432166));
    if (element == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539431953));
    if (subscription == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539431968));
    this.\u0023\u003DzvWHSaOs\u003D.Add((IChartElement) element, subscription);
    this.AddElement(area, (IChartElement) element);
  }
  ...
  void IChart.RemoveElement(IChartArea area, IChartElement element)
  {
    ...
    if (jyDziF55m7JqXuwJc.\u0023\u003Dzy_5REws\u003D == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539431947));
    if (jyDziF55m7JqXuwJc.\u0023\u003Dz_i6sZDg\u003D == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539431986));
  ...
  public void SetSubscription(IChartElement element, Subscription subscription)
  {
    ...
    zvWhSaOs[chartElement] = subscription ?? throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539431997));
  ...
  public bool AutoRangeByAnnotations
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539431980));
    }
  }
  ...
  public bool ShowPerfStats
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432005));
    }
  }
  ...
  public bool CrossHair
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432057));
    }
  }
  ...
  public bool CrossHairTooltip
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432041));
    }
  }
  ...
  public bool CrossHairAxisLabels
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432324));
    }
  }
  ...
  public ChartAnnotationTypes AnnotationType
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432378));
    }
  }
  ...
  public bool OrderCreationMode
  {
    ...
    set
    {
      ...
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432403));
    }
  }
  ...
  public TimeZoneInfo TimeZone
  {
    ...
    set
    {
      if (this.\u0023\u003Dzlm3nxP8O1U6I == value)
        return;
      this.\u0023\u003Dzlm3nxP8O1U6I = value ?? throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432395));
      NotifyPropertyChangedExHelper.Notify<Chart>(this, \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432434));
    }
  }
  ...
  {
    ChartDrawData chartDrawData = data != null ? (ChartDrawData) data : throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432417));
  ...
  {
    this.IsAutoScroll = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432741), this.IsAutoScroll);
    this.IsAutoRange = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432796), this.IsAutoRange);
    this.AutoRangeByAnnotations = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539431980), this.AutoRangeByAnnotations);
    this.ShowOverview = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432432), this.ShowOverview);
    this.ShowLegend = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432195), this.ShowLegend);
    this.CrossHair = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432057), this.CrossHair);
    this.CrossHairTooltip = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432041), this.CrossHairTooltip);
    this.CrossHairAxisLabels = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432324), this.CrossHairAxisLabels);
    this.OrderCreationMode = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432403), this.OrderCreationMode);
    this.TimeZone = Converter.To<TimeZoneInfo>((object) storage.GetValue<string>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432434), (string) null)) ?? this.TimeZone;
    this.ShowPerfStats = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432005), this.ShowPerfStats);
    ...
    object source = storage.GetValue<object>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432244), (object) null);
    if (source == null)
      return;
    if (source is SettingsStorage settingsStorage)
      source = (object) settingsStorage.GetValue<IEnumerable<SettingsStorage>>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432244), (IEnumerable<SettingsStorage>) null);
  ...
  {
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432741), this.IsAutoScroll);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432796), this.IsAutoRange);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539431980), this.AutoRangeByAnnotations);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432432), this.ShowOverview);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432195), this.ShowLegend);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432057), this.CrossHair);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432041), this.CrossHairTooltip);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432324), this.CrossHairAxisLabels);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432403), this.OrderCreationMode);
    storage.SetValue<string>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432434), this.TimeZone?.Id);
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432005), this.ShowPerfStats);
    if (!this.IsInteracted)
      return;
    storage.SetValue<SettingsStorage[]>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432244), this.\u0023\u003Dza1mnh6ythHbd.Select<IChartArea, SettingsStorage>(Chart.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzIUod_Wcpx0QRK1tJ1g\u003D\u003D ?? (Chart.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzIUod_Wcpx0QRK1tJ1g\u003D\u003D = new Func<IChartArea, SettingsStorage>(Chart.\u0023\u003Dz7qOdpi4\u003D.\u0023\u003DzhxV_97w\u003D.\u0023\u003Dzi3wYC00Rk5VQyB\u00247dTCZE2Q\u003D))).ToArray<SettingsStorage>());
  }
  ...
  private void \u0023\u003DzZTljjN6ww\u0024xh(IEnumerable<SettingsStorage> _param1)
  {
    ...
    foreach (SettingsStorage storage in _param1)
    {
      ...
      area.\u0023\u003Dz3ThQNm3rQ1fp().Height = storage.GetValue<double>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432499), double.NaN);
    }
  }
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432256), UriKind.Relative));
  }
  ...
  private void \u0023\u003DzA\u0024Wg8llSgKSoO3igMVHuEmE\u003D()
  {
    ...
    ChartArea area = new ChartArea()
    {
      Title = LocalizedStrings.Panel + \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432316) + (this.\u0023\u003Dza1mnh6ythHbd.Count + 1).ToString()
    };
  ...
  private sealed class \u0023\u003Dz7qOdpi4\u003D
  {
    ...
    internal SettingsStorage \u0023\u003Dzi3wYC00Rk5VQyB\u00247dTCZE2Q\u003D(IChartArea _param1)
    {
      ...
      settingsStorage.SetValue<double>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432499), ((ChartArea) _param1).\u0023\u003Dz3ThQNm3rQ1fp().Height);
  ...
  private sealed class \u0023\u003DzHeEbGncgo1okL0HgWiq5JrU\u003D
  {
    ...
    internal void \u0023\u003Dzo0PvKPRyMKTdyL4L\u0024A\u003D\u003D()
    {
      ...
      if (this.\u0023\u003Dz_i6sZDg\u003D is IChartIndicatorElement zI6sZdg && zI6sZdg.AutoAssignYAxis && this.\u0023\u003DzRRvwDu67s9Rm.\u0023\u003Dz\u0024IReF1JUpHYmGa845Q\u003D\u003D.TryGetValue(zI6sZdg, ref zZq9Hpf12oRwg) && zZq9Hpf12oRwg.Indicator.Measure != IndicatorMeasures.Price)
      {
        ...
        if (!this.\u0023\u003DzRRvwDu67s9Rm.\u0023\u003DzDUXY6MNzkE1e.TryGetValue(key, out stringAndClear))
        {
          DefaultInterpolatedStringHandler interpolatedStringHandler = new DefaultInterpolatedStringHandler(2, 2);
          interpolatedStringHandler.AppendFormatted(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432528));
        ...
        this.\u0023\u003Dz_i6sZDg\u003D.YAxisId = stringAndClear;
      }
  ...
  private sealed class \u0023\u003DzLeQepc5PMlUh44ZxsNBznec\u003D
  {
    ...
    internal void \u0023\u003DzTUl6zvo_PmQZ4TJ2ew\u003D\u003D()
    {
      if (this.\u0023\u003Dzy_5REws\u003D.Chart != null)
        throw new ArgumentException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432512), \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432533));
      if (this.\u0023\u003Dzy_5REws\u003D == null || this.\u0023\u003DzRRvwDu67s9Rm.\u0023\u003Dza1mnh6ythHbd.Contains(this.\u0023\u003Dzy_5REws\u003D))
        throw new ArgumentException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432516));
  ...
  private sealed class \u0023\u003DzZQ9Hpf12oRwg : Disposable
  {
    ...
    public \u0023\u003DzZQ9Hpf12oRwg(
      ...
      IIndicator _param3)
    {
      this.\u0023\u003DzF\u002458l4g\u003D = _param1 ?? throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432552));
      this.\u0023\u003Dz2YSX_Z4\u003D = _param2 ?? throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432851));
      this.\u0023\u003Dz5re6lC2j05\u0024MW0IM5w\u003D\u003D = _param3 ?? throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432858));
