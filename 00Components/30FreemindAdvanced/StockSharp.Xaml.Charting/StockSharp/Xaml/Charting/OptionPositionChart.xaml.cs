...
/// </summary>
/// <summary>OptionPositionChart</summary>
  ...
  IComponentConnector
{
    ...
    set
    {
      ...
      if (this.ShowSeparated)
      {
        foreach (BlackScholes innerModel in (IEnumerable<BlackScholes>) this.\u0023\u003DzN\u0024mcfM0\u003D.InnerModels)
        {
          ...
          ChartLineElement chartLineElement1 = OptionPositionChart.\u0023\u003Dq0HLdWTESvQ6GGDGtNBBTLK5Qq8Y\u0024H3q\u00248gIXe0eWBbj5IK92tA5V4eLCtjG2o_mj(id + \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539437559), Colors.Black);
          ChartLineElement chartLineElement2 = this.ShowExpiration ? OptionPositionChart.\u0023\u003Dq0HLdWTESvQ6GGDGtNBBTLK5Qq8Y\u0024H3q\u00248gIXe0eWBbj5IK92tA5V4eLCtjG2o_mj(id + \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539437540), Colors.SandyBrown) : (ChartLineElement) null;
      ...
      {
        ChartLineElement chartLineElement3 = OptionPositionChart.\u0023\u003Dq0HLdWTESvQ6GGDGtNBBTLK5Qq8Y\u0024H3q\u00248gIXe0eWBbj5IK92tA5V4eLCtjG2o_mj(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539437549), Colors.Black);
        ChartLineElement chartLineElement4 = this.ShowExpiration ? OptionPositionChart.\u0023\u003Dq0HLdWTESvQ6GGDGtNBBTLK5Qq8Y\u0024H3q\u00248gIXe0eWBbj5IK92tA5V4eLCtjG2o_mj(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539437339), Colors.SandyBrown) : (ChartLineElement) null;
  ...
  /// <summary>
  /// The parameter type in the chart. The default is <see cref="F:StockSharp.Algo.Derivatives.BlackScholesGreeks.Premium" />.
  /// </summary>
    ...
    set
    {
      ...
      switch (value)
      {
        ...
        case BlackScholesGreeks.Premium:
          ...
          break;
        default:
          throw new ArgumentOutOfRangeException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539437313));
      }
      this.\u0023\u003DzYanY0A0\u003D = func;
  ...
  public void Load(SettingsStorage storage)
  {
    ...
    this.UseBlackModel = storage.GetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539437373), this.UseBlackModel);
  }
  ...
  public void Save(SettingsStorage storage)
  {
    ...
    storage.SetValue<bool>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539437373), this.UseBlackModel);
  }
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539437393), UriKind.Relative));
  }
  ...
  {
    public OptionPositionChart \u0023\u003DzRRvwDu67s9Rm;
      ...
      RoutedEventArgs _param2)
    {
      ...
      IChartDrawData data2 = this.\u0023\u003DzRRvwDu67s9Rm.\u0023\u003DzO72kpz0\u003D.CreateData();
      data2.Add((IChartAnnotationElement) this.\u0023\u003DzRRvwDu67s9Rm.\u0023\u003Dz_h3U\u0024zi3bxOZ5JXm\u0024A\u003D\u003D, (IAnnotationData) data1);
      this.\u0023\u003DzRRvwDu67s9Rm.\u0023\u003DzO72kpz0\u003D.Draw(data2);
    }
  }
