...
// Type: StockSharp.Xaml.Charting.IndicatorPainters.ZigZagPainter
...
/// <summary>
/// The chart element for <see cref="T:StockSharp.Xaml.Charting.IndicatorPainters.ZigZagPainter" />.
/// </summary>
...
public class ZigZagPainter : BaseChartIndicatorPainter<ZigZag>
{
  ...
  /// <summary>
  /// <see cref="T:StockSharp.Algo.Indicators.ZigZag" /> dots color.
  ///     </summary>
  ...
  {
    base.Load(storage);
    PersistableHelper.Load((IPersistable) this.Part, storage, "");
  }
  ...
  {
    base.Save(storage);
    storage.SetValue<SettingsStorage>("", PersistableHelper.Save((IPersistable) this.Part));
  }
}
