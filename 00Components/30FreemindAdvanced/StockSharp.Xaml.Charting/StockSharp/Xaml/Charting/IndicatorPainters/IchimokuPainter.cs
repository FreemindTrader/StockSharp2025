...
public class IchimokuPainter : BaseChartIndicatorPainter<Ichimoku>
{
  ...
  public IchimokuPainter()
  {
    ...
    chartBandElement.\u0023\u003Dz9i5WbtNpD44L((IChartElement) this.Senkou.Line1, "");
    chartBandElement.\u0023\u003Dz9i5WbtNpD44L((IChartElement) this.Senkou.Line2, "");
  }
  ...
  {
    base.Load(storage);
    PersistableHelper.Load((IPersistable) this.Tenkan, storage, "");
    PersistableHelper.Load((IPersistable) this.Kijun, storage, "");
    PersistableHelper.Load((IPersistable) this.Chinkou, storage, "");
    PersistableHelper.Load((IPersistable) this.Senkou, storage, "");
  }
  ...
  {
    base.Save(storage);
    storage.SetValue<SettingsStorage>("", PersistableHelper.Save((IPersistable) this.Tenkan));
    storage.SetValue<SettingsStorage>("", PersistableHelper.Save((IPersistable) this.Kijun));
    storage.SetValue<SettingsStorage>("", PersistableHelper.Save((IPersistable) this.Chinkou));
    storage.SetValue<SettingsStorage>("", PersistableHelper.Save((IPersistable) this.Senkou));
  }
}
