  ...
  IPersistable
{
  ...
  public IChartIndicatorPainter IndicatorPainter
  {
    ...
    set
    {
      ...
      this.RaisePropertyChanged(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539428532));
    }
  }
  ...
  {
    base.Load(storage);
    SettingsStorage settingsStorage1 = storage.GetValue<SettingsStorage>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539428532), (SettingsStorage) null);
    if (settingsStorage1 == null)
      return;
    Type type = Type.GetType(settingsStorage1.GetValue<string>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539428523), (string) null), false);
    if (type == (Type) null)
      return;
    this.IndicatorPainter.OnDetached();
    ...
    SettingsStorage settingsStorage2 = settingsStorage1.GetValue<SettingsStorage>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539428562), (SettingsStorage) null);
    try
    {
  ...
  {
    storage.SetValue<SettingsStorage>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539428532), PersistableHelper.SaveEntire((IPersistable) this.IndicatorPainter, false));
    base.Save(storage);
  }
