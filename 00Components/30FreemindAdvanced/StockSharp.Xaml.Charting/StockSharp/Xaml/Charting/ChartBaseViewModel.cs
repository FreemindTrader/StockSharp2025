...
public class ChartBaseViewModel : NotifiableObject
{
    ...
    {
        ChartBaseViewModel.SomeClass111 skXz9pb7XdulaJda = new ChartBaseViewModel.SomeClass111();
        ...
        CollectionHelper.SyncDo<SynchronizedDictionary<INotifyPropertyChanged, Dictionary<string, HashSet<string>>>>(this._propertyChangedMap, new Action<SynchronizedDictionary<INotifyPropertyChanged, Dictionary<string, HashSet<string>>>>(skXz9pb7XdulaJda.\u0023\u003DzEvCBk4t2uj_E0g7AMwV\u0024814\u003D));
    }

    private void \u0023\u003DzlNMg8s2tEtQY(object _param1, PropertyChangedEventArgs _param2)
    {
        CollectionHelper.SyncDo<SynchronizedDictionary<INotifyPropertyChanged, Dictionary<string, HashSet<string>>>>(this._propertyChangedMap, new Action<SynchronizedDictionary<INotifyPropertyChanged, Dictionary<string, HashSet<string>>>>(new ChartBaseViewModel.\u0023\u003DzP\u0024K\u0024cmcad6NXc5A8\u0024A\u003D\u003D()
        {
      \u0023\u003DzwM8aRUE\u003D = _param1,
      \u0023\u003Dz1BK01YA\u003D = _param2,
      \u0023\u003DzRRvwDu67s9Rm = this
