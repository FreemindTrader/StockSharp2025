...
#nullable disable
internal sealed class \u0023\u003DzBQI7r_wiRKcCdd7zOgb7xGkBRjz2cANt6prK2mzvoXV0 : 
  \u0023\u003Dz6RuI7w1XIc38iQTeDB5TvWfY_h5S2Y_Vli8ECWL1cMw8VzeOSw\u003D\u003D<dje_zZVEBX5NJ2AQTDXQ94AUTAJRYAXNKUH4NHECKVD8AXF9ZGQ7NBH9KS_ejd>
{
  ...
  internal static \u0023\u003DzBQI7r_wiRKcCdd7zOgb7xGkBRjz2cANt6prK2mzvoXV0 \u0023\u003DzFvAsfEI\u003D()
  {
    ...
    XmlReader _param2)
  {
    ...
    string typeName = _param2[XXX.SSS(-539440768)];
    if (typeName == null)
      return;
    Type type = Type.GetType(typeName);
    _param1.MajorDelta = (IComparable) _param2.\u0023\u003Dzm2nn9hA\u003D(XXX.SSS(-539440752), type);
    _param1.MinorDelta = (IComparable) _param2.\u0023\u003Dzm2nn9hA\u003D(XXX.SSS(-539441053), type);
  }
    ...
    XmlWriter _param2)
  {
    ...
    _param2.WriteAttributeString(XXX.SSS(-539440768), type.\u0023\u003Dzb_Ih6a0\u003D());
    _param2.\u0023\u003DzVjDFK7Q\u003D((object) _param1, XXX.SSS(-539441053));
    _param2.\u0023\u003DzVjDFK7Q\u003D((object) _param1, XXX.SSS(-539440752));
  }
}
