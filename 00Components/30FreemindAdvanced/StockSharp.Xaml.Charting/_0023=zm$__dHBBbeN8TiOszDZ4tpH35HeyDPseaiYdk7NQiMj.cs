...
#nullable disable
internal class \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4tpH35HeyDPseaiYdk7NQiMjk : 
  \u0023\u003DzbcX\u0024ot\u0024Zhy6wUdB9J7NC32XliaaE3r6bFuapa3pO8HOc<double>
{
    ...
    \u0023\u003DzMv9TAT1PEEnC0UeBhCNwDLl9dU6QA5lGfoNJvig\u003D<double> _param2)
  {
    ...
    \u0023\u003DzITX8mZ2jbGEtwuB21HaSb94StZu7BSE7Sw\u003D\u003D.\u0023\u003DzlTskcr4\u003D((IComparable) _param1.Min, "").\u0023\u003DziXfpgk1YpfgIxrtqTA\u003D\u003D((IComparable) _param1.Max, "");
    ...
    double _param3)
  {
    ...
    if (!\u0023\u003DzNCoz_cr7eiA6K6bzw3PTSRjrsuvJB3oFJPVFS7w\u003D.\u0023\u003Dzpz5fd0zg24Kt(num1, _param2))
      num1 = \u0023\u003DzNCoz_cr7eiA6K6bzw3PTSRjrsuvJB3oFJPVFS7w\u003D.\u0023\u003Dz1bwNIVeIfnJ7(num1, _param2);
    double num2 = num1;
    int num3 = 0;
    for (; num1 <= max; num1 = num2 + (double) ++num3 * _param2)
    {
      if (!(\u0023\u003DzNCoz_cr7eiA6K6bzw3PTSRjrsuvJB3oFJPVFS7w\u003D.\u0023\u003Dzpz5fd0zg24Kt(num1, _param3) ^ flag))
        doubleList.Add(num1);
    }
