...
internal static class \u0023\u003Dzm9W_6u1Hb\u0024Y4gq7yl8Gm\u0024wWzGgD7jDDbQYeSb9M\u003D
{
  ...
  {
    return (_param0.Attribute((XName) _param1) ?? throw new InvalidOperationException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439502) + _param1 + \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439529))).Value;
  }

  internal static string \u0023\u003DzOezjA\u0024ae5BcS(this XElement _param0, string _param1)
  {
    return (_param0.Element((XName) _param1) ?? throw new InvalidOperationException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439570) + _param1 + \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439529))).Value;
  }
