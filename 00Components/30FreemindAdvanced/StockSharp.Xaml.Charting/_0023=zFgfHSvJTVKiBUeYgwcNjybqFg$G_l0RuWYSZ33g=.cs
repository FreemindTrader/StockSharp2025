...
internal static class \u0023\u003DzFgfHSvJTVKiBUeYgwcNjybqFg\u0024G_l0RuWYSZ33g\u003D
{
    ...
    bool _param2)
  {
    ...
    switch (_param0)
    {
      ...
      case List<T> _:
        return new \u0023\u003Dz9A9aKbwx17eqF3Yh7gjiWuPneE7x_PdElYKA_LxaZfcJ<T>((T[]) typeof (List<T>).GetField(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439957), BindingFlags.Instance | BindingFlags.NonPublic).GetValue((object) _param0), _param1.Min, num);
      default:
    ...
    bool _param1)
  {
    switch (_param0)
    {
      ...
      case List<T> _:
        return new \u0023\u003Dz9A9aKbwx17eqF3Yh7gjiWuPneE7x_PdElYKA_LxaZfcJ<T>((T[]) typeof (List<T>).GetField(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439957), BindingFlags.Instance | BindingFlags.NonPublic).GetValue((object) _param0));
      default:
  ...
  internal static T[] \u0023\u003Dz1bvQV4SZTWpA<T>(this IList<T> _param0)
  {
    switch (_param0)
    {
      ...
      case List<T> _:
        return (T[]) typeof (List<T>).GetField(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439957), BindingFlags.Instance | BindingFlags.NonPublic).GetValue((object) _param0);
  ...
  {
    if (_param0 == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439986));
    if (_param2 == null)
  ...
  {
    if (_param0 == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439997));
    if (_param2 == null)
      throw new ArgumentNullException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439980));
    ...
    interpolatedStringHandler.AppendLiteral(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439255));
    ...
    interpolatedStringHandler.AppendLiteral(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439297));
    interpolatedStringHandler.AppendFormatted<\u0023\u003DzNCoz_cr7eiA6K6bzw3PTSVworRoy7o1mkb\u0024GDjE\u003D>(_param3);
    interpolatedStringHandler.AppendLiteral(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539439111));
    ...
    where TX : IComparable
  {
    ...
    _param3 = \u0023\u003DzNCoz_cr7eiA6K6bzw3PTSRjrsuvJB3oFJPVFS7w\u003D.\u0023\u003DzOS5Il8E\u003D(_param3, 0, _param1 - 1);
    _param2 = \u0023\u003DzNCoz_cr7eiA6K6bzw3PTSRjrsuvJB3oFJPVFS7w\u003D.\u0023\u003DzOS5Il8E\u003D(_param2, 0, _param1 - 1);
