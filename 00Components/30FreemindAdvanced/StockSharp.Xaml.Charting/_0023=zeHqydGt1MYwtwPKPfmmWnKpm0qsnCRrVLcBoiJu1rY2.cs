...
internal sealed class \u0023\u003DzeHqydGt1MYwtwPKPfmmWnKpm0qsnCRrVLcBoiJu1rY232oMfVr72yIGQA4ay
{
  ...
  public string \u0023\u003Dzz2S8ZCo\u003D(double _param1)
  {
    ...
    foreach (\u0023\u003DzEJoJjwSelM_K3zbmiw1OA8iSu5G6NISegyeaxgatVzJifGI8m8xL_SrGvDY8poU3Mw\u003D\u003D gi8m8xLSrGvDy8poU3Mw in this.\u0023\u003DzNfj_yrlKoHA\u0024)
    {
      ...
      {
        stringBuilder.Append(string.Format("", (object) (gi8m8xLSrGvDy8poU3Mw.\u0023\u003Dz502aPPQqdJZc() * 1000.0)) + "" + string.Format("", (object) (gi8m8xLSrGvDy8poU3Mw.\u0023\u003DzAkyA2braTgIZWO09MwShOIdybNuS() * 1000.0)) + "" + string.Format("", (object) Math.Min(99.99, gi8m8xLSrGvDy8poU3Mw.\u0023\u003Dz502aPPQqdJZc() / _param1 * 100.0)) + "" + string.Format("", (object) (gi8m8xLSrGvDy8poU3Mw.\u0023\u003DzAkyA2braTgIZWO09MwShOIdybNuS() / _param1 * 100.0)) + "" + gi8m8xLSrGvDy8poU3Mw.\u0023\u003DzsLDTRVg\u003D);
