  ...
  IXmlSerializable
{
  ...
  public static readonly DependencyProperty \u0023\u003Dz2Rta\u0024oTnlQkx = DependencyProperty.Register("", typeof (string), typeof (StackedColumnRenderableSeries), new PropertyMetadata((object) "", new PropertyChangedCallback(StackedColumnRenderableSeries.\u0023\u003DzyGQyqAS53k26)));
  
  public static readonly DependencyProperty \u0023\u003Dzj\u0024ZDuobq5\u0024GmruUxggpnzio\u003D = DependencyProperty.Register("", typeof (bool), typeof (StackedColumnRenderableSeries), new PropertyMetadata((object) false));
  
  public static readonly DependencyProperty \u0023\u003DzYrTUOus\u003D = DependencyProperty.Register("", typeof (double), typeof (StackedColumnRenderableSeries), new PropertyMetadata((object) 0.1, new PropertyChangedCallback(BaseRenderableSeries.\u0023\u003Dzmf\u0024vfR3OJQU9)));
  ...
  public static readonly DependencyProperty \u0023\u003Dzj9GlhPUqVKhn = DependencyProperty.Register("", typeof (bool), typeof (StackedColumnRenderableSeries), new PropertyMetadata((object) false, new PropertyChangedCallback(BaseRenderableSeries.\u0023\u003Dzmf\u0024vfR3OJQU9)));
  
  public static readonly DependencyProperty \u0023\u003DzE0CH9XMtyZ7l = DependencyProperty.Register("", typeof (Color), typeof (StackedColumnRenderableSeries), new PropertyMetadata((object) Colors.White));
  
  public static readonly DependencyProperty \u0023\u003DzDFBNGGYX51P8 = DependencyProperty.Register("", typeof (float), typeof (StackedColumnRenderableSeries), new PropertyMetadata((object) 12f));
  
  public static readonly DependencyProperty \u0023\u003DzdeZXVnb310kr = DependencyProperty.Register("", typeof (string), typeof (StackedColumnRenderableSeries), new PropertyMetadata((object) ""));
