...
// Type: -.dje_zF4WA8KVL9RSV2UZFF2V5EQZWBQPKVJE6PUTMY25VEXBHLUR354YKS5CBBMMNFT3Q9T2FQ9MGAU42NRHTNUCHXYFAV93Q_ejd
  ...
  dje_zP6VTXEU8B2YELVEGUZAJ27BBHF7M9YENVCNNCT32898EYMRSJSW3C8HB7ESPM23CV4LS4ST64EQZFBA_ejd
{
  ...
  public static readonly DependencyProperty \u0023\u003DzVvc2lVdKTrj8 = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539433071), typeof (double), typeof (dje_zF4WA8KVL9RSV2UZFF2V5EQZWBQPKVJE6PUTMY25VEXBHLUR354YKS5CBBMMNFT3Q9T2FQ9MGAU42NRHTNUCHXYFAV93Q_ejd), new PropertyMetadata((object) 0.2, new PropertyChangedCallback(dje_zP6VTXEU8B2YELVEGUZAJ27BBHF7M9YENVCNNCT32898EYMRSJSW3C8HB7ESPM23CV4LS4ST64EQZFBA_ejd.\u0023\u003Dzmf\u0024vfR3OJQU9)));
  [DebuggerBrowsable(DebuggerBrowsableState.Never)]
  public static readonly DependencyProperty \u0023\u003DzoiPF1o\u0024bG_HJ = DependencyProperty.Register(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539440382), typeof (Brush), typeof (dje_zF4WA8KVL9RSV2UZFF2V5EQZWBQPKVJE6PUTMY25VEXBHLUR354YKS5CBBMMNFT3Q9T2FQ9MGAU42NRHTNUCHXYFAV93Q_ejd), new PropertyMetadata((object) new SolidColorBrush(Color.FromArgb((byte) 0, (byte) 0, (byte) 0, (byte) 0)), new PropertyChangedCallback(dje_zP6VTXEU8B2YELVEGUZAJ27BBHF7M9YENVCNNCT32898EYMRSJSW3C8HB7ESPM23CV4LS4ST64EQZFBA_ejd.\u0023\u003Dzmf\u0024vfR3OJQU9)));
  [DebuggerBrowsable(DebuggerBrowsableState.Never)]
  ...
  {
    this.DefaultStyleKey = (object) typeof (dje_zF4WA8KVL9RSV2UZFF2V5EQZWBQPKVJE6PUTMY25VEXBHLUR354YKS5CBBMMNFT3Q9T2FQ9MGAU42NRHTNUCHXYFAV93Q_ejd);
  }
  ...
  public virtual double DataPointWidth
  {
    get
    {
      return (double) this.GetValue(dje_zF4WA8KVL9RSV2UZFF2V5EQZWBQPKVJE6PUTMY25VEXBHLUR354YKS5CBBMMNFT3Q9T2FQ9MGAU42NRHTNUCHXYFAV93Q_ejd.\u0023\u003DzVvc2lVdKTrj8);
    }
    set
    {
      this.SetValue(dje_zF4WA8KVL9RSV2UZFF2V5EQZWBQPKVJE6PUTMY25VEXBHLUR354YKS5CBBMMNFT3Q9T2FQ9MGAU42NRHTNUCHXYFAV93Q_ejd.\u0023\u003DzVvc2lVdKTrj8, (object) value);
    }
  }
  ...
  public Brush BodyBrush
  {
    get
    {
      return (Brush) this.GetValue(dje_zF4WA8KVL9RSV2UZFF2V5EQZWBQPKVJE6PUTMY25VEXBHLUR354YKS5CBBMMNFT3Q9T2FQ9MGAU42NRHTNUCHXYFAV93Q_ejd.\u0023\u003DzoiPF1o\u0024bG_HJ);
    }
    set
    {
      this.SetValue(dje_zF4WA8KVL9RSV2UZFF2V5EQZWBQPKVJE6PUTMY25VEXBHLUR354YKS5CBBMMNFT3Q9T2FQ9MGAU42NRHTNUCHXYFAV93Q_ejd.\u0023\u003DzoiPF1o\u0024bG_HJ, (object) value);
    }
  }
  ...
  {
    return (\u0023\u003DzYH1zUE63H2wnu5PkgVdj8C0KCtI6r27_gg\u003D\u003D) new \u0023\u003Dz3RRntx4pzkd854dIVpLK6S_EKy\u0024AtkpA9s\u0024N3N0\u003D((\u0023\u003DzA\u0024A4W5SfT\u0024DiuyUN7UYciXZRQS6mpDuG09xUExO4eQukbot9S1JOL\u0024YRWoYpqmQ6ug\u003D\u003D) this, _param1);
  }
    ...
    \u0023\u003Dz0w5QTi_Hwx2Q\u0024WqRdQ\u0024aZaScol6ORWm4rPwbPViMZ4rNexJsSmCJpOM\u003D _param2)
  {
    ...
    double num1 = 0.0;
    this.\u0023\u003Dzz7UraMUVt1cf<\u0023\u003Dzs5PVP76t9JCEogjKMLIN9W\u0024EMs7d6n8LMrq66EFixVuy>(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539340342));
