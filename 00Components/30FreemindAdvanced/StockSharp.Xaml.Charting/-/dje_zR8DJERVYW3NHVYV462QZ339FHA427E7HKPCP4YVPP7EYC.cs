  ...
  MarkupExtension
{
  ...
  {
    if (!(_param1.GetService(typeof (IProvideValueTarget)) is IProvideValueTarget service) || service.TargetObject.GetType().Name == \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539441826))
      return (object) this;
    ...
    if (!(service.TargetObject is DependencyObject targetObject))
      throw new Exception(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539441873));
