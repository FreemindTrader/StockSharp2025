  ...
  \u0023\u003DzBQI7r_wiRKcCdd7zOgb7xAm_Ca5jQWV7qTLlcbbCsg9V98qcX3BV8d1LwxB\u0024<CandlePatternElement>(_param1)
{
  ...
  private void \u0023\u003Dzsinxw0lApF067xCcMw\u003D\u003D(bool _param1)
  {
    ...
    if (candles == null & _param1)
      throw new InvalidOperationException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539330379));
    ...
    string _param2)
  {
    ...
    if (!(_param2 == \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432639)) && !(_param2 == \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539432591)) && !(_param2 == \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539433813)))
      return;
    this.\u0023\u003Dz\u00246aIVrHDxlRJ().\u0023\u003DzBCuJKIIaVAUt();
  }
