...
// Type: #=zYB09msiytIDFpDsyaHpANIlY9U40wht98ivkll_JsB6Zqlt8apQd7HvhbLg9JuAyfQElyetA3oik
...
#nullable disable
internal sealed class \u0023\u003DzYB09msiytIDFpDsyaHpANIlY9U40wht98ivkll_JsB6Zqlt8apQd7HvhbLg9JuAyfQElyetA3oik : 
  \u0023\u003DzuxHg1RShgoNoz91lIJvsfNpaIZHYCAi8nIZQBxHeA1YPjtvfCM4Cf\u0024SW20w4MlG5kJm\u0024WkUzOQfp
{
    ...
    : base(_param1, _param2, _param3)
  {
    if (_param1.\u0023\u003Dz8hY71usSYcKH().\u0023\u003DztvwmoyKu8oUlLP4_gA\u003D\u003D().\u0023\u003DzVAoYC\u0024MJfjKU3EUhiA\u003D\u003D() != 24)
      throw new FormatException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539324036));
  }
    ...
    int _param5)
  {
    ...
    do
    {
      ...
      numArray1[0] = numArray1[1] = numArray1[2] = 8192 /*0x2000*/;
      int num10 = _param4 >> 8;
