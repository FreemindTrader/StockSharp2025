...
internal static class \u0023\u003DzAWpkoWPAfFQEtlAHXmXhio86vmI2XKycmgX\u0024bXbMoWy0WSCN5qTb7KX3DSGIbEK1Aw\u003D\u003D
{
  ...
  {
    return _param0 >= 0L ? (long) Math.Pow(2.0, Math.Ceiling(Math.Log((double) _param0, 2.0))) : throw new ArgumentOutOfRangeException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322891), \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322930));
  }

  public static int \u0023\u003DzYDSd8XwnDBcn(int _param0)
  {
    return _param0 >= 0 ? (int) Math.Pow(2.0, Math.Ceiling(Math.Log((double) _param0, 2.0))) : throw new ArgumentOutOfRangeException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322922), \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322930));
  }

  public static float \u0023\u003DzYDSd8XwnDBcn(float _param0)
  {
    return (double) _param0 >= 0.0 ? (float) Math.Pow(2.0, Math.Ceiling(Math.Log((double) _param0, 2.0))) : throw new ArgumentOutOfRangeException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322965), \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322930));
  }

  public static double \u0023\u003DzYDSd8XwnDBcn(double _param0)
  {
    return _param0 >= 0.0 ? Math.Pow(2.0, Math.Ceiling(Math.Log(_param0, 2.0))) : throw new ArgumentOutOfRangeException(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322948), \u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322930));
  }
  ...
  public static double \u0023\u003DzE1pg1ELlS2z_(double _param0)
  {
    ...
    if (_param0 >= 6.2831854820251465)
      _param0 -= 6.2831854820251465;
    return _param0 >= 0.0 && _param0 <= 6.2831854820251465 ? _param0 : throw new Exception(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322959));
  }
  ...
  public static double \u0023\u003DzAWhsryhXz5Xs(double _param0, double _param1)
  {
    if (_param0 != \u0023\u003DzAWpkoWPAfFQEtlAHXmXhio86vmI2XKycmgX\u0024bXbMoWy0WSCN5qTb7KX3DSGIbEK1Aw\u003D\u003D.\u0023\u003DzE1pg1ELlS2z_(_param0))
      throw new Exception(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539322992));
    if (_param1 != \u0023\u003DzAWpkoWPAfFQEtlAHXmXhio86vmI2XKycmgX\u0024bXbMoWy0WSCN5qTb7KX3DSGIbEK1Aw\u003D\u003D.\u0023\u003DzE1pg1ELlS2z_(_param1))
      throw new Exception(\u0023\u003DzlTriv\u0024izV_y2_zQvsgEHkxJr2Ncz.\u0023\u003DzhQ0l2sE\u003D(-539323324));
