...
internal class TopicVisitApiClient :
  BaseApiEntityClient<TopicVisit>,
  ITopicVisitService,
  IBaseEntityService<TopicVisit>
{
    ...
    Task<BaseEntitySet<TopicVisit>> ITopicVisitService.FindAsync(
      long skip,
      long? count,
      bool? deleted,
      string orderBy,
