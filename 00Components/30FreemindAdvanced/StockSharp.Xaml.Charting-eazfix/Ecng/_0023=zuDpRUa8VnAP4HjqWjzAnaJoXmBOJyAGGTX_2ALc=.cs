  ...
  IRenderContext2D
{
  ...
  protected IEnumerable<Point> \u0023\u003Dz8zZ1iXDzEMaO(IEnumerable<Tuple<Point, Point>> _param1)
  {
    ...
    return this.\u0023\u003Dz8zZ1iXDzEMaO(((IEnumerable<Tuple<Point, Point>>) array).Select<Tuple<Point, Point>, Point>(\u0023\u003DzuDpRUa8VnAP4HjqWjzAnaJoXmBOJyAGGTX_2ALc\u003D.SomeClass34343383.\u0023\u003DzRvDbWZIRxYgzjR1S\u0024g\u003D\u003D ?? (\u0023\u003DzuDpRUa8VnAP4HjqWjzAnaJoXmBOJyAGGTX_2ALc\u003D.SomeClass34343383.\u0023\u003DzRvDbWZIRxYgzjR1S\u0024g\u003D\u003D = new Func<Tuple<Point, Point>, Point>(\u0023\u003DzuDpRUa8VnAP4HjqWjzAnaJoXmBOJyAGGTX_2ALc\u003D.SomeClass34343383.SomeMethond0343.\u0023\u003DzDg6mo2MEiaYNMCHzJKIJl5w\u003D))), 0, 0).Concat<Point>(this.\u0023\u003Dz8zZ1iXDzEMaO(((IEnumerable<Tuple<Point, Point>>) array).Select<Tuple<Point, Point>, Point>(\u0023\u003DzuDpRUa8VnAP4HjqWjzAnaJoXmBOJyAGGTX_2ALc\u003D.SomeClass34343383.\u0023\u003DzyemWZ3TsoGdbt2LrKg\u003D\u003D ?? (\u0023\u003DzuDpRUa8VnAP4HjqWjzAnaJoXmBOJyAGGTX_2ALc\u003D.SomeClass34343383.\u0023\u003DzyemWZ3TsoGdbt2LrKg\u003D\u003D = new Func<Tuple<Point, Point>, Point>(\u0023\u003DzuDpRUa8VnAP4HjqWjzAnaJoXmBOJyAGGTX_2ALc\u003D.SomeClass34343383.SomeMethond0343.\u0023\u003DzXC7FT3ts2hCp609BBf5\u0024NGQ\u003D))), 0, 0).Reverse<Point>());
  }
