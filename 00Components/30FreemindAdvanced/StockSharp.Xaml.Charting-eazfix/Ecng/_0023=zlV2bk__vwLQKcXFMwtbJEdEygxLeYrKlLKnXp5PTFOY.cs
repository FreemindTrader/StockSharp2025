...
// Type: #=zlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6
...
#nullable disable
public sealed class \u0023\u003DzlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6 : 
  \u0023\u003DzlalC_BLW58oQFzS2Y8CMpwbBRmxTjoI81dC7J9YT\u0024RWJeZXysfONBiA\u003D<sbyte>
{
  private double \u0023\u003DzT\u0024kqKKwnFTS7 = 1.0;

  public \u0023\u003DzlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6()
  {
  ...
  public void \u0023\u003Dzhe7qd\u0024I\u003D(IList<sbyte> _param1, int _param2)
  {
    ...
    this.\u0023\u003DzWGTdqe9TpK9M((_param2 == 1 || \u0023\u003DzE2B_RS0KvtqHnw_gRshK2XNMFe_3Evlr8vIKUruTJaum.\u0023\u003DzNe9B4H63T3gE<sbyte>(_param1, index, _param2)) & (count <= 1 || index <= 0 || (int) _param1[index] >= (int) _param1[index - 1]));
    if (!this.\u0023\u003DzYod2AP\u0024vFlZp9roA9AjCses\u003D())
      return;
    double num1 = 1.0;
    double num2 = this.\u0023\u003DzT\u0024kqKKwnFTS7 * 0.000125;
    if ((_param2 == 1 ? 1 : (\u0023\u003DzE2B_RS0KvtqHnw_gRshK2XNMFe_3Evlr8vIKUruTJaum.\u0023\u003DzScZFqV8CJEMRehn4FqDXCME\u003D<sbyte>(_param1, index, _param2, num2, out num1) ? 1 : 0)) == 0)
      this.\u0023\u003DztzlkMHp1fyBYyPnbdOgIwYc\u003D(false);
    else if (count > _param2 && _param2 >= 2 && Math.Abs(this.\u0023\u003DzT\u0024kqKKwnFTS7 - num1) > num2)
      this.\u0023\u003DztzlkMHp1fyBYyPnbdOgIwYc\u003D(false);
    else if (index > 0)
    {
      double num3 = \u0023\u003DzlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6.\u0023\u003DzkUwF72z8\u0024rM9(_param1[index - 1]);
      double num4 = \u0023\u003DzlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6.\u0023\u003DzkUwF72z8\u0024rM9(_param1[index]) - num3;
      if (_param1.Count > 2)
      {
  ...
  public void \u0023\u003DzJ\u0024jJ8KQ\u003D(IList<sbyte> _param1, int _param2, int _param3)
  {
    if (!this.\u0023\u003DzZNXhT1ubdKMn())
      return;
    bool flag = _param3 == 1 || \u0023\u003DzE2B_RS0KvtqHnw_gRshK2XNMFe_3Evlr8vIKUruTJaum.\u0023\u003DzNe9B4H63T3gE<sbyte>(_param1, _param2, _param3);
    ...
    double num1 = 1.0;
    double num2 = this.\u0023\u003DzT\u0024kqKKwnFTS7 * 0.000125;
    if ((_param3 == 1 ? 1 : (\u0023\u003DzE2B_RS0KvtqHnw_gRshK2XNMFe_3Evlr8vIKUruTJaum.\u0023\u003DzScZFqV8CJEMRehn4FqDXCME\u003D<sbyte>(_param1, _param2, _param3, num2, out num1) ? 1 : 0)) == 0)
      this.\u0023\u003DztzlkMHp1fyBYyPnbdOgIwYc\u003D(false);
    ...
    else
    {
      if (_param2 > 0)
      {
        double num3 = \u0023\u003DzlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6.\u0023\u003DzkUwF72z8\u0024rM9(_param1[_param2 - 1]);
        double num4 = \u0023\u003DzlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6.\u0023\u003DzkUwF72z8\u0024rM9(_param1[_param2]) - num3;
        if (_param1.Count > 2)
        {
          if (Math.Abs(num4 - this.\u0023\u003DzT\u0024kqKKwnFTS7) > num2)
          {
      ...
      {
        double num5 = \u0023\u003DzlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6.\u0023\u003DzkUwF72z8\u0024rM9(_param1[index]);
        double num6 = \u0023\u003DzlV2bk__vwLQKcXFMwtbJEdEygxLeYrKlLKnXp5PTFOYh4EoztDxd13pyqFa6.\u0023\u003DzkUwF72z8\u0024rM9(_param1[index + 1]) - num5;
        if (_param1.Count > 2)
        {
