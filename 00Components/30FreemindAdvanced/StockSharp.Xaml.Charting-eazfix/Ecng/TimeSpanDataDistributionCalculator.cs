...
#nullable disable
public sealed class TimeSpanDataDistributionCalculator : 
  BaseDataDistributionCalculator<TimeSpan>
{
    ...
    bool _param4)
  {
    ...
    if (_param2 == 0)
    {
      ...
      double num1 = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(timeSpan) - TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param3);
      ...
      else
      {
        if (!this.\u0023\u003Dzto0ucxxNtpN_zkiSeV1usQd_D\u0024yl() || !this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D)
          return;
        double num2 = num1 - (TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(timeSpanList[2]) - TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(timeSpan));
        if (num2 < 0.0)
          num2 = -num2;
    ...
    bool _param5)
  {
    ...
    else if (_param2 == 0)
    {
      if (count <= 2)
        return;
      double num1 = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(timeSpanList[1]) - TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(timeSpanList[0]);
      this.\u0023\u003DzUvUfmcjO8Kin = num1;
      this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D = true;
      ...
      {
        double num2 = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(timeSpanList[index]);
    ...
    bool _param4)
  {
    ...
    if (_param3 > 0)
    {
      double num1 = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param2) - this.\u0023\u003DzECK7c5Gz4mSc;
      if (num1 < 0.0)
      {
        this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
        this.\u0023\u003Dz6HFZWED70KA3OkmAw\u0024SltknkBzo4(false);
    ...
    this.\u0023\u003DzECK7c5Gz4mSc = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param2);
  }
    ...
    bool _param5)
  {
    ...
    {
      double num2 = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]) - this.\u0023\u003DzECK7c5Gz4mSc;
      if (this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && this.\u0023\u003DzECK7c5Gz4mSc > TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]))
      {
        this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
        if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !_param5)
          throw new InvalidOperationException("Data has been Appended to a DataSeries which is unsorted in the X-Direction. Unsorted data can have severe performance implications in Ultrachart.\r\nFor maximum performance, please double-check that you are only inserting sorted data to Ultrachart. Alternatively, to disable this warning and allow unsorted data, please set DataSeries.AcceptsUnsortedData = true. For more info see Performance Tips and Tricks at http://support.ultrachart.com/index.php?/Knowledgebase/Article/View/17227/36/performance-tips-and-tricks");
    ...
    double num4 = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]);
    double num5 = this.\u0023\u003DzUvUfmcjO8Kin;
    bool flag = this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D;
    for (int index = 1; index < num1; ++index)
    {
      double num6 = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param3[index]);
    ...
    this.\u0023\u003DzECK7c5Gz4mSc = TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param3[num1 - 1]);
    if (this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D || num1 <= 1)
      return;
    this.\u0023\u003DzUvUfmcjO8Kin = this.\u0023\u003DzECK7c5Gz4mSc - TimeSpanDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param3[num1 - 2]);
    this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D = true;
    this.\u0023\u003DznxnJcVNYOdRqEfYQdQ\u003D\u003D = this.\u0023\u003DzUvUfmcjO8Kin * 0.000125;
  }
