...
#nullable disable
public sealed class ListSByteDataDistributionCalculator : 
  BaseDataDistributionCalculator<sbyte>
{
  ...
  public void \u0023\u003Dzhe7qd\u0024I\u003D(IList<sbyte> _param1, int _param2)
  {
    ...
    {
      double num3 = ListSByteDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param1[index - 1]);
      double num4 = ListSByteDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param1[index]) - num3;
      if (_param1.Count > 2)
      {
  ...
  public void \u0023\u003DzJ\u0024jJ8KQ\u003D(IList<sbyte> _param1, int _param2, int _param3)
  {
    ...
    else
    {
      if (_param2 > 0)
      {
        double num3 = ListSByteDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param1[_param2 - 1]);
        double num4 = ListSByteDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param1[_param2]) - num3;
        if (_param1.Count > 2)
        {
          if (Math.Abs(num4 - this.\u0023\u003DzT\u0024kqKKwnFTS7) > num2)
          {
      ...
      {
        double num5 = ListSByteDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param1[index]);
        double num6 = ListSByteDataDistributionCalculator.\u0023\u003DzkUwF72z8\u0024rM9(_param1[index + 1]) - num5;
        if (_param1.Count > 2)
        {
