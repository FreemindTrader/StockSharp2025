  ...
  \u0023\u003Dza5uC6EI3X0HH3HGpwdgoZt5Gh_M7zik7mtVzjUImZB9B
{
    ...
    IComparable _param2)
  {
    ...
    if (lqkdKbY6smnsRhNQalw1.HasExponent)
    {
      ...
      lqkdKbY6smnsRhNQalw1.Text = string.Format((IFormatProvider) CultureInfo.InvariantCulture, $"{{0:{str1}}}x", (object) num2);
      lqkdKbY6smnsRhNQalw1.Exponent = string.Format((IFormatProvider) CultureInfo.InvariantCulture, $"{{0:{str5}}}", (object) y);
