...
// Type: #=zWwDYSe$z_nPO4KEsBbkyAbG5yCERTVlAHXU$91pTc_0$9S_IJjqm2RooF3Z3GCGxsWTMKbR2A7YAC$bSIDB2QLk=
// Assembly: StockSharp.Xaml.Charting, Version=5.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: B81ABC38-30E9-4E5C-D0FB-A30B79FCF2D6
// Assembly location: C:\00-Reverse\StockSharp.Xaml.Charting-eazfix.dll

#nullable disable
internal sealed class \u0023\u003DzWwDYSe\u0024z_nPO4KEsBbkyAbG5yCERTVlAHXU\u002491pTc_0\u00249S_IJjqm2RooF3Z3GCGxsWTMKbR2A7YAC\u0024bSIDB2QLk\u003D : 
  \u0023\u003DzumuFC1VOOoBDs2QpPto5VkbLjIthccEiDcgR\u0024vJQ7K_Hrp4E7vWJo36zKSrEqSwNKA\u003D\u003D
{
    ...
    int _param5)
  {
    ...
    if (this.\u0023\u003Dz8piAmGjALgntNR5r77ROXo0\u003D.GetType() == typeof (\u0023\u003DzpWMIzYBzoypE5Wwh\u0024gRH6Rj345c91wV_bHWufOYgBJkEIa\u0024gxVFiFtn1t6a1SKrdXMUKfjlv0yjch\u00241C5KjERZk\u003D) && ((\u0023\u003DzpWMIzYBzoypE5Wwh\u0024gRH6Rj345c91wV_bHWufOYgBJkEIa\u0024gxVFiFtn1t6a1SKrdXMUKfjlv0yjch\u00241C5KjERZk\u003D) this.\u0023\u003Dz8piAmGjALgntNR5r77ROXo0\u003D).\u0023\u003DzRLWOoTmSHt4EDNlIQQ\u003D\u003D().GetType() == typeof (\u0023\u003DzGEJCq9O47NiPLstzce6jeKFdpdmlN1Sks7H98KXSg9LvtczoYENMDycPB20wrm_F\u0024w\u003D\u003D) && ((\u0023\u003DzGEJCq9O47NiPLstzce6jeKFdpdmlN1Sks7H98KXSg9LvtczoYENMDycPB20wrm_F\u0024w\u003D\u003D) ((\u0023\u003DzpWMIzYBzoypE5Wwh\u0024gRH6Rj345c91wV_bHWufOYgBJkEIa\u0024gxVFiFtn1t6a1SKrdXMUKfjlv0yjch\u00241C5KjERZk\u003D) this.\u0023\u003Dz8piAmGjALgntNR5r77ROXo0\u003D).\u0023\u003DzRLWOoTmSHt4EDNlIQQ\u003D\u003D()).\u0023\u003Dz\u0024ZPx7vNrsbrB())
    {
      ...
      do
      {
        ...
        int index4 = num6;
        num1 = index4 + 1;
        int num8 = (int) numArray5[index4];
        local4.\u0023\u003DzKCqGEcs\u003D = (byte) num8;
        ++_param2;
      }
      while (--_param5 != 0);
    }
    else
    {
      ...
      int num9 = this.\u0023\u003DzXfsXM99CTPMy().\u0023\u003Dz8hY71usSYcKH().\u0023\u003DzQB4v2EccUot6eT2VRw\u003D\u003D();
      int num10 = ppsbKthY7Nkewpng.Width - 1;
      int num11 = ppsbKthY7Nkewpng.Height - 1;
      ...
      do
      {
        int num12;
        int num13;
        nbVwaPinzNveauDt.\u0023\u003Dz95kJcrQe23xpIQcxtQ\u003D\u003D(out num12, out num13);
        num12 -= this.\u0023\u003DzxioLP9oyjKFBIHWWVA\u003D\u003D();
        num13 -= this.\u0023\u003Dz2YwJt7tn\u0024hxMRoRU\u0024A\u003D\u003D();
        int num14 = num12 >> 8;
        int num15 = num13 >> 8;
        if (num14 >= 0 && num15 >= 0 && num14 < num10 && num15 < num11)
        {
          numArray6[0] = numArray6[1] = numArray6[2] = numArray6[3] = 32768 /*0x8000*/;
          num12 &= (int) byte.MaxValue;
          num13 &= (int) byte.MaxValue;
          int index;
          byte[] numArray7 = ppsbKthY7Nkewpng.\u0023\u003DznPLKTp_rfCU9(num14, num15, out index);
          int num16 = (256 /*0x0100*/ - num12) * (256 /*0x0100*/ - num13);
          if (num16 > (int) byte.MaxValue)
          {
            numArray6[0] += num16 * (int) numArray7[index + 2];
            numArray6[1] += num16 * (int) numArray7[index + 1];
            numArray6[2] += num16 * (int) numArray7[index];
            numArray6[3] += num16 * (int) numArray7[index + 3];
          }
          int num17 = num12 * (256 /*0x0100*/ - num13);
          if (num17 > (int) byte.MaxValue)
          {
            index += num9;
            numArray6[0] += num17 * (int) numArray7[index + 2];
            numArray6[1] += num17 * (int) numArray7[index + 1];
            numArray6[2] += num17 * (int) numArray7[index];
            numArray6[3] += num17 * (int) numArray7[index + 3];
          }
          int num18 = (256 /*0x0100*/ - num12) * num13;
          if (num18 > (int) byte.MaxValue)
          {
            int num19 = num15 + 1;
            numArray7 = ppsbKthY7Nkewpng.\u0023\u003DznPLKTp_rfCU9(num14, num19, out index);
            numArray6[0] += num18 * (int) numArray7[index + 2];
            numArray6[1] += num18 * (int) numArray7[index + 1];
            numArray6[2] += num18 * (int) numArray7[index];
            numArray6[3] += num18 * (int) numArray7[index + 3];
          }
          int num20 = num12 * num13;
          if (num20 > (int) byte.MaxValue)
          {
            index += num9;
            numArray6[0] += num20 * (int) numArray7[index + 2];
            numArray6[1] += num20 * (int) numArray7[index + 1];
            numArray6[2] += num20 * (int) numArray7[index];
            numArray6[3] += num20 * (int) numArray7[index + 3];
          }
          numArray6[0] >>= 16 /*0x10*/;
          numArray6[1] >>= 16 /*0x10*/;
          numArray6[2] >>= 16 /*0x10*/;
        ...
        else if (num14 < -1 || num15 < -1 || num14 > num10 || num15 > num11)
        {
          numArray6[0] = z4Whdt9g;
          numArray6[1] = zoRsAtmfOfdZe;
          numArray6[2] = zcdKuX48ZxnS;
          numArray6[3] = zKcqGecs;
        }
        else
        {
          numArray6[0] = numArray6[1] = numArray6[2] = numArray6[3] = 32768 /*0x8000*/;
        ...
        _param1[_param2].\u0023\u003Dz4WHdt9g\u003D = (byte) numArray6[0];
        _param1[_param2].\u0023\u003DzoRsAtmfOFDZe = (byte) numArray6[1];
        _param1[_param2].\u0023\u003DzcdKuX48ZXN_S = (byte) numArray6[2];
        _param1[_param2].\u0023\u003DzKCqGEcs\u003D = (byte) numArray6[3];
        ++_param2;
  ...
  private void \u0023\u003DzvarNhRFp_fcR(
    ...
    int _param11)
  {
    if ((uint) _param9 <= (uint) _param7 && (uint) _param10 <= (uint) _param8)
    {
      int index = _param6.\u0023\u003DzHlHGfKJZNJsq(_param9, _param10);
      byte[] numArray = _param6.\u0023\u003Dz9b1_JhA\u003D();
      _param1[0] += _param11 * (int) numArray[index + 2];
      _param1[1] += _param11 * (int) numArray[index + 1];
      _param1[2] += _param11 * (int) numArray[index];
      _param1[3] += _param11 * (int) numArray[index + 3];
    }
    else
    {
      _param1[0] += _param2 * _param11;
      _param1[1] += _param3 * _param11;
      _param1[2] += _param4 * _param11;
      _param1[3] += _param5 * _param11;
    }
  }
}
