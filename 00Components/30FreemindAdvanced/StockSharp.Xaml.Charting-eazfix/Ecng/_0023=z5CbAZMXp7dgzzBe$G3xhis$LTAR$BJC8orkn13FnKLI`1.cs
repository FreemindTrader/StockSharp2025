  ...
  where TX : struct, IComparable
{
    ...
    : base(_param1)
  {
    ...
    this.\u0023\u003DzlkmfHYgr1H49 = new \u0023\u003DzlbW67NDum9APBLuSxcbgNFrHbXEQ3PaVam0xJhsXKfF7<TX, double, double>();
  }
  ...
  private void \u0023\u003DzaQ1S7AaIPkwA4Hm2eKJs7\u0024w\u003D()
  {
    ...
    switch (this.ChartComponentView.Style)
    {
      ...
      case DrawStyles.Bubble:
        ...
        b5lfOfnUo8w7EyJw.ResamplingMode = ResamplingMode.None;
  ...
  Color? IXxxPaletteProvider.\u0023\u003DzbcX\u0024ot\u0024Zhy6wUdB9J7NC3yzxavQxmzggPmZ8V62OI0Kr0hq2Km30eq101sCk(
    ...
    double _param3)
  {
    if (!(_param1.get_DataSeries() is \u0023\u003DzlbW67NDum9APBLuSxcbgNFrHbXEQ3PaVam0xJhsXKfF7<TX, double, double> dataSeries))
      return new Color?();
