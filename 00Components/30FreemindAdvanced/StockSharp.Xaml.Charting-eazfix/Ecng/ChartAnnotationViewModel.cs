...
//    public override bool Draw( IEnumerableEx<ChartDrawData.IDrawValue> p )
//    {
//        this.ScichartSurfaceMVVM.AnnotationModifier.Draw( ChartComponentView, ( ( IEnumerable ) p ).Cast<ChartDrawData.AnnotationData>().Single<ChartDrawData.AnnotationData>() );
