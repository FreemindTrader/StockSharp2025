...
// Type: #=z5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q=
...
public sealed class \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D : 
  BaseDataDistributionCalculator<byte>
{
  ...
  public override void \u0023\u003DzFIf7JZ5S\u0024Wr_(
    ...
    bool _param3)
  {
    this.\u0023\u003DzUIhkiEELxlDXkW60HA\u003D\u003D(_param1, _param2, ((ICollection<byte>) _param1).Count - 1, _param3);
  }
    ...
    bool _param4)
  {
    ...
    {
      case byte[] numArray2:
        this.\u0023\u003DzhyFsF2I8e3f6_Y5THg\u003D\u003D((IList<byte>) _param1, _param2, numArray2, numArray2.Length, _param4);
        break;
      case IList<byte> byteList:
        int count = byteList.Count;
        byte[] numArray1 = byteList.\u0023\u003Dz1bvQV4SZTWpA<byte>();
        this.\u0023\u003DzhyFsF2I8e3f6_Y5THg\u003D\u003D((IList<byte>) _param1, _param2, numArray1, count, _param4);
        break;
      default:
        IEnumerable<byte> bytes = _param3;
        int num = _param2;
    ...
    bool _param4)
  {
    if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !this.\u0023\u003Dzto0ucxxNtpN_zkiSeV1usQd_D\u0024yl())
      return;
    IList<byte> byteList = (IList<byte>) _param1;
    int count = byteList.Count;
    if (_param2 == 0)
    {
      if (count <= 1)
        return;
      byte num1 = byteList[1];
      double num2 = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(num1) - \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param3);
      ...
      else
      {
        if (!this.\u0023\u003Dzto0ucxxNtpN_zkiSeV1usQd_D\u0024yl() || !this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D)
          return;
        double num3 = num2 - (\u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(byteList[2]) - \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(num1));
        if (num3 < 0.0)
          num3 = -num3;
    ...
    else
    {
      ...
      if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D())
        return;
      if (_param2 > 0 && (int) byteList[_param2 - 1] > (int) _param3)
      {
        this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
        if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !_param4)
          throw new InvalidOperationException("Data has been Inserted to a DataSeries which is unsorted in the X-Direction. Unsorted data can have severe performance implications in Ultrachart.\r\nFor maximum performance, please double-check that you are only inserting sorted data to Ultrachart. Alternatively, to disable this warning and allow unsorted data, please set DataSeries.AcceptsUnsortedData = true. For more info see Performance Tips and Tricks at http://support.ultrachart.com/index.php?/Knowledgebase/Article/View/17227/36/performance-tips-and-tricks");
      }
      if (_param2 >= count - 1 || (int) byteList[_param2 + 1] >= (int) _param3)
        return;
      this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
      if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !_param4)
        throw new InvalidOperationException("Data has been Inserted to a DataSeries which is unsorted in the X-Direction. Unsorted data can have severe performance implications in Ultrachart.\r\nFor maximum performance, please double-check that you are only inserting sorted data to Ultrachart. Alternatively, to disable this warning and allow unsorted data, please set DataSeries.AcceptsUnsortedData = true. For more info see Performance Tips and Tricks at http://support.ultrachart.com/index.php?/Knowledgebase/Article/View/17227/36/performance-tips-and-tricks");
    ...
    bool _param5)
  {
    ...
    else if (_param2 == 0)
    {
      if (count <= 2)
        return;
      double num1 = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(byteList[1]) - \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(byteList[0]);
      ...
      {
        double num2 = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(byteList[index]);
    ...
    bool _param4)
  {
    ...
    if (_param3 > 0)
    {
      double num1 = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param2) - this.\u0023\u003DzECK7c5Gz4mSc;
      if (num1 < 0.0)
      {
        this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
        this.\u0023\u003Dz6HFZWED70KA3OkmAw\u0024SltknkBzo4(false);
    ...
    this.\u0023\u003DzECK7c5Gz4mSc = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param2);
  }
    ...
    bool _param5)
  {
    ...
    {
      double num2 = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]) - this.\u0023\u003DzECK7c5Gz4mSc;
      if (this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && this.\u0023\u003DzECK7c5Gz4mSc > \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]))
      {
        this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
        if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !_param5)
          throw new InvalidOperationException("Data has been Appended to a DataSeries which is unsorted in the X-Direction. Unsorted data can have severe performance implications in Ultrachart.\r\nFor maximum performance, please double-check that you are only inserting sorted data to Ultrachart. Alternatively, to disable this warning and allow unsorted data, please set DataSeries.AcceptsUnsortedData = true. For more info see Performance Tips and Tricks at http://support.ultrachart.com/index.php?/Knowledgebase/Article/View/17227/36/performance-tips-and-tricks");
    ...
    double num4 = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]);
    double num5 = this.\u0023\u003DzUvUfmcjO8Kin;
    bool flag = this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D;
    for (int index = 1; index < num1; ++index)
    {
      double num6 = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param3[index]);
    ...
    this.\u0023\u003DzECK7c5Gz4mSc = \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param3[num1 - 1]);
    if (this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D || num1 <= 1)
      return;
    this.\u0023\u003DzUvUfmcjO8Kin = this.\u0023\u003DzECK7c5Gz4mSc - \u0023\u003Dz5hVyTN88kBn45NAfOxK7MOzNKQH1uxVq4qvGxsln3hTzUcBgLSDbT3Q\u003D.\u0023\u003DzkUwF72z8\u0024rM9(_param3[num1 - 2]);
    this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D = true;
    this.\u0023\u003DznxnJcVNYOdRqEfYQdQ\u003D\u003D = this.\u0023\u003DzUvUfmcjO8Kin * 0.000125;
  }
