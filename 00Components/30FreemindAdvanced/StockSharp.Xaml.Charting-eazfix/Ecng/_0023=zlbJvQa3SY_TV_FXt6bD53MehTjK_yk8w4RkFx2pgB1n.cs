...
// Type: #=zlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg$vS3imZ
...
#nullable disable
public sealed class \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ : 
  BaseDataDistributionCalculator<short>
{
  ...
  public override void \u0023\u003DzFIf7JZ5S\u0024Wr_(
    ISeriesColumn<short> _param1,
    short _param2,
    bool _param3)
  {
    this.\u0023\u003DzUIhkiEELxlDXkW60HA\u003D\u003D(_param1, _param2, ((ICollection<short>) _param1).Count - 1, _param3);
  }

  public override void \u0023\u003DzeU6gWqHRfREz(
    ISeriesColumn<short> _param1,
    int _param2,
    IEnumerable<short> _param3,
    bool _param4)
  {
    switch (_param3)
    {
      case short[] numArray2:
        this.\u0023\u003DzhyFsF2I8e3f6_Y5THg\u003D\u003D((IList<short>) _param1, _param2, numArray2, numArray2.Length, _param4);
        break;
      case IList<short> shortList:
        int count = shortList.Count;
        short[] numArray1 = shortList.\u0023\u003Dz1bvQV4SZTWpA<short>();
        this.\u0023\u003DzhyFsF2I8e3f6_Y5THg\u003D\u003D((IList<short>) _param1, _param2, numArray1, count, _param4);
        break;
      default:
        IEnumerable<short> shorts = _param3;
        int num = _param2;
        using (IEnumerator<short> enumerator = shorts.GetEnumerator())
        {
    ...
    bool _param4)
  {
    if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !this.\u0023\u003Dzto0ucxxNtpN_zkiSeV1usQd_D\u0024yl())
      return;
    IList<short> shortList = (IList<short>) _param1;
    int count = shortList.Count;
    if (_param2 == 0)
    {
      if (count <= 1)
        return;
      short num1 = shortList[1];
      double num2 = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(num1) - \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param3);
      ...
      else
      {
        if (!this.\u0023\u003Dzto0ucxxNtpN_zkiSeV1usQd_D\u0024yl() || !this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D)
          return;
        double num3 = num2 - (\u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(shortList[2]) - \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(num1));
        if (num3 < 0.0)
          num3 = -num3;
    ...
    else
    {
      ...
      if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D())
        return;
      if (_param2 > 0 && (int) shortList[_param2 - 1] > (int) _param3)
      {
        this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
        if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !_param4)
          throw new InvalidOperationException("Data has been Inserted to a DataSeries which is unsorted in the X-Direction. Unsorted data can have severe performance implications in Ultrachart.\r\nFor maximum performance, please double-check that you are only inserting sorted data to Ultrachart. Alternatively, to disable this warning and allow unsorted data, please set DataSeries.AcceptsUnsortedData = true. For more info see Performance Tips and Tricks at http://support.ultrachart.com/index.php?/Knowledgebase/Article/View/17227/36/performance-tips-and-tricks");
      }
      if (_param2 >= count - 1 || (int) shortList[_param2 + 1] >= (int) _param3)
        return;
      this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
      if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !_param4)
        throw new InvalidOperationException("Data has been Inserted to a DataSeries which is unsorted in the X-Direction. Unsorted data can have severe performance implications in Ultrachart.\r\nFor maximum performance, please double-check that you are only inserting sorted data to Ultrachart. Alternatively, to disable this warning and allow unsorted data, please set DataSeries.AcceptsUnsortedData = true. For more info see Performance Tips and Tricks at http://support.ultrachart.com/index.php?/Knowledgebase/Article/View/17227/36/performance-tips-and-tricks");
    ...
    bool _param5)
  {
    ...
    else if (_param2 == 0)
    {
      if (count <= 2)
        return;
      double num1 = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(shortList[1]) - \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(shortList[0]);
      ...
      {
        double num2 = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(shortList[index]);
    ...
    bool _param4)
  {
    ...
    if (_param3 > 0)
    {
      double num1 = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param2) - this.\u0023\u003DzECK7c5Gz4mSc;
      if (num1 < 0.0)
      {
        this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
        this.\u0023\u003Dz6HFZWED70KA3OkmAw\u0024SltknkBzo4(false);
    ...
    this.\u0023\u003DzECK7c5Gz4mSc = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param2);
  }
    ...
    bool _param5)
  {
    ...
    {
      double num2 = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]) - this.\u0023\u003DzECK7c5Gz4mSc;
      if (this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && this.\u0023\u003DzECK7c5Gz4mSc > \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]))
      {
        this.\u0023\u003DzBD_etwoAJ6Nw1j21ug\u003D\u003D(false);
        if (!this.\u0023\u003Dzu6iQ2MOE9IYpXL_QIQ\u003D\u003D() && !_param5)
          throw new InvalidOperationException("Data has been Appended to a DataSeries which is unsorted in the X-Direction. Unsorted data can have severe performance implications in Ultrachart.\r\nFor maximum performance, please double-check that you are only inserting sorted data to Ultrachart. Alternatively, to disable this warning and allow unsorted data, please set DataSeries.AcceptsUnsortedData = true. For more info see Performance Tips and Tricks at http://support.ultrachart.com/index.php?/Knowledgebase/Article/View/17227/36/performance-tips-and-tricks");
    ...
    double num4 = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param3[0]);
    double num5 = this.\u0023\u003DzUvUfmcjO8Kin;
    bool flag = this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D;
    for (int index = 1; index < num1; ++index)
    {
      double num6 = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param3[index]);
    ...
    this.\u0023\u003DzECK7c5Gz4mSc = \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param3[num1 - 1]);
    if (this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D || num1 <= 1)
      return;
    this.\u0023\u003DzUvUfmcjO8Kin = this.\u0023\u003DzECK7c5Gz4mSc - \u0023\u003DzlbJvQa3SY_TV_FXt6bD53MehTjK_yk8w4RkFx2pgB1nCOK9Da0gcg\u0024vS3imZ.\u0023\u003DzkUwF72z8\u0024rM9(_param3[num1 - 2]);
    this.\u0023\u003DzJEpy_QVydelYNN6GnA\u003D\u003D = true;
    this.\u0023\u003DznxnJcVNYOdRqEfYQdQ\u003D\u003D = this.\u0023\u003DzUvUfmcjO8Kin * 0.000125;
  }
