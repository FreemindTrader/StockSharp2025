  ...
  BaseRenderableSeries
{
  ...
  public static readonly DependencyProperty \u0023\u003DzWsyKEigY1Lm6 = DependencyProperty.Register(nameof (BubbleColor), typeof (Color), typeof (FastBubbleRenderableSeries), new PropertyMetadata((object) new Color(), new PropertyChangedCallback(FastBubbleRenderableSeries.OnPropertyChanged)));
  
  public static readonly DependencyProperty \u0023\u003DzgLLxE9j2DbxR = DependencyProperty.Register(nameof (AutoZRange), typeof (bool), typeof (FastBubbleRenderableSeries), new PropertyMetadata((object) true, new PropertyChangedCallback(FastBubbleRenderableSeries.OnPropertyChanged)));
