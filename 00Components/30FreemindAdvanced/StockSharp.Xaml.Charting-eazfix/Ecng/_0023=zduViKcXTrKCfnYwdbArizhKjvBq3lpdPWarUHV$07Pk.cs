...
#nullable disable
public static class \u0023\u003DzduViKcXTrKCfnYwdbArizhKjvBq3lpdPWarUHV\u002407Pk\u0024
{
  public static bool IsDefined(this IComparable _param0)
  {
    return _param0 != null && \u0023\u003DzbKeMmKPk2OqoW3MAcU5vNXCE4EvjzL\u0024mX84Druo\u003D.IsDefined(_param0);
  }

  public static double ToDouble(this double _param0) => _param0;

  public static double ToDouble(this IComparable _param0)
  {
    return _param0 is double num ? num : \u0023\u003DzbKeMmKPk2OqoW3MAcU5vNXCE4EvjzL\u0024mX84Druo\u003D.ToDouble(_param0);
  }

  public static double[] \u0023\u003DzvczFDIa7rqI9<T>(this T[] _param0) where T : IComparable
  {
  ...
  public static DateTime \u0023\u003Dzxuo5aY4wjkaI(this IComparable _param0)
  {
  ...
  public static TimeSpan \u0023\u003Dzto51K8pl8UAh(this IComparable _param0)
  {
    if (_param0 is TimeSpan timeSpan)
      return timeSpan;
    if (_param0 is DateTime dateTime)
  ...
  private sealed class \u0023\u003DzHKPvivPHfuGd30DNcQ\u003D\u003D<T> where T : IComparable
  {
    ...
    public double \u0023\u003DzGBBVR4\u0024_hO74jzC_CeEppVE\u003D(
      T _param1)
    {
