...
// Type: #=zESFnl$cpXbmAnH3LhxCsqQMMUpdrYizZh1$TejAsPVdnlvpPU6Az$I4=
...
internal static class \u0023\u003DzESFnl\u0024cpXbmAnH3LhxCsqQMMUpdrYizZh1\u0024TejAsPVdnlvpPU6Az\u0024I4\u003D
{
  ...
  internal static void \u0023\u003DzftEp\u0024x4VdHnj(
    ...
    bool _param6)
  {
    \u0023\u003DzESFnl\u0024cpXbmAnH3LhxCsqQMMUpdrYizZh1\u0024TejAsPVdnlvpPU6Az\u0024I4\u003D.\u0023\u003DzftEp\u0024x4VdHnj(_param0, _param1, _param2.\u0023\u003DzwQnyySN6xaVC().\u0023\u003DzRr4AYdnHaTxa(), _param2.\u0023\u003DzPqsSI6C5MOOb().\u0023\u003DzRr4AYdnHaTxa(), _param2.\u0023\u003DzlpVGw6E\u003D(), _param3, _param4, _param5, _param6);
  }
    ...
    bool _param8)
  {
    ...
    double num11 = num7;
    if (num2 == num2)
      v1qkdyQymVhxLr4oDq = _param0.\u0023\u003Dz7ZSU06M\u003D(bDPyrbD0P2noEi5c1, num7, num6);
    for (int index = 1; index < _param4; ++index)
    {
      double num12 = _param2[index];
      double num13 = _param3[index];
      if (num13 != num13)
      {
        ...
        num8 = _param8 ? num8 : double.NaN;
        num9 = _param8 ? num9 : double.NaN;
      }
      else
      {
        ...
        if (v1qkdyQymVhxLr4oDq == null)
        {
          double num14 = _param5.\u0023\u003DzhL6gsJw\u003D(num8);
          double num15 = _param6.\u0023\u003DzhL6gsJw\u003D(num9);
          double num16 = flag ? num15 : num14;
          double num17 = flag ? num14 : num15;
          double num18 = num16;
          num10 = num17;
          num11 = num18;
          if (num9 != num9)
          ...
          v1qkdyQymVhxLr4oDq = _param0.\u0023\u003Dz7ZSU06M\u003D(bDPyrbD0P2noEi5c1, num18, num17);
        }
        double num19 = _param5.\u0023\u003DzhL6gsJw\u003D(num12);
        double num20 = _param6.\u0023\u003DzhL6gsJw\u003D(num13);
        double num21 = flag ? num20 : num19;
        double num22 = flag ? num19 : num20;
        double num23 = num21;
        if (_param7)
        {
          if (flag)
          {
            v1qkdyQymVhxLr4oDq.\u0023\u003DzfRDRUq8\u003D(num11, num22);
            v1qkdyQymVhxLr4oDq.\u0023\u003DzfRDRUq8\u003D(num23, num22);
          }
          else
          {
            v1qkdyQymVhxLr4oDq.\u0023\u003DzfRDRUq8\u003D(num23, num10);
            v1qkdyQymVhxLr4oDq.\u0023\u003DzfRDRUq8\u003D(num23, num22);
          }
        }
        else
