  ...
  where T : ChartTransactionElement<T>, new()
{
  ...
  public System.Windows.Media.Color BuyStrokeColor
  {
    ...
    set
    {
      ...
      this.RaisePropertyChanged(nameof (BuyStrokeColor));
    }
  }
  ...
  public System.Windows.Media.Color SellStrokeColor
  {
    ...
    set
    {
      ...
      this.RaisePropertyChanged(nameof (SellStrokeColor));
    }
  }
  ...
  public bool UseAltIcon
  {
    ...
    set
    {
      ...
      this.RaisePropertyChanged(nameof (UseAltIcon));
    }
  }
  ...
  public double DrawSize
  {
    ...
    set
    {
      ...
      this.RaisePropertyChanged(nameof (DrawSize));
    }
  }
  ...
  {
    base.Load(storage);
    this.BuyColor = storage.GetValue<int>("BuyColor", this.BuyColor.ToInt()).ToColor();
    this.BuyStrokeColor = storage.GetValue<int>("BuyStrokeColor", this.BuyStrokeColor.ToInt()).ToColor();
    this.SellColor = storage.GetValue<int>("SellColor", this.SellColor.ToInt()).ToColor();
    this.SellStrokeColor = storage.GetValue<int>("SellStrokeColor", this.SellStrokeColor.ToInt()).ToColor();
    this.UseAltIcon = storage.GetValue<bool>("UseAltIcon", this.UseAltIcon);
    this.DrawSize = storage.GetValue<double>("DrawSize", this.DrawSize);
  }

  public override void Save(SettingsStorage storage)
  {
    base.Save(storage);
    storage.SetValue<int>("BuyColor", this.BuyColor.ToInt());
    storage.SetValue<int>("BuyStrokeColor", this.BuyStrokeColor.ToInt());
    storage.SetValue<int>("SellColor", this.SellColor.ToInt());
    storage.SetValue<int>("SellStrokeColor", this.SellStrokeColor.ToInt());
    storage.SetValue<bool>("UseAltIcon", this.UseAltIcon);
