...
public class ChartDrawData : IChartDrawData
{
  ...
  public IChartDrawData Add(IChartAnnotationElement element, IAnnotationData data)
  {
    ...
    dictionary[key] = data ?? throw new ArgumentNullException(nameof (data));
    ...
    OrderStates? state = null)
  {
    ...
    if (!price.HasValue)
    {
      ...
      price = order != null ? new Decimal?(__nonvirtual (order.Price)) : throw new ArgumentException("both order and price cannot be null");
    }
  ...
  internal sealed class \u0023\u003DzU3TaXFs\u003D : ChartDrawData.IDrawValue
  {
    ...
    {
      return $"{"TransactionData"}: id={this.\u0023\u003DzDmTtC9WghRFa()}, time={this.\u0023\u003Dzg86amuQ\u003D()}, {this.\u0023\u003DzUYTxG_Bgl8ih()} {this.Volume}@{this.\u0023\u003DzbH5YDNBwpnry()}";
    }
  }
  ...
  internal readonly struct \u0023\u003DzbzWrw_pExZ6TZuVkEg\u003D\u003D : ChartDrawData.IDrawValue
  {
    ...
    {
      this.\u0023\u003DzOAeg4d9aAVB\u0024\u0024e1gKg\u003D\u003D = _param1.UtcDateTime;
      this.\u0023\u003DzdgcgaziC7FxHmFtv9g\u003D\u003D = _param2 ?? throw new ArgumentNullException("dataType");
  ...
  public class AnnotationData : IPersistable, IAnnotationData, ChartDrawData.IDrawValue
  {
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    ...
    public void Load(SettingsStorage storage)
    {
      ...
      this.X1 = ChartDrawData.AnnotationData.\u0023\u003DqS8Rz7CLyLtZi1DPj0ZEyaLSgFDmJg4JMOyHZMbcvphk\u003D(storage.GetValue<IComparable>("X1", this.X1));
      this.Y1 = storage.GetValue<IComparable>("Y1", this.Y1);
      this.X2 = ChartDrawData.AnnotationData.\u0023\u003DqS8Rz7CLyLtZi1DPj0ZEyaLSgFDmJg4JMOyHZMbcvphk\u003D(storage.GetValue<IComparable>("X2", this.X2));
    ...
    public void Save(SettingsStorage storage)
    {
      ...
      storage.SetValue<IComparable>("X1", ChartDrawData.AnnotationData.\u0023\u003DqQ1G3fw2s0nP9veUenvj8sEj2aOo8jkJJ5IBJj0VGllQ\u003D(this.X1));
      storage.SetValue<IComparable>("Y1", this.Y1);
      storage.SetValue<IComparable>("X2", ChartDrawData.AnnotationData.\u0023\u003DqQ1G3fw2s0nP9veUenvj8sEj2aOo8jkJJ5IBJj0VGllQ\u003D(this.X2));
