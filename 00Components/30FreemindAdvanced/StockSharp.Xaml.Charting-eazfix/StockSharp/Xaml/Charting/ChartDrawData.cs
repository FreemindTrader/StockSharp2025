...
public class ChartDrawData : IChartDrawData
{
    ...
    public readonly struct sCandle : ChartDrawData.IDrawValue
    {
        ...
        public sCandle( DateTimeOffset _param1, DataType _param2, Decimal _param3, Decimal _param4, Decimal _param5, Decimal _param6, IEnumerable<CandlePriceLevel> _param7 )
        {
            ...
            this._candleArg = _param2 ?? throw new ArgumentNullException( "dataType" );
    ...
    public readonly struct sCandleColor :
    ...
    public readonly struct sActiveOrder : ChartDrawData.IDrawValue
    {
    ...
    public readonly struct IndicatorData : ChartDrawData.IDrawValue
    {
        ...
        public IndicatorData( DateTime _param1, IIndicatorValue _param2 )
        {
    ...
    public sealed class sTrade : ChartDrawData.IDrawValue
    {
        ...
        {
            return $"{"TransactionData"}: id={this.GetTransactionString()}, time={this.UtcTime()} {this.OrderSides()} {this.Volume}@{this.Volume}";
        }
    }
    ...
    public class AnnotationData : ChartDrawData.IDrawValue, IPersistable, IAnnotationData
    {
        ...
        public static IComparable ConvertToUTC( IComparable _param0 )
        {
            return _param0 is DateTime dateTime ? ( IComparable ) TimeHelper.UtcKind( dateTime ) : _param0;
        }

        public static IComparable ConvertToUniversalTime( IComparable _param0 )
        {
            switch ( _param0 )
            {
        ...
        public void Save( SettingsStorage storage )
        {
            ...
            System.Windows.Thickness? thickness = this.Thickness;
            ref System.Windows.Thickness? local = ref thickness;
            SettingsStorage settingsStorage8 = local.HasValue ? local.GetValueOrDefault().SaveSettings() : (SettingsStorage)null;
    ...
    public ChartDrawData( IEnumerable<RefPair<DateTimeOffset, IDictionary<IChartElement, object>>> _param1 )
    {
        if ( _param1 == null )
    ...
    public sealed class ChartDrawDataItem : IChartDrawData.IChartDrawDataItem
    {
        ...
        public ChartDrawDataItem( ChartDrawData _param1, DateTimeOffset _param2 )
        {
        ...
        public ChartDrawDataItem( ChartDrawData _param1, double _param2 )
        {
            this._drawData = _param1 ?? throw new ArgumentNullException( "" );
    ...
    public List<ChartDrawData.sCandle> GetCandleRelatedData(
    ...
    public List<ChartDrawData.sCandleColor> GetCandleColor(
      IChartCandleElement _param1 )
    {
    ...
    public List<ChartDrawData.IndicatorData> GetCandleRelatedData(
    ...
    public List<ChartDrawData.sTrade> GetCandleRelatedData(
    ...
    public List<ChartDrawData.sActiveOrder> GetCandleRelatedData(
    ...
    public List<ChartDrawData.sxTuple<DateTime>> GetLineTime(
    ...
    public List<ChartDrawData.sxTuple<double>> GetLineValue(
      IChartLineElement _param1 )
    {
    ...
    public IEnumerableEx<ChartDrawData.IDrawValue> GetCandleRelatedData( IChartLineElement _param1 )
    {
    ...
    public IEnumerableEx<ChartDrawData.IDrawValue> GetCandleRelatedData(
      IChartBandElement _param1 )
    {
        List<ChartDrawData.sxTuple<DateTime>> source1 = this.GetLineTime(_param1);
        if ( source1 != null && source1.Count > 0 )
    ...
    public ChartDrawData.AnnotationData GetAnnotation( IChartAnnotationElement _param1 )
    {
