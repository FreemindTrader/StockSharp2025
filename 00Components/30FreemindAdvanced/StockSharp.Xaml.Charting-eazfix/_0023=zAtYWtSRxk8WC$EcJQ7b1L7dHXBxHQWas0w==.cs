  ...
  Range<TimeSpan>
{
  ...
  public override IRange<TimeSpan> SetMinMax(
    ...
    double _param2)
  {
    this.SetMinMaxInternal(new TimeSpan(\u0023\u003DzNCoz_cr7eiA6K6bzw3PTSRjrsuvJB3oFJPVFS7w\u003D.\u0023\u003DzOS5Il8E\u003D((long) _param1.\u0023\u003DzZsq6ZfbZQvsf(), TimeSpan.MinValue.Ticks, TimeSpan.MaxValue.Ticks)), new TimeSpan(\u0023\u003DzNCoz_cr7eiA6K6bzw3PTSRjrsuvJB3oFJPVFS7w\u003D.\u0023\u003DzOS5Il8E\u003D((long) _param2.\u0023\u003DzZsq6ZfbZQvsf(), TimeSpan.MinValue.Ticks, TimeSpan.MaxValue.Ticks)));
