...
// Type: #=zNCT3Gnfe2tX07N5vDTkaUrpBxQ9IN4CBXg==
  ...
  IXmlSerializable
{
  ...
  public IAxis Default
  {
    get
    {
      return this.Count <= 0 ? (IAxis) null : this.\u0023\u003Dz\u0024YoxjvGBoa2C("DefaultAxisId", false);
    }
  }
    ...
    bool _param2)
  {
    ...
    try
    {
      ...
      return !_param2 || dynWmoFzgH4RlWB0lB != null ? dynWmoFzgH4RlWB0lB : throw new InvalidOperationException(string.Format("AxisCollection.GetAxisById('{0}') returned no axis with ID={0}. Please check you have added an axis with this Id to the AxisCollection", (object) (z9r5QdtX0xdsJ15Nf5Q.\u0023\u003DzQ9LPsT8\u003D ?? "NULL")));
    }
    catch
    {
      throw new InvalidOperationException(string.Format("AxisCollection.GetAxisById('{0}') returned more than one axis with the ID={0}. Please check you have assigned correct axis Ids when you have multiple axes in Ultrachart", (object) (z9r5QdtX0xdsJ15Nf5Q.\u0023\u003DzQ9LPsT8\u003D ?? "NULL")));
    }
  }

  private void \u0023\u003DzhWsB8Osx9PQj()
  {
