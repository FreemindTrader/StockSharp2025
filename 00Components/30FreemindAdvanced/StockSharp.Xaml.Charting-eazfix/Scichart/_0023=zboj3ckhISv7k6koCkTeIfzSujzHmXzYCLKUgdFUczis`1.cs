...
#nullable disable
internal abstract class \u0023\u003Dzboj3ckhISv7k6koCkTeIfzSujzHmXzYCLKUgdFUczis\u0024<T> : 
  IList<T>,
  ICollection<T>,
  IEnumerable<T>,
  IList,
  IEnumerable,
  ICollection,
  \u0023\u003Dz5tgJOvSsgsmn_0Qv_7eNQxgil7IMIZzTVOZnJ0QEWy6u<T>,
  \u0023\u003DzJhc8WdlQgSkcniY\u0024669ans2mQMwz_VJH0HVFEk8\u003D
{
  [DebuggerBrowsable(DebuggerBrowsableState.Never)]
  protected \u0023\u003DzN_ef\u0024eTD0bISWSKkIKedSvLP\u0024zDbYxtEhpMKleCtJGtGqo7ZPw\u003D\u003D<T> \u0023\u003DzkELV\u0024GPsC83d = (\u0023\u003DzN_ef\u0024eTD0bISWSKkIKedSvLP\u0024zDbYxtEhpMKleCtJGtGqo7ZPw\u003D\u003D<T>) new AbstractList<T>(128 /*0x80*/);

  public virtual \u0023\u003Dz9A9aKbwx17eqF3Yh7gjiWuPneE7x_PdElYKA_LxaZfcJ<T> \u0023\u003Dz1bvQV4SZTWpA(
    int _param1,
    int _param2)
  {
  ...
  {
    return this.Count == 0 ? -1 : this.IndexOf((T) Convert.ChangeType(_param1, typeof (T), (IFormatProvider) null));
  }

  public void Insert(int _param1, object _param2)
  {
    this.\u0023\u003DzkELV\u0024GPsC83d.Insert(_param1, (T) _param2);
  }

  public void Remove(object _param1)
  {
    this.\u0023\u003DzkELV\u0024GPsC83d.Remove((T) _param1);
  }
  ...
  public void GuiUpdateAndClear(T _param1)
  {
  ...
  {
    this.\u0023\u003DzkELV\u0024GPsC83d[_param1] = (T) _param2;
  }
