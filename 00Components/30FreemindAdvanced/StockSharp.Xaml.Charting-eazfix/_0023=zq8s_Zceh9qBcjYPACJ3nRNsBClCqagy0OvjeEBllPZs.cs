...
// Type: #=zq8s_Zceh9qBcjYPACJ3nRNsBClCqagy0OvjeEBllPZsP$cuKwdgjHjkWC9BrIZ3N4ZHIFdUHnvUR
...
#nullable disable
internal sealed class \u0023\u003Dzq8s_Zceh9qBcjYPACJ3nRNsBClCqagy0OvjeEBllPZsP\u0024cuKwdgjHjkWC9BrIZ3N4ZHIFdUHnvUR : 
  \u0023\u003DzzSC94lsu\u00242WfTPlDSLyhlOESA9yl1dafdSqQDeAMKXaBPbCxPlPQgez5bfFbgS\u0024CknPn64g\u003D
{
  ...
  public \u0023\u003Dzq8s_Zceh9qBcjYPACJ3nRNsBClCqagy0OvjeEBllPZsP\u0024cuKwdgjHjkWC9BrIZ3N4ZHIFdUHnvUR(
    int _param1)
  {
    this.\u0023\u003Dzcz7RxakSRn3uq70hWw\u003D\u003D = _param1;
    if (\u0023\u003Dzq8s_Zceh9qBcjYPACJ3nRNsBClCqagy0OvjeEBllPZsP\u0024cuKwdgjHjkWC9BrIZ3N4ZHIFdUHnvUR.\u0023\u003Dzj0UOcNgA12GrmdK3Yl_cpR5KTgS6[2] != 0)
      return;
    for (int val1 = 0; val1 < \u0023\u003Dzq8s_Zceh9qBcjYPACJ3nRNsBClCqagy0OvjeEBllPZsP\u0024cuKwdgjHjkWC9BrIZ3N4ZHIFdUHnvUR.\u0023\u003Dzj0UOcNgA12GrmdK3Yl_cpR5KTgS6.Length; ++val1)
      \u0023\u003Dzq8s_Zceh9qBcjYPACJ3nRNsBClCqagy0OvjeEBllPZsP\u0024cuKwdgjHjkWC9BrIZ3N4ZHIFdUHnvUR.\u0023\u003Dzj0UOcNgA12GrmdK3Yl_cpR5KTgS6[val1] = Math.Min(val1, (int) byte.MaxValue);
  }
    ...
    int _param4)
  {
    do
    {
      _param1[_param2] = _param3.\u0023\u003Dz4WHdt9g\u003D;
  ...
  public void \u0023\u003Dz1sAbEWOIYGyA(
    ...
    \u0023\u003DzUTCl8jvgS_4weG5YU7g\u00240UvSdtxx4ULRrY0tRkq5Lb2WIbkHw6NWSEwePinXgsJJ4Q\u003D\u003D _param3)
  {
    byte num = (byte) (((int) _param3.\u0023\u003Dz4WHdt9g\u003D - (int) _param1[_param2]) * (int) _param3.\u0023\u003DzKCqGEcs\u003D + ((int) _param1[_param2] << 8) >> 8);
    _param1[_param2] = num;
  }
