...
internal sealed class \u0023\u003DzYB09msiytIDFpDsyaHpANOfeInYFQo\u0024WpAIn1xziSGfNI1uko0FFh3E\u003D
{
  private static readonly IList<TimeSpan> \u0023\u003Dz3yhjwpbyTKgX = (IList<TimeSpan>) new TimeSpan[11]
  {
    ...
    \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzmlhV\u0024ev7WhIH(1),
    \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzmlhV\u0024ev7WhIH(3),
    \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzmlhV\u0024ev7WhIH(6),
    \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzKGRRRbI\u003D(1),
    \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzKGRRRbI\u003D(2),
    \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzKGRRRbI\u003D(5),
    \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzKGRRRbI\u003D(10)
  };
    ...
    int _param4)
  {
    ...
    {
      \u0023\u003DzmAi_JN5raoSBYo9w2IEI_3gFWH1eBtHUGwTeshC8eR8A btHuGwTeshC8eR8A = new \u0023\u003DzmAi_JN5raoSBYo9w2IEI_3gFWH1eBtHUGwTeshC8eR8A(0.0, (double) timeSpan1.Ticks / (double) \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzKGRRRbI\u003D(1).Ticks, _param3, (uint) h5gkzF2FxdwMnQnA.\u0023\u003DzkDUgQT\u0024Ndmp3);
      btHuGwTeshC8eR8A.\u0023\u003Dz2RD3F8MtvzO1();
      \u0023\u003DzPauio66DvxKtWOFEEHOV9Y7gefdi\u0024o2zLQ\u003D\u003D wofeehoV9Y7gefdiO2zLq = btHuGwTeshC8eR8A.\u0023\u003DzAnYO0vLQEDGX();
      \u0023\u003DzPm\u0024a5jxBEPxWxb6PrKARIzshiFBv2m5Lhw\u003D\u003D karIzshiFbv2m5Lhw = new \u0023\u003DzPm\u0024a5jxBEPxWxb6PrKARIzshiFBv2m5Lhw\u003D\u003D(\u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzKGRRRbI\u003D((int) wofeehoV9Y7gefdiO2zLq.\u0023\u003DzZ85DqsktXJL3()), \u0023\u003Dzm\u0024__dHBBbeN8TiOszDZ4threxLLudETYN2pgrj0XJaQz.\u0023\u003DzKGRRRbI\u003D((int) wofeehoV9Y7gefdiO2zLq.\u0023\u003Dzgq30Jn5PclK8()));
    }
    ...
    return new \u0023\u003DzgeFvyoahWukw3bL8yZfVYr7JNrME_OMqiz4nIDlTZlok(array3, source1, array4, array2);
  }
