  ...
  \u0023\u003Dzboj3ckhISv7k6koCkTeIfzSujzHmXzYCLKUgdFUczis\u0024<T>
{
    ...
    int _param1)
  {
    ...
    this.\u0023\u003DzkELV\u0024GPsC83d = (\u0023\u003DzN_ef\u0024eTD0bISWSKkIKedSvLP\u0024zDbYxtEhpMKleCtJGtGqo7ZPw\u003D\u003D<T>) new \u0023\u003DzTbSy5Tg7CNKewHb2FguXqwGUeAhM\u0024ieAvvjndn5pLsCI<T>(_param1);
    this.\u0023\u003Dzy04c1jB0PxOy = new T[_param1];
  }

  public override \u0023\u003Dz9A9aKbwx17eqF3Yh7gjiWuPneE7x_PdElYKA_LxaZfcJ<T> \u0023\u003Dz1bvQV4SZTWpA(
    int _param1,
    int _param2)
  {
    ...
    ((\u0023\u003DzTbSy5Tg7CNKewHb2FguXqwGUeAhM\u0024ieAvvjndn5pLsCI<T>) this.\u0023\u003DzkELV\u0024GPsC83d).\u0023\u003Dz3MbNd8U\u003D(num1, this.\u0023\u003Dzy04c1jB0PxOy, 0, num2);
  ...
  public IList<T> \u0023\u003Dz3TQv53iUYmxB()
  {
    return (IList<T>) this.\u0023\u003DzkELV\u0024GPsC83d.\u0023\u003DzRr4AYdnHaTxa();
  }
}
