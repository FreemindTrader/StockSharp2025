...
// Type: -.StackedMountainRenderableSeries
  ...
  \u0023\u003DzbZGwufOdFTewaG24h4AgEnzuMpofQ03Hc8jI6jE7b1HUFPrXQWmwDjkmjGOLarsxpjJdER0Gb4PvgE1uuw\u003D\u003D
{
  ...
  public static readonly DependencyProperty \u0023\u003Dz2Rta\u0024oTnlQkx = DependencyProperty.Register(nameof (StackedGroupId), typeof (string), typeof (StackedMountainRenderableSeries), new PropertyMetadata((object) "DefaultStackedGroupId", new PropertyChangedCallback(StackedMountainRenderableSeries.\u0023\u003DzyGQyqAS53k26)));
  
  public static readonly DependencyProperty \u0023\u003Dzj\u0024ZDuobq5\u0024GmruUxggpnzio\u003D = DependencyProperty.Register(nameof (IsOneHundredPercent), typeof (bool), typeof (StackedMountainRenderableSeries), new PropertyMetadata((object) false));

  public StackedMountainRenderableSeries()
  {
    this.DefaultStyleKey = (object) typeof (StackedMountainRenderableSeries);
  }
  ...
  public string StackedGroupId
  {
    get
    {
      return (string) this.GetValue(StackedMountainRenderableSeries.\u0023\u003Dz2Rta\u0024oTnlQkx);
    }
    set
    {
      this.SetValue(StackedMountainRenderableSeries.\u0023\u003Dz2Rta\u0024oTnlQkx, (object) value);
    }
  }
  ...
  public bool IsOneHundredPercent
  {
    get
    {
      return (bool) this.GetValue(StackedMountainRenderableSeries.\u0023\u003Dzj\u0024ZDuobq5\u0024GmruUxggpnzio\u003D);
    }
    set
    {
      this.SetValue(StackedMountainRenderableSeries.\u0023\u003Dzj\u0024ZDuobq5\u0024GmruUxggpnzio\u003D, (object) value);
  ...
  {
    if (!(_param0 is StackedMountainRenderableSeries sbylR2E2AeewaEjd) || sbylR2E2AeewaEjd.\u0023\u003Dz9NrWMa9\u00243uT8() == null)
      return;
