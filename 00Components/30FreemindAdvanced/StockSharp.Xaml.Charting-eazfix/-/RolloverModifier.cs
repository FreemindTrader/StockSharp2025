  ...
  VerticalSliceModifierBase
{
  ...
  public static readonly DependencyProperty \u0023\u003DzNRygy3vTBpTh = DependencyProperty.RegisterAttached("IncludeSeries", typeof (bool), typeof (RolloverModifier), new PropertyMetadata((object) true));
  
  public static readonly DependencyProperty \u0023\u003DzuExxmF6hE_Ve = DependencyProperty.Register(nameof (DrawVerticalLine), typeof (bool), typeof (RolloverModifier), new PropertyMetadata((object) true));
  ...
  {
    this.DefaultStyleKey = (object) typeof (RolloverModifier);
  ...
  {
    return (bool) _param0.GetValue(RolloverModifier.\u0023\u003DzNRygy3vTBpTh);
  }

  public static void SetIncludeSeries(DependencyObject _param0, bool _param1)
  {
    _param0.SetValue(RolloverModifier.\u0023\u003DzNRygy3vTBpTh, (object) _param1);
  }
  ...
  public bool DrawVerticalLine
  {
    get
    {
      return (bool) this.GetValue(RolloverModifier.\u0023\u003DzuExxmF6hE_Ve);
    }
    set
    {
      this.SetValue(RolloverModifier.\u0023\u003DzuExxmF6hE_Ve, (object) value);
    }
  }
