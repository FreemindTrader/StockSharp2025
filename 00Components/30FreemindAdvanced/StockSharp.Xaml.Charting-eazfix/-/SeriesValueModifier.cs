  ...
  ChartModifierBase
{
  ...
  public static readonly DependencyProperty YAxisIdProperty = DependencyProperty.Register(nameof (YAxisId), typeof (string), typeof (SeriesValueModifier), new PropertyMetadata((object) "DefaultAxisId", new PropertyChangedCallback(SeriesValueModifier.\u0023\u003DzdXB_wQ4DNB7BU25L6g\u003D\u003D)));
  
  public static readonly DependencyProperty \u0023\u003DzNnZwaoee8xziVPglsg\u003D\u003D = DependencyProperty.RegisterAttached("IsSeriesValueModifierEnabled", typeof (bool), typeof (SeriesValueModifier), new PropertyMetadata((object) true));
  
  public static readonly DependencyProperty \u0023\u003DzEf91H67L3cmpXtvCzf\u0024fF8UYUMr2 = DependencyProperty.RegisterAttached("IsRenderableSeriesInViewport", typeof (bool), typeof (SeriesValueModifier), new PropertyMetadata((object) false));
  
  public static readonly DependencyProperty \u0023\u003Dz8BRRl9X\u00241GaoKzQFLQ\u003D\u003D = DependencyProperty.RegisterAttached("IsLastPointInViewport", typeof (bool), typeof (SeriesValueModifier), new PropertyMetadata((object) false));
  
  public static readonly DependencyProperty \u0023\u003DzRuUiUh8wem3V = DependencyProperty.RegisterAttached("SeriesMarkerColor", typeof (Color), typeof (SeriesValueModifier), new PropertyMetadata((object) new Color()));
  ...
  {
    _param0.SetValue(SeriesValueModifier.\u0023\u003DzNnZwaoee8xziVPglsg\u003D\u003D, (object) _param1);
  }

  public static bool GetIsSeriesValueModifierEnabled(UIElement _param0)
  {
    return (bool) _param0.GetValue(SeriesValueModifier.\u0023\u003DzNnZwaoee8xziVPglsg\u003D\u003D);
  }

  public static bool GetIsRenderableSeriesInViewport(DependencyObject _param0)
  {
    return (bool) _param0.GetValue(SeriesValueModifier.\u0023\u003DzEf91H67L3cmpXtvCzf\u0024fF8UYUMr2);
  }

  public static void SetIsRenderableSeriesInViewport(DependencyObject _param0, bool _param1)
  {
    _param0.SetValue(SeriesValueModifier.\u0023\u003DzEf91H67L3cmpXtvCzf\u0024fF8UYUMr2, (object) _param1);
  }

  public static bool GetIsLastPointInViewport(DependencyObject _param0)
  {
    return (bool) _param0.GetValue(SeriesValueModifier.\u0023\u003Dz8BRRl9X\u00241GaoKzQFLQ\u003D\u003D);
  }

  public static void SetIsLastPointInViewport(DependencyObject _param0, bool _param1)
  {
    _param0.SetValue(SeriesValueModifier.\u0023\u003Dz8BRRl9X\u00241GaoKzQFLQ\u003D\u003D, (object) _param1);
  }

  public static Color GetSeriesMarkerColor(DependencyObject _param0)
  {
    return (Color) _param0.GetValue(SeriesValueModifier.\u0023\u003DzRuUiUh8wem3V);
  }

  public static void SetSeriesMarkerColor(DependencyObject _param0, Color _param1)
  {
    _param0.SetValue(SeriesValueModifier.\u0023\u003DzRuUiUh8wem3V, (object) _param1);
  }
  ...
  public Style AxisMarkerStyle
  {
    get
    {
      return (Style) this.GetValue(SeriesValueModifier.\u0023\u003Dzvp8Q5iyLlWID);
    }
    set
    {
      this.SetValue(SeriesValueModifier.\u0023\u003Dzvp8Q5iyLlWID, (object) value);
    }
  }
    ...
    \u0023\u003Dzd9zvJtNUzU9n1Kn1rKAcAUdzyaQmAfsVzCpDWg08TVWt _param1)
  {
    ...
    foreach (IRenderableSeries key in this.ParentSurface.get_RenderableSeries().Where<IRenderableSeries>(new Func<IRenderableSeries, bool>(this.\u0023\u003DzXKvQXbvtr98ebQ_YJw\u003D\u003D)))
    {
      ...
      {
        ls4St64EqzfbaEjd.SetValue(SeriesValueModifier.\u0023\u003DzEf91H67L3cmpXtvCzf\u0024fF8UYUMr2, (object) isDefined);
        ls4St64EqzfbaEjd.SetValue(SeriesValueModifier.\u0023\u003Dz8BRRl9X\u00241GaoKzQFLQ\u003D\u003D, (object) flag);
        Color color = !zldchDrVsrVyHh6WyiGy.\u0023\u003DzMeGSfVE\u003D() ? key.\u0023\u003Dz3_4\u0024b5dxRhLlXyFK3Q\u003D\u003D(zldchDrVsrVyHh6WyiGy) : ls4St64EqzfbaEjd.SeriesColor;
        ls4St64EqzfbaEjd.SetValue(SeriesValueModifier.\u0023\u003DzRuUiUh8wem3V, (object) color);
      }
  ...
  protected virtual string \u0023\u003DzMXsY2TplcAmh(
    ...
    IComparable _param2)
  {
    return ((AxisBase) _param1.YAxis).\u0023\u003DzRQVMnjXxoCTF(_param2, false);
  }
  ...
  {
    if (!(_param0 is SeriesValueModifier ubbaqxskcA3KuG553MxzEjd) || ubbaqxskcA3KuG553MxzEjd.ParentSurface == null)
      return;
