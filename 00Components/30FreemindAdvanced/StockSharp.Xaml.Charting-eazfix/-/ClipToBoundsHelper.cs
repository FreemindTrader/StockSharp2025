...
public static class ClipToBoundsHelper
{
  ...
  {
    return (bool) _param0.GetValue(ClipToBoundsHelper.\u0023\u003DzPqXZPEJZP3as);
  }

  public static void SetClipToBounds(DependencyObject _param0, bool _param1)
  {
    _param0.SetValue(ClipToBoundsHelper.\u0023\u003DzPqXZPEJZP3as, (object) _param1);
  }

  public static bool GetClipToEllipseBounds(DependencyObject _param0)
  {
    return (bool) _param0.GetValue(ClipToBoundsHelper.\u0023\u003DziVSP6OFqTkR8hihgtQ\u003D\u003D);
  }

  public static void SetClipToEllipseBounds(DependencyObject _param0, bool _param1)
  {
    _param0.SetValue(ClipToBoundsHelper.\u0023\u003DziVSP6OFqTkR8hihgtQ\u003D\u003D, (object) _param1);
  }
  ...
  {
    if (ClipToBoundsHelper.GetClipToBounds((DependencyObject) _param0))
    ...
    DependencyPropertyChangedEventArgs _param1)
  {
    if (!(_param0 is FrameworkElement frameworkElement))
      return;
    ClipToBoundsHelper.\u0023\u003DzvgmToiciTxzW(frameworkElement);
    frameworkElement.Loaded += ClipToBoundsHelper.SomeClass34343383.\u0023\u003DzjJ3vlfxVH92KtuUzew\u003D\u003D ?? (ClipToBoundsHelper.SomeClass34343383.\u0023\u003DzjJ3vlfxVH92KtuUzew\u003D\u003D = new RoutedEventHandler(ClipToBoundsHelper.SomeClass34343383.SomeMethond0343.\u0023\u003Dzey4uj458pf56Oqw2JddifQGfxNx1));
    frameworkElement.SizeChanged += ClipToBoundsHelper.SomeClass34343383.\u0023\u003DzyrbJPDSEp4QjajjhiA\u003D\u003D ?? (ClipToBoundsHelper.SomeClass34343383.\u0023\u003DzyrbJPDSEp4QjajjhiA\u003D\u003D = new SizeChangedEventHandler(ClipToBoundsHelper.SomeClass34343383.SomeMethond0343.\u0023\u003DzIdjSw7XvQEG2GMw8R94pNFvcNUgD));
  }

  private static void \u0023\u003DzvgmToiciTxzW(FrameworkElement _param0)
  {
    if (ClipToBoundsHelper.GetClipToEllipseBounds((DependencyObject) _param0))
    {
  ...
  {
    public static readonly ClipToBoundsHelper.SomeClass34343383 SomeMethond0343 = new ClipToBoundsHelper.SomeClass34343383();
