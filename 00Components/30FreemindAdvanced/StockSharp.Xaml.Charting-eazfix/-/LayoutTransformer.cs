  ...
  ContentControl
{
  ...
  public static readonly DependencyProperty \u0023\u003Dz32W8b1i6xoYS = DependencyProperty.Register(nameof (LayoutTransform), typeof (Transform), typeof (LayoutTransformer), new PropertyMetadata(new PropertyChangedCallback(LayoutTransformer.\u0023\u003Dz0HuiTL\u0024SKGca)));
  ...
  public new Transform LayoutTransform
  {
    get
    {
      return (Transform) this.GetValue(LayoutTransformer.\u0023\u003Dz32W8b1i6xoYS);
    }
    set
    {
      this.SetValue(LayoutTransformer.\u0023\u003Dz32W8b1i6xoYS, (object) value);
    }
  }
  ...
  public override void OnApplyTemplate()
  {
    ...
    this.\u0023\u003DzhIjAwTPpB57_ = (Panel) (this.GetTemplateChild("TransformRoot") as Grid);
    this.\u0023\u003DzZ\u00240zMrM8YIwq = this.GetTemplateChild("Presenter") as ContentPresenter;
  ...
  {
    ((LayoutTransformer) _param0).\u0023\u003DzFuJzw\u0024c\u003D((Transform) _param1.NewValue);
  }
  ...
  {
    this.\u0023\u003DzoNEXi9IWk2BNsqQ_lTShmRs\u003D = LayoutTransformer.\u0023\u003Dz83uKsjUrBFp7(this.\u0023\u003DzSgKrxhowo3cf(_param1), 4);
    ...
    switch (_param1)
    {
      case TransformGroup transformGroup:
        ...
        foreach (Transform child in transformGroup.Children)
          matrix = LayoutTransformer.\u0023\u003DzCewUhnWkyYIz(matrix, this.\u0023\u003DzSgKrxhowo3cf(child));
        return matrix;
  ...
  protected override Size MeasureOverride(Size _param1)
  {
    ...
    Rect rect = LayoutTransformer.\u0023\u003DzEzTnxQC3CD4\u0024(new Rect(0.0, 0.0, this.\u0023\u003DzhIjAwTPpB57_.DesiredSize.Width, this.\u0023\u003DzhIjAwTPpB57_.DesiredSize.Height), this.\u0023\u003DzoNEXi9IWk2BNsqQ_lTShmRs\u003D);
  ...
  protected override Size ArrangeOverride(Size _param1)
  {
    ...
    if (LayoutTransformer.\u0023\u003DzsTf\u0024wp8hY4v\u0024kW\u0024FiA\u003D\u003D(size, this.\u0023\u003DzhIjAwTPpB57_.DesiredSize))
      size = this.\u0023\u003DzhIjAwTPpB57_.DesiredSize;
    Rect rect = LayoutTransformer.\u0023\u003DzEzTnxQC3CD4\u0024(new Rect(0.0, 0.0, size.Width, size.Height), this.\u0023\u003DzoNEXi9IWk2BNsqQ_lTShmRs\u003D);
    ...
    if (LayoutTransformer.\u0023\u003DzsTf\u0024wp8hY4v\u0024kW\u0024FiA\u003D\u003D(size, frameworkElement.RenderSize) && Size.op_Equality(Size.Empty, this.\u0023\u003Dz60AC8Q2WG7I_))
    {
  ...
  private Size \u0023\u003DzthQJ9zgZOkOvr7IaO4b9cuE\u003D(Size _param1)
  {
    ...
    else if (!LayoutTransformer.\u0023\u003DzV9X1hDY95bUE(this.\u0023\u003DzoNEXi9IWk2BNsqQ_lTShmRs\u003D))
