  ...
  ChartBaseViewModel
{
  ...
  {
    get => this.\u0023\u003DzChcrgRo\u003D;
    set => this.SetField<string>(ref this.\u0023\u003DzChcrgRo\u003D, value, nameof (Name));
  }

  public Color Color
  {
    get => this.\u0023\u003Dzfzo3Zt0\u003D;
    set => this.SetField<Color>(ref this.\u0023\u003Dzfzo3Zt0\u003D, value, nameof (Color));
  }

  public string Value
  {
    get => this.\u0023\u003DzEBLPoa4\u003D;
    set => this.SetField<string>(ref this.\u0023\u003DzEBLPoa4\u003D, value, nameof (Value));
  }
