...
public interface IClientService : IBaseEntityService<Client>, ISmsService
{
    ...
    Task ChangePasswordAsync(string newPassword, long? clientId = null, CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task<bool> RemoveAwardAsync(long clientId, long awardId, CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task<Client> TryGetByTelegramIdAsync(long telegramId, CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task<Client> TryGetByEmailTokenAsync(string emailToken, CancellationToken cancellationToken = default(CancellationToken));
}
