...
// Type: StockSharp.Web.Api.Interfaces.IInstrumentDataTypeService
...
public interface IInstrumentDataTypeService : IBaseEntityService<InstrumentDataType>
{
    Task<BaseEntitySet<InstrumentDataType>> FindAsync(
      long skip = 0,
      long? count = null,
      bool? deleted = null,
      string orderBy = null,
    ...
    Task<InstrumentDataType> TryGetByInstrumentAndDataType(
      long instrumentId,
      long dataTypeId,
      CancellationToken cancellationToken = default(CancellationToken));
}
