...
// Type: StockSharp.Web.Api.Interfaces.IDiagramSocketService
...
public interface IDiagramSocketService : IBaseEntityService<DiagramSocket>
{
    Task<BaseEntitySet<DiagramSocket>> FindAsync(
      long skip = 0,
      long? count = null,
      bool? deleted = null,
      string orderBy = null,
