...
//        private int _count;
//        private int _lastBucketIndex;

//        public ThreadSafeGetOrCreateValueDictionary( Func< TKey, TValue > creator ) : this( creator, 31, null )
//        {
//        }
...
//                var newNode = new DatabarNode( hashCode, _baseNodes[ bucketIndex ], key, value );
//                _baseNodes[ bucketIndex ] = newNode;
//                _lastBucketIndex = bucketIndex;
...
//            get
//            {
//                return _baseNodes[ _lastBucketIndex ]._value;
//            }
//        }
...
//    public sealed class WeakGetOrCreateValueDictionary< TKey, TValue > where TValue : class
//    {
//        private sealed class DatabarNode
//        {
