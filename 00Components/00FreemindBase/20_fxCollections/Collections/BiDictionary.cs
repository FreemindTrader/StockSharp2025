...
namespace fx.Collections
{
    ...
    public class BiDictionary< ValueTypeKey, ValueTypeValue> where ValueTypeKey : notnull where ValueTypeValue : notnull
    {
        private PooledDictionary< ValueTypeKey, ValueTypeValue > _dictionary1 = new PooledDictionary< ValueTypeKey, ValueTypeValue >( );
        private PooledDictionary< ValueTypeValue, ValueTypeKey > _dictionary2 = new PooledDictionary< ValueTypeValue, ValueTypeKey >( );
        ...
        {
            if( _dictionary1.ContainsKey( keyValue ) ||
                 _dictionary2.ContainsKey( valueValue ) )
            {
                return false;
            }
