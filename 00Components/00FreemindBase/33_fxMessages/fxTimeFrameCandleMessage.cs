...
//			var str = $"{x:Type},Sec={SecurityId},A={periodString}, C={closeTime:HH:mm:ss yyyy/MM/dd},O={OpenTime: HH:mm:ss.fff yyyy/MM/dd},O={OpenPrice},H={HighPrice},L={LowPrice},C={ClosePrice},V={TotalVolume},S={State},TransId={OriginalTransactionId}";
