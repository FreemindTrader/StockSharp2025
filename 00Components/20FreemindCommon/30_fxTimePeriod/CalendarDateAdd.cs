...
namespace fx.TimePeriod
{
	...
	public class CalendarDateAdd : DateAdd
	{
		...
		private readonly PooledList<HourRange> workingHours = new PooledList<HourRange>();
		private readonly PooledList<DayHourRange> workingDayHours = new PooledList<DayHourRange>();
