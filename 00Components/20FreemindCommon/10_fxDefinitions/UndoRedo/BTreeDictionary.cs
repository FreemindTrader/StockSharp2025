...
namespace fx.Definitions.Collections
{
    /// <summary>
    ...
    public class BTreeDictionary<TKey, TValue> : ISortedDictionary<TKey, TValue>
    {
        ...
        /// <param name="nodeCapacity">The capacity in keys for each node in the tree structure.</param>
        public BTreeDictionary( IComparer<TKey> keyComparer,
                                int nodeCapacity )
        {
        ...
        public IEnumerable<KeyValuePair<TKey, TValue>> GetElementsRightOf( TKey keyLowerBound )
        {
            Contract.Ensures( Contract.Result<IEnumerable<KeyValuePair<TKey, TValue>>>( ) != null );

            Node leaf;
            int leafPos;
            var found = Node.Find( root, keyLowerBound, KeyComparer, AllowDuplicates ? -1 : 0, out leaf, out leafPos );
        ...
        public TValue GetRightElement( TKey keyLowerBound )
        {
            Node leaf;
            int leafPos;
            var found = Node.Find( root, keyLowerBound, KeyComparer, AllowDuplicates ? -1 : 0, out leaf, out leafPos );
        ...
        /// <param name="keyUpperBound">The value at which to start returning keys.</param>
        /// <returns>All key value pairs having a key equal or less than the upper bound, in key descending order.</returns>
        public IEnumerable<KeyValuePair<TKey, TValue>> GetElementsLeftOf( TKey keyUpperBound )
        {
            Contract.Ensures( Contract.Result<IEnumerable<KeyValuePair<TKey, TValue>>>( ) != null );
        ...
        public TValue GetLeftElement( TKey keyUpperBound )
        {
            Node leaf;
            int leafPos;
            var found = Node.Find( root, keyUpperBound, KeyComparer, AllowDuplicates ? 1 : 0, out leaf, out leafPos );
        ...
        sealed class Node
        {
            ...
            /// </summary>
            public static Node LeafAt( Node root,
                                       ref int pos )
            {
            ...
            /// </summary>
            public static bool Find( Node root,
                                     TKey key,
            ...
            /// </summary>
            public static void Insert( TKey key,
                                       ref Node leaf,
                                       ref int pos,
                                       ref Node root )
            {
            ...
            /// </summary>
            public static bool Remove( Node leaf,
                                       int pos,
                                       ref Node root )
            {
            ...
            /// </summary>
            public static IEnumerable<KeyValuePair<TKey, TValue>> ForwardFromIndex( Node leaf,
                                                                                        int pos )
            {
                Contract.Requires( leaf != null );
                Contract.Requires( leaf.IsLeaf );
            ...
            /// </summary>
            public static IEnumerable<KeyValuePair<TKey, TValue>> BackwardFromIndex( Node leaf,
                                                                                         int pos )
            {
                Contract.Requires( leaf != null );
                Contract.Requires( leaf.IsLeaf );
            ...
            /// </summary>
            public static int GetRootIndex( Node leaf,
                                            int pos )
            {
                var node = leaf;
                var rootIndex = pos;
            ...
            static void MoveToDuplicatesBoundary( TKey key,
                                                  IComparer<TKey> keyComparer,
                                                  int duplicatesBias,
                                                  ref Node node,
                                                  ref int pos )
            ...
            static bool EnsureSpace( Node node,
                                     ref Node root )
            {
            ...
            static void Move<TItem>( TItem[ ] source,
                                       int sourceIndex,
                                       int sourceTotal,
                                       TItem[ ] target,
                                       int targetIndex,
            ...
            static void EnsureParent( Node node,
                                      ref Node root )
            {
                if ( node.parent != null )
                    return;
            ...
            static void EnsureParentKey( Node node,
                                         int pos )
            {
        ...
        sealed class KeyCollection : KeyValueCollectionBase<TKey>,
                                     ISortedCollection<TKey>
        {
            ...
            public bool AllowDuplicates
            {
                get { return tree.AllowDuplicates; }
            }

            public IComparer<TKey> Comparer
            {
                get { return tree.KeyComparer; }
            }
            ...
            public IEnumerable<TKey> GetElementsRightOf( TKey lowerBound )
            {
                return tree.GetElementsRightOf( lowerBound ).Select( keyValue => keyValue.Key );
            }

            public IEnumerable<TKey> GetElementsLeftOf( TKey upperBound )
            {
                return tree.GetElementsLeftOf( upperBound ).Select( keyValue => keyValue.Key );
            }
