...
namespace fx.Definitions
{
    ...
    public class ChineseCalendar
    {
        ...
        public string GanZhiYearString
        {
            get
            {                
                return GanZhiYearSimple + "年";
            }
        }

        public string GanZhiYearSimple
        {
            get
            {
                string tempStr;
        ...
        public string GanZhiMonthString
        {
            get
            {                
                return GanZhiMonthSimple + "月";
            }
        }

        public string GanZhiMonthSimple
        {
            get
            {
        ...
        public string GanZhiDayString
        {
            get
            {                
                return GanZhiDaySimple + "日";
            }
        }

        public string GanZhiDaySimple
        {
            get
            {
                int i, offset;
        ...
        public string GanZhiDateSimple
        {
            get
            {
                return GanZhiYearSimple + GanZhiMonthSimple + GanZhiDaySimple;
            }
        }
        #endregion
        #endregion
