...
//    /// </summary>
//    
//    public partial struct HewShort : IHarmonicElliottWave<uint>
//    {
//        #region Variables        
//        private uint               _hewBits;
//                       
//        #endregion
...
//        public HewShort( HewShort other )
//        {
//            _hewBits = other.RawWave;            
//        }

//        public HewShort( HewShort other, ElliottWaveCycle mininumCycle )
//        {
//            _hewBits = other.RawWave;            

//            var waves          = other.GetAllWaves( mininumCycle );

//            WaveLabelPosition position = WaveLabelPosition.UNKNOWN;

//            foreach ( var wave in waves )
//            {
//                if ( position == WaveLabelPosition.UNKNOWN )
//                {
//                    position = wave.LabelPosition;
//                }
//                else if ( position != wave.LabelPosition )
//                {
//                    position = WaveLabelPosition.BOTH;
//                }
...
//        public HewShort( ElliottWaveCycle waveCycle, ElliottWaveEnum waveName, WaveLabelPosition waveLabelPosition )
//        {
//            _hewBits = 0;            
...
//        public HewShort( PooledList<WaveInfo> waves, WaveLabelPosition waveLabelPosition )
//        {
//            _hewBits = 0;
//            
...
//        public HewShort( WaveInfo wave, WaveLabelPosition waveLabelPosition )
//        {
//            _hewBits = 0;            
...
//        public HewShort( uint waveBit, WaveLabelPosition waveLabelPosition )
//        {
//            _hewBits = waveBit;            
//        }
...
//            {
//                if ( waveCycleCount < GlobalConstants.MaxCountPerInt )
//                {
//                    _hewBits |= ( uint ) bitwiseWave << ( int ) ( waveCycleCount * GlobalConstants.NewHewBits );
//                }                
//            }
...
//        private bool WaveExists( uint inputBitWave )
//        {
//            uint content = 0;
//            int extractedWave = 0;
...
//        public bool ReplaceWave( ElliottWaveCycle desiredCycle,
...
//        public bool ReplaceTopWave( uint selectedBarTime,
...
//        public bool ReplaceBottomWave( uint selectedBarTime,
//                                       ElliottWaveCycle desiredCycle,
//                                       ElliottWaveEnum oldElliottWave,
//                                       ElliottWaveEnum newElliottWave )
//        {
...
//        public WaveLabelPosition LabelPosition { get => GetLabelPositionFromHew(); set => throw new NotImplementedException(); }
//        public uint RawWaveExtra { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
...
//            if ( waveCycleCount <= GlobalConstants.MaxCountPerInt )
//            {
//                for ( int i = 0; i < GlobalConstants.MaxCountPerInt; i++ )
//                {
//                    content = _hewBits >> ( GlobalConstants.NewHewBits * i );
//                    var ewavePoint = new WaveInfo( content );
...
//        public PooledList<WaveInfo> GetBottomWaves( bool isFilterAB,
//                                                ElliottWaveCycle miniCycle )
//        {
...
//            int counter = ( int ) Math.Round( ( double ) ( sizeof( uint ) * 8 / GlobalConstants.NewHewBits ) );
...
//        public void MergeWave( uint waveBit, uint extraBit, WaveLabelPosition waveLabelPosition )
//        {
//            if ( waveBit != _hewBits )
//            {
//                var higherTimeFrameWave = new HewShort( waveBit, waveLabelPosition );
...
//        public void RemoveWaves( ref HewShort hew )
//        {
//            var tempWave = new HewShort( );
...
//        public bool RemoveMatchedWaves( HewShort hew )
//        {
...
//        public bool RemoveMatchedWaves( HewLong hew )
//        {
//            if ( this.Count == 0 ) return false;
...
//        public void CopyFrom( ref HewShort otherWave )
//        {
...
//        {
//            if ( otherWave.RawWave < uint.MaxValue )
//            {
//                _hewBits = ( uint ) otherWave.RawWave;
//            }
//            else
//            {
...
//            if ( obj is HewShort )
//            {
//                return Equals( ( HewShort ) obj );
//            }

//            return base.Equals( obj );
//        }

//        public static bool operator ==( HewShort first, HewShort second )
//        {
...
//        public bool Equals( HewShort other )
//        {
...
//        public void MergeInLowerTimeFrameWaves( ref HewShort otherHew, ElliottWaveCycle minimumCycle )
//        {
//            var allWaves = GetAllWaves( );
