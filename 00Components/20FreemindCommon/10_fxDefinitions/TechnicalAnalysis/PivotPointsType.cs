...
//        public MatchedSRinfo(ICandleBar bar, TimeSpan timePeriod, string name, double level, SRLineResponseType type )
//        {
//            _owningBar      = bar;
