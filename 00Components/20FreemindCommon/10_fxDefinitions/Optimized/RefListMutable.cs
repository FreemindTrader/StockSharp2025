...
//{
//    public static class RefListMutable
//    {
//        /// <summary>
...
//        /// </summary>
//        public static IList<T> AsMutableList<T>( this RefList<T> collection ) where T : IEquatable<T>
//        {
//            if ( collection == null )
//            {
...
//            return new _RefList<T>( collection );
//        }

//        private sealed class _RefList<T> where T : IEquatable<T>
//        {
//            private readonly RefList<T> _collection;

//            internal _RefList( RefList<T> collection )
//            {
