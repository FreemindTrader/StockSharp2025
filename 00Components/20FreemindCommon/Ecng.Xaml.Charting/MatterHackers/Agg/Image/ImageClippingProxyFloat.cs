...
// Type: MatterHackers.Agg.Image.ImageClippingProxyFloat
...
namespace MatterHackers.Agg.Image
{
    internal class ImageClippingProxyFloat : ImageProxyFloat
    {
        ...
        {
            RGBA_Floats asRgbaFloats = in_c.GetAsRGBA_Floats();
            if ( this.Width == 0 )
                return;
            for ( int y = 0 ; y < this.Height ; ++y )
                base.copy_hline( 0, y, this.Width, asRgbaFloats );
        }
        ...
        public override void CopyFrom( IImageFloat sourceImage, RectangleInt sourceImageRect, int destXOffset, int destYOffset )
        {
