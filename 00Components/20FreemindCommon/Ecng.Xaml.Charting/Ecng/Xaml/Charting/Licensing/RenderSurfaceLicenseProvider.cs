...
// Type: StockSharp.Xaml.Charting.Licensing.RenderSurfaceLicenseProvider
...
namespace StockSharp.Xaml.Charting.Licensing
{
    ...
    internal sealed class RenderSurfaceLicenseProvider : Credentials, IUltrachartLicenseProvider
    {
        ...
        {
            RenderSurfaceValidator.Validate( parameter, this.IsLicenseValid, this.LicenseDaysRemaining, this.LicenseType, this.ProductCode );
        }
    }
}
