...
internal static class ArrayOperations
{
    ...
    private class DecimalGenericArrayHelper : IGenericArrayHelper<decimal>
    {
        ...
        {
            decimal num = GenericMathFactory.New<decimal>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
        ...
        {
            IMath<decimal> math = GenericMathFactory.New<decimal>();
            max = math.MinValue;
            min = math.MaxValue;
            switch ( count )
            {
    ...
    private class DoubleGenericArrayHelper : IGenericArrayHelper<double>
    {
        ...
        {
            double num = GenericMathFactory.New<double>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
    ...
    private class SingleGenericArrayHelper : IGenericArrayHelper<float>
    {
        ...
        {
            float num = GenericMathFactory.New<float>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
    ...
    private class Int32GenericArrayHelper : IGenericArrayHelper<int>
    {
        ...
        {
            int num = GenericMathFactory.New<int>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
    ...
    private class UInt32GenericArrayHelper : IGenericArrayHelper<uint>
    {
        ...
        {
            uint num = GenericMathFactory.New<uint>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
    ...
    private class Int64GenericArrayHelper : IGenericArrayHelper<long>
    {
        ...
        {
            long num = GenericMathFactory.New<long>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
    ...
    private class UInt64GenericArrayHelper : IGenericArrayHelper<ulong>
    {
        ...
        {
            ulong num = GenericMathFactory.New<ulong>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
    ...
    private class Int16GenericArrayHelper : IGenericArrayHelper<short>
    {
        ...
        {
            short num = GenericMathFactory.New<short>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
    ...
    private class UInt16GenericArrayHelper : IGenericArrayHelper<ushort>
    {
        ...
        {
            ushort num = GenericMathFactory.New<ushort>().MinValue;
            switch ( count )
            {
                case 0:
                    return num;
    ...
    private class ByteGenericArrayHelper : IGenericArrayHelper<byte>
    {
        ...
        {
            byte b = GenericMathFactory.New<byte>().MinValue;
            switch ( count )
            {
                case 0:
                    return b;
    ...
    private class SByteGenericArrayHelper : IGenericArrayHelper<sbyte>
    {
        ...
        {
            sbyte b = GenericMathFactory.New<sbyte>().MinValue;
            switch ( count )
            {
                case 0:
                    return b;
    ...
    private class DateTimeGenericArrayHelper : IGenericArrayHelper<DateTime>
    {
        ...
        {
            DateTime dateTime = GenericMathFactory.New<DateTime>().MinValue;
            switch ( count )
            {
                case 0:
                    return dateTime;
        ...
        {
            IMath<DateTime> math = GenericMathFactory.New<DateTime>();
            max = math.MinValue;
            min = math.MaxValue;
            switch ( count )
            {
    ...
    private class TimeSpanGenericArrayHelper : IGenericArrayHelper<TimeSpan>
    {
        ...
        {
            TimeSpan timeSpan = GenericMathFactory.New<TimeSpan>().MinValue;
            switch ( count )
            {
                case 0:
                    return timeSpan;
        ...
        {
            IMath<TimeSpan> math = GenericMathFactory.New<TimeSpan>();
            max = math.MinValue;
            min = math.MaxValue;
            switch ( count )
            {
    ...
    internal static T Maximum<T>( IEnumerable<T> enumerable )
    {
        ...
        IMath<T> math = GenericMathFactory.New<T>();
        T val = math.MinValue;
    ...
    {
        IMath<T> math = (IMath<T>)GenericMathFactory.New<T>();
