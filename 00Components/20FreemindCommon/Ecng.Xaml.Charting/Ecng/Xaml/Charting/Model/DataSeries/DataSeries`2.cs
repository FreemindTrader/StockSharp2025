...
// Type: Ecng.Xaml.Charting.Model.DataSeries.DataSeries`2
...
namespace Ecng.Xaml.Charting.Model.DataSeries
{
    public abstract class DataSeries<TX, TY> : BindableObject, IDataSeries<TX, TY>, IDataSeries, ISuspendable where TX : IComparable where TY : IComparable
    {
        ...
        private Ecng.Xaml.Charting.Common.WeakReference<ISciChartSurface> _parentSurface;
        ...
        public ISciChartSurface ParentSurface
        {
            ...
            set
            {
                ...
                this._parentSurface = new Ecng.Xaml.Charting.Common.WeakReference<ISciChartSurface>( value );
            }
        }
        ...
        public virtual IRange XRange
        {
            get
            {
                lock ( this.SyncRoot )
                {
                    TX min = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.MaxValue;
                    TX max = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.MinValue;
        ...
        public IRange GetWindowedYRange( IRange xRange, bool getPositiveRange )
        {
            ...
            return indicesRange.IsDefined ? this.GetWindowedYRange( indicesRange, getPositiveRange ) : ( IRange ) this.NewRange( ( IComparable ) Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.MinValue, ( IComparable ) Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.MaxValue );
        }
        ...
        public IRange GetWindowedYRange( IndexRange xIndexRange, bool getPositiveRange )
        {
            lock ( this.SyncRoot )
            {
                TY existingYMax = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.MinValue;
                TY y = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.MaxValue;
        ...
        public int FindIndex( IComparable x, SearchMode searchMode = SearchMode.Exact )
        {
            ...
            if ( x.GetType() != typeof( TX ) )
            {
                ...
                double rhs = (double) x;
                TX lhs = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ZeroValue;
                lhs = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Inc( ref lhs );
                x = ( IComparable ) Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Mult( lhs, rhs );
            }
        ...
        protected T GetPositiveMin<T>( T positiveMin, T min ) where T : IComparable
        {
            ...
            IComparable comparable = typeof (T) == typeof (TX) ? (IComparable) Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ZeroValue : (IComparable) Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.ZeroValue;
        ...
        public TX GetXMinAt( int index, TX existingXMin )
        {
            ...
            return Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Min( existingXMin, xvalue );
        }
        ...
        internal TY ComputeMin( TY currentMin, TY inputMin, ISeriesColumn<TY> seriesColumn )
        {
            ...
            return Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.Min( currentMin, inputMin );
        }
        ...
        internal TY ComputeMax( TY currentMax, TY inputMax, ISeriesColumn<TY> seriesColumn )
        {
            ...
            return Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.Max( currentMax, inputMax );
        }
        ...
        internal TX ComputeMin( TX currentMin, TX inputMin, ISeriesColumn<TX> seriesColumn )
        {
            ...
            return Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Min( currentMin, inputMin );
        }
        ...
        internal TX ComputeMax( TX currentMax, TX inputMax, ISeriesColumn<TX> seriesColumn )
        {
            ...
            return Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Max( currentMax, inputMax );
        }
        ...
        public virtual int FindClosestPoint( IComparable xValue, IComparable yValue, double xyScaleRatio, double hitTestRadius )
        {
            ...
            lock ( this._syncRoot )
            {
                ...
                TX x1 = (TX) xValue;
                double num4 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ToDouble(x1);
                if ( this.IsSorted )
                {
                    if ( xyScaleRatio.CompareTo( 0.0 ) == 0 )
                    {
                        num1 = uncheckedList1.FindIndexInSortedData<TX>( count, x1, SearchMode.Nearest, Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath );
                    }
                    else
                    {
                        TX zeroValue = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ZeroValue;
                        TX lhs = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Inc(ref zeroValue);
                        ...
                        TX x2 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Mult(lhs, hitTestRadius);
                        TX x3 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Subtract(x1, x2);
                        TX x4 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Add(x1, x2);
                        int indexInSortedData1 = uncheckedList1.FindIndexInSortedData<TX>(count, x3, SearchMode.RoundDown, Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath);
                        int indexInSortedData2 = uncheckedList1.FindIndexInSortedData<TX>(count, x4, SearchMode.RoundUp, Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath);
                ...
                if ( num1 == -1 )
                {
                    ...
                    {
                        double num7 = Math.Abs(Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ToDouble(uncheckedList1[index]) - num4);
                        if ( xyScaleRatio.CompareTo( 0.0 ) != 0 )
                        {
                            double num8 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.ToDouble(Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.Subtract(uncheckedList2[index], (TY) yValue));
        ...
        public virtual int FindClosestLine( IComparable x, IComparable y, double xyScaleRatio, double xRadius, LineDrawMode drawNanAs )
        {
            ...
            lock ( this._syncRoot )
            {
                ...
                if ( this.IsSorted )
                {
                    TX x2 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ZeroValue;
                    x2 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Inc( ref x2 );
                    x2 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Mult( x2, xRadius );
                    int indexInSortedData1 = uncheckedList1.FindIndexInSortedData<TX>(count, Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Subtract(x1, x2), SearchMode.RoundDown, Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath);
                    int indexInSortedData2 = uncheckedList1.FindIndexInSortedData<TX>(count, Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.Add(x1, x2), SearchMode.RoundUp, Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath);
                    if ( drawNanAs == LineDrawMode.ClosedLines )
                    {
                        while ( indexInSortedData1 > 0 && Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.IsNaN( uncheckedList2[ indexInSortedData1 ] ) )
                        {
                            --indexInSortedData1;
                        }

                        while ( indexInSortedData2 < this.Count - 1 && Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.IsNaN( uncheckedList2[ indexInSortedData2 ] ) )
                        {
                            ++indexInSortedData2;
                        }
                ...
                double x3 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ToDouble(x1);
                double num3 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.ToDouble(y1);
                Point pt = new Point(x3, num3 * xyScaleRatio);
                double num4 = double.MaxValue;
                double x4 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ToDouble(uncheckedList1[index1]);
                double y2 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.ToDouble(uncheckedList2[index1]) * xyScaleRatio;
                ...
                for ( int index2 = index1 + 1 ; index2 < num8 ; ++index2 )
                {
                    ...
                    if ( Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.IsNaN( y3 ) )
                    {
                    ...
                    {
                        double x2 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.XMath.ToDouble(uncheckedList1[index2]);
                        double y4 = Ecng.Xaml.Charting.Model.DataSeries.DataSeries<TX, TY>.YMath.ToDouble(y3) * xyScaleRatio;
