...
// Type: StockSharp.Xaml.Charting.Visuals.RenderableSeries.FastXORenderableSeries
...
namespace StockSharp.Xaml.Charting.Visuals.RenderableSeries
{
    ...
    {
        public static readonly DependencyProperty XOBoxSizeProperty = DependencyProperty.Register(nameof (XOBoxSize), typeof (double), typeof (FastXORenderableSeries), new PropertyMetadata((object) 0.0, new PropertyChangedCallback(BaseRenderableSeries.OnInvalidateParentSurface)));

        public double XOBoxSize
        {
            get
            {
                return ( double ) this.GetValue( FastXORenderableSeries.XOBoxSizeProperty );
            }
            set
            {
                this.SetValue( FastXORenderableSeries.XOBoxSizeProperty, ( object ) value );
            }
        }
        ...
        public FastXORenderableSeries()
        {
            ...
            this.SetCurrentValue( FastOhlcRenderableSeries.DataPointWidthProperty, ( object ) 1.0 );
        }
