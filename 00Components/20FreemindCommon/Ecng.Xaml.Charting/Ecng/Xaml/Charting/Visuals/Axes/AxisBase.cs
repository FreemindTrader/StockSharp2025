...
//// Type: fx.Xaml.Charting.AxisBase
...
//    {
//        public static readonly DependencyProperty TickCoordinatesProviderProperty = DependencyProperty.Register(nameof (TickCoordinatesProvider), typeof (ITickCoordinatesProvider), typeof (AxisBase), new PropertyMetadata(new PropertyChangedCallback(AxisBase.OnTickCoordinatesProviderChanged)));
//        public static readonly DependencyProperty IsStaticAxisProperty            = DependencyProperty.Register(nameof (IsStaticAxis), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) false, new PropertyChangedCallback(AxisBase.OnIsStaticAxisChanged)));
//        public static readonly DependencyProperty IsPrimaryAxisProperty           = DependencyProperty.Register(nameof (IsPrimaryAxis), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) false, new PropertyChangedCallback(AxisBase.OnIsPrimaryAxisChanged)));
//        public static readonly DependencyProperty IsCenterAxisProperty            = DependencyProperty.Register(nameof (IsCenterAxis), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) false, new PropertyChangedCallback(AxisBase.OnIsCenterAxisDependencyPropertyChanged)));
...
//        public static readonly DependencyProperty AxisModeProperty                = DependencyProperty.Register(nameof (AxisMode), typeof (AxisMode), typeof (AxisBase), new PropertyMetadata((object) AxisMode.Linear));
//        public static readonly DependencyProperty AutoRangeProperty               = DependencyProperty.Register(nameof (AutoRange), typeof (AutoRange), typeof (AxisBase), new PropertyMetadata((object) AutoRange.Once, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty MajorDeltaProperty              = DependencyProperty.Register(nameof (MajorDelta), typeof (IComparable), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty MinorDeltaProperty              = DependencyProperty.Register(nameof (MinorDelta), typeof (IComparable), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty MinorsPerMajorProperty          = DependencyProperty.Register(nameof (MinorsPerMajor), typeof (int), typeof (AxisBase), new PropertyMetadata((object) 5, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty GrowByProperty                  = DependencyProperty.Register(nameof (GrowBy), typeof (IRange<double>), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty VisibleRangeProperty            = DependencyProperty.Register(nameof (VisibleRange), typeof (IRange), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.OnVisibleRangeDependencyPropertyChanged)));
//        public static readonly DependencyProperty VisibleRangeLimitProperty       = DependencyProperty.Register(nameof (VisibleRangeLimit), typeof (IRange), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.OnVisibleRangeLimitDependencyPropertyChanged)));
//        public static readonly DependencyProperty VisibleRangeLimitModeProperty   = DependencyProperty.Register(nameof (VisibleRangeLimitMode), typeof (RangeClipMode), typeof (AxisBase), new PropertyMetadata((object) RangeClipMode.MinMax));
//        public static readonly DependencyProperty AnimatedVisibleRangeProperty    = DependencyProperty.Register(nameof (AnimatedVisibleRange), typeof (IRange), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.OnAnimatedVisibleRangeDependencyPropertyChanged)));
//        public static readonly DependencyProperty VisibleRangePointProperty       = DependencyProperty.Register("VisibleRangePoint", typeof (Point), typeof (AxisBase), new PropertyMetadata((object) new Point(), new PropertyChangedCallback(AxisBase.OnVisibleRangePointDependencyPropertyChanged)));
//        public static readonly DependencyProperty AutoAlignVisibleRangeProperty   = DependencyProperty.Register(nameof (AutoAlignVisibleRange), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) false, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty MaxAutoTicksProperty            = DependencyProperty.Register(nameof (MaxAutoTicks), typeof (int), typeof (AxisBase), new PropertyMetadata((object) 10, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty AutoTicksProperty               = DependencyProperty.Register(nameof (AutoTicks), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) true, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty TickProviderProperty            = DependencyProperty.Register(nameof (TickProvider), typeof (ITickProvider), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.OnTickProviderChanged)));
//        public static readonly DependencyProperty MinimalZoomConstrainProperty    = DependencyProperty.Register(nameof (MinimalZoomConstrain), typeof (IComparable), typeof (AxisBase), new PropertyMetadata((object) null));
//        public static readonly DependencyProperty OrientationProperty             = DependencyProperty.Register(nameof (Orientation), typeof (Orientation), typeof (AxisBase), new PropertyMetadata((object) Orientation.Horizontal, new PropertyChangedCallback(AxisBase.OnOrientationChanged)));
//        public static readonly DependencyProperty AxisAlignmentProperty           = DependencyProperty.Register(nameof (AxisAlignment), typeof (AxisAlignment), typeof (AxisBase), new PropertyMetadata((object) AxisAlignment.Default, new PropertyChangedCallback(AxisBase.OnAlignmentChanged)));
//        public static readonly DependencyProperty IdProperty                      = DependencyProperty.Register(nameof (Id), typeof (string), typeof (AxisBase), new PropertyMetadata((object) nameof (DefaultAxisId), new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty FlipCoordinatesProperty         = DependencyProperty.Register(nameof (FlipCoordinates), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) false, new PropertyChangedCallback(AxisBase.OnFlipCoordinatesChanged)));
//        public static readonly DependencyProperty LabelProviderProperty           = DependencyProperty.Register(nameof (LabelProvider), typeof (ILabelProvider), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.OnLabelProviderChanged)));
//        public static readonly DependencyProperty DefaultLabelProviderProperty    = DependencyProperty.Register(nameof (DefaultLabelProvider), typeof (ILabelProvider), typeof (AxisBase), new PropertyMetadata((PropertyChangedCallback) null));
//        public static readonly DependencyProperty TextFormattingProperty          = DependencyProperty.Register(nameof (TextFormatting), typeof (string), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty CursorTextFormattingProperty    = DependencyProperty.Register(nameof (CursorTextFormatting), typeof (string), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty AxisTitleProperty               = DependencyProperty.Register(nameof (AxisTitle), typeof (string), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty TitleStyleProperty              = DependencyProperty.Register(nameof (TitleStyle), typeof (Style), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty TitleFontWeightProperty         = DependencyProperty.Register(nameof (TitleFontWeight), typeof (FontWeight), typeof (AxisBase), new PropertyMetadata((object) FontWeights.Normal, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty TitleFontSizeProperty           = DependencyProperty.Register(nameof (TitleFontSize), typeof (double), typeof (AxisBase), new PropertyMetadata((object) 12.0, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty TickTextBrushProperty           = DependencyProperty.Register(nameof (TickTextBrush), typeof (Brush), typeof (AxisBase), new PropertyMetadata(new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty StrokeThicknessProperty         = DependencyProperty.Register(nameof (StrokeThickness), typeof (double), typeof (AxisBase), new PropertyMetadata((object) 1.0, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty MajorTickLineStyleProperty      = DependencyProperty.Register(nameof (MajorTickLineStyle), typeof (Style), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty MinorTickLineStyleProperty      = DependencyProperty.Register(nameof (MinorTickLineStyle), typeof (Style), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty DrawMajorTicksProperty          = DependencyProperty.Register(nameof (DrawMajorTicks), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) true, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty DrawMinorTicksProperty          = DependencyProperty.Register(nameof (DrawMinorTicks), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) true, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty DrawLabelsProperty              = DependencyProperty.Register(nameof (DrawLabels), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) true, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty MajorGridLineStyleProperty      = DependencyProperty.Register(nameof (MajorGridLineStyle), typeof (Style), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty MinorGridLineStyleProperty      = DependencyProperty.Register(nameof (MinorGridLineStyle), typeof (Style), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty DrawMajorGridLinesProperty      = DependencyProperty.Register(nameof (DrawMajorGridLines), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) true, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty DrawMinorGridLinesProperty      = DependencyProperty.Register(nameof (DrawMinorGridLines), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) true, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty DrawMajorBandsProperty          = DependencyProperty.Register(nameof (DrawMajorBands), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) false, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty AxisBandsFillProperty           = DependencyProperty.Register(nameof (AxisBandsFill), typeof (Color), typeof (AxisBase), new PropertyMetadata((object) new Color(), new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty TickLabelStyleProperty          = DependencyProperty.Register(nameof (TickLabelStyle), typeof (Style), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.InvalidateParent)));
//        public static readonly DependencyProperty ScrollbarProperty               = DependencyProperty.Register(nameof (Scrollbar), typeof (UltrachartScrollbar), typeof (AxisBase), new PropertyMetadata((object) null, new PropertyChangedCallback(AxisBase.OnScrollBarChanged)));
//        public static readonly DependencyProperty IsLabelCullingEnabledProperty   = DependencyProperty.Register(nameof (IsLabelCullingEnabled), typeof (bool), typeof (AxisBase), new PropertyMetadata((object) true, new PropertyChangedCallback(AxisBase.InvalidateParent)));
...
//        private fx.Xaml.Charting.Themes.ModifierAxisCanvas _modifierAxisCanvas;
...
//            new StockSharp.Xaml.Licensing.Core.LicenseManager().Validate<AxisBase>( this, ( IProviderFactory ) new UltrachartLicenseProviderFactory() );
//        }

//        internal AxisBase( IAxisPanel axisPanel )
//          : this()
//        {
...
//        {
//            _labelsPool = _labelsPool ?? ( this is NumericAxis ? ( ITickLabelsPool ) new fx.Xaml.Charting.TickLabelsPool<NumericTickLabel>( MaxAutoTicks, new Func<DefaultTickLabel, DefaultTickLabel>( ApplyStyle ) ) : ( ITickLabelsPool ) new fx.Xaml.Charting.TickLabelsPool<DefaultTickLabel>( MaxAutoTicks, new Func<DefaultTickLabel, DefaultTickLabel>( ApplyStyle ) ) );
//        }

//        private DefaultTickLabel ApplyStyle( DefaultTickLabel defaultTickLabel )
//        {
//            defaultTickLabel.DataContext =  null;
//            defaultTickLabel.SetBinding( DefaultTickLabel.DefaultForegroundProperty, ( BindingBase ) new Binding( "TickTextBrush" )
//            {
//                Source =  this
//            } );
//            defaultTickLabel.SetBinding( DefaultTickLabel.DefaultHorizontalAnchorPointProperty, ( BindingBase ) new Binding( "AxisAlignment" )
//            {
//                Source =  this,
//                Converter = ( IValueConverter ) _axisAlignmentToHorizontalAnchorPointConverter
//            } );
//            defaultTickLabel.SetBinding( DefaultTickLabel.DefaultVerticalAnchorPointProperty, ( BindingBase ) new Binding( "AxisAlignment" )
//            {
//                Source =  this,
//                Converter = ( IValueConverter ) _axisAlignmentToVerticalAnchorPointConverter
//            } );
//            defaultTickLabel.SetBinding( FrameworkElement.StyleProperty, ( BindingBase ) new Binding( "TickLabelStyle" )
//            {
//                Source =  this
//            } );
...
//        protected IGridLinesPanel GridLinesPanel
//        {
//            get
//            {
//                if ( ParentSurface == null )
//                {
//                    return ( IGridLinesPanel ) null;
//                }

//                return ParentSurface.GridLinesPanel;
//            }
//        }
...
//            foreach ( IRenderableSeries renderableSeries in ParentSurface.RenderableSeries.Where<IRenderableSeries>( ( Func<IRenderableSeries, bool> ) ( x =>
//            {
...
//                } ) ) )
//                {
//                    IRange xRange = xRanges == null || !xRanges.ContainsKey(renderableSeries.XAxisId) ? (renderableSeries.XAxis ?? ParentSurface.XAxes.GetAxisById(renderableSeries.XAxisId, true)).VisibleRange : xRanges[renderableSeries.XAxisId];
//                    if ( xRange != null && xRange.IsDefined )
//                    {
...
//            TrySetOrAnimateVisibleRange( newRange, duration );
//        }
...
//        {
//            return IsOfValidType( range ) && range.IsDefined && range.Min.CompareTo(  range.Max ) <= 0;
//        }
...
//            {
//                throw new InvalidOperationException( string.Format( "{0} does not support the type {1}. Supported types include {2}",  GetType().Name,  dataType,  string.Join( ", ", supportedTypes.Select<Type, string>( ( Func<Type, string> ) ( x => x.Name ) ).ToArray<string>() ) ) );
//            }
//        }
...
//        {
//            if ( !AutoTicks && ( MajorDelta == null || MajorDelta.Equals( AxisBase.MajorDeltaProperty.GetMetadata( typeof( AxisBase ) ).DefaultValue ) || ( MinorDelta == null || MinorDelta.Equals( AxisBase.MinorDeltaProperty.GetMetadata( typeof( AxisBase ) ).DefaultValue ) ) ) )
//            {
...
//        {
//            _currentCoordinateCalculator = ( Services == null ? ( ICoordinateCalculatorFactory ) new CoordinateCalculatorFactory() : Services.GetService<ICoordinateCalculatorFactory>() ).New( GetAxisParams() );
//            _currentInteractivityHelper = ( IAxisInteractivityHelper ) new AxisInteractivityHelper( _currentCoordinateCalculator );
...
//            {
//                IRenderableSeries renderableSeries = IsXAxis ? ParentSurface.RenderableSeries.FirstOrDefault<IRenderableSeries>((Func<IRenderableSeries, bool>) (x =>
//                {
//                    if (x.XAxisId == Id)
//                    {
//                        return x.DataSeries.HasValues;
...
//                    return false;
//                })) : ParentSurface.RenderableSeries.FirstOrDefault<IRenderableSeries>((Func<IRenderableSeries, bool>) (x =>
//                {
//                    if (x.YAxisId == Id)
//                    {
//                        return x.DataSeries.HasValues;
...
//        {
//            return ElementExtensions.IsPointWithinBounds( this, ParentSurface.RootGrid.TranslatePoint( point, ( IHitTestable ) this ) );
//        }
...
//                stopwatch.Stop();
//                UltrachartDebugLogger.Instance.WriteLine( "Drawn {0}: Width={1}, Height={2} in {3}ms",  GetType().Name,  ActualWidth,  ActualHeight,  stopwatch.ElapsedMilliseconds );
//            }
//        }
...
//            if ( parentSurface != null && parentSurface.IsVisible() && IsVisible() )
//            {
//                return HasAxisPanel();
//            }
...
//            {
//                renderContext.Layers[ RenderLayer.AxisMinorGridlines ].Enqueue( ( Action ) ( ( ) => DrawGridLine( renderContext, MinorGridLineStyle, ( IEnumerable<float> ) tickCoords.MinorTickCoordinates ) ) );
//            }
...
//            if ( DrawMajorBands )
//            {
//                renderContext.Layers[ RenderLayer.AxisBands ].Enqueue( ( Action ) ( ( ) => DrawBand( renderContext, tickCoords.MajorTicks, tickCoords.MajorTickCoordinates ) ) );
//            }
...
//            renderContext.Layers[ RenderLayer.AxisMajorGridlines ].Enqueue( ( Action ) ( ( ) => DrawGridLine( renderContext, MajorGridLineStyle, ( IEnumerable<float> ) tickCoords.MajorTickCoordinates ) ) );
//        }
...
//            Point pt1 = direction == XyDirection.YDirection ? new Point(0.0, (double) coord0) : new Point((double) coord0, 0.0);
//            Point pt2 = direction == XyDirection.YDirection ? new Point(renderSurface.ActualWidth, (double) coord1) : new Point((double) coord1, renderSurface.ActualHeight);
...
//            Point pt1 = direction == XyDirection.YDirection ? new Point(-(double) strokeThickness, (double) atPoint) : new Point((double) atPoint, -(double) strokeThickness);
//            Point pt2 = direction == XyDirection.YDirection ? new Point(renderSurface.ActualWidth + (double) strokeThickness, (double) atPoint) : new Point((double) atPoint, renderSurface.ActualHeight + (double) strokeThickness);
...
//                DefaultTickLabel label = index < canvas.Children.Count ? (DefaultTickLabel) canvas.Children[index] : _labelsPool.Get(new Func<DefaultTickLabel, DefaultTickLabel>(ApplyStyle));
...
//            label.DataContext = label.DataContext == null ?  labelProvider.CreateDataContext( value ) :  labelProvider.UpdateDataContext( ( ITickLabelViewModel ) label.DataContext, value );
//        }

//        private int CalculateLabelCullingPriority( double tick )
//        {
//            Decimal tickNum = GetMajorTickIndex(tick);
//            return ( ( IEnumerable<int> ) AxisBase.LabelCullingDistances ).Count<int>( ( Func<int, bool> ) ( i => tickNum % ( Decimal ) i == Decimal.Zero ) );
//        }
...
//            ( ( fx.Xaml.Charting.Themes.AxisPanel ) _axisPanel ).AddLabels = ( Action<AxisCanvas> ) ( canvas =>
//            {
...
//            } );
//            _modifierAxisCanvas = GetAndAssertTemplateChild<fx.Xaml.Charting.Themes.ModifierAxisCanvas>( "PART_ModifierAxisCanvas" );
...
//            {
//                throw new InvalidOperationException( string.Format( "Unable to Apply the Control Template. {0} is missing or of the wrong type",  childName ) );
//            }
...
//                if ( oldValue != null )
//                {
//                    oldValue.PropertyChanged -= new PropertyChangedEventHandler( axisBase.OnMaxMinVisibleRangePropertiesChanged );
//                }
...
//                else
//                {
//                    newValue.PropertyChanged += new PropertyChangedEventHandler( axisBase.OnMaxMinVisibleRangePropertiesChanged );
...
//            {
//                throw new ArgumentException( string.Format( "VisibleRange.Min (value={0}) must be less than VisibleRange.Max (value={1})",  range.Min,  range.Max ) );
//            }
//        }
...
//            {
//                throw new InvalidOperationException( string.Format( "Axis type {0} requires that VisibleRange is of type {1}",  GetType().Name,  VisibleRange.GetType().FullName ) );
//            }
//        }
...
//            if ( oldValue != null )
//            {
//                oldValue.PropertyChanged -= new PropertyChangedEventHandler( axisBase.OnMaxMinVisibleRangeLimitPropertiesChanged );
//            }
...
//                Storyboard.SetTargetProperty( ( DependencyObject ) pointAnimation, new PropertyPath( "VisibleRangePoint", new object[ 0 ] ) );
//                Storyboard storyboard1 = new Storyboard();
//                storyboard1.Duration = ( Duration ) duration;
//                Storyboard storyboard2 = storyboard1;
//                storyboard2.Children.Add( ( Timeline ) pointAnimation );
...
//            axis.Dispatcher.BeginInvokeAlways( ( Action ) ( ( ) =>
//            {
...
//                axis.VisibleRange = RangeFactory.NewRange( axis.VisibleRange.GetType(), ( IComparable ) y1, ( IComparable ) y2 );
//            } ) );
//        }
...
//            Services.GetService<IEventAggregator>().Publish<InvalidateUltrachartMessage>( new InvalidateUltrachartMessage(  this ) );
//        }
...
//            axisBase.TickCoordinatesProvider = axisBase.IsStaticAxis ? ( ITickCoordinatesProvider ) new StaticTickCoordinatesProvider() : ( ITickCoordinatesProvider ) new DefaultTickCoordinatesProvider();
//        }
...
public abstract class AxisBase : ContentControl, IAxis, IAxisParams, IHitTestable, ISuspendable, IInvalidatableElement, IDrawable, INotifyPropertyChanged, IXmlSerializable
{
    ...
    private ISciChartSurface _parentSurface;
    private IAxisPanel _axisPanel;
    private fx.Xaml.Charting.ModifierAxisCanvas _modifierAxisCanvas;
    private ITickLabelsPool _labelsPool;
    private TickCoordinates _tickCoords;
    private float _offset;
    private bool _isAnimationChange;
    ...
    private void InitializeLabelsPool()
    {
        _labelsPool = _labelsPool ??
            ( this is NumericAxis
                ? ( ITickLabelsPool ) new fx.Xaml.Charting.TickLabelsPool<NumericTickLabel>(
                    MaxAutoTicks,
                    new Func<DefaultTickLabel, DefaultTickLabel>( ApplyStyle ) )
                : ( ITickLabelsPool ) new fx.Xaml.Charting.TickLabelsPool<DefaultTickLabel>(
                    MaxAutoTicks,
                    new Func<DefaultTickLabel, DefaultTickLabel>( ApplyStyle ) ) );
    }
    ...
    public override void OnApplyTemplate()
    {
        ...
        _axisContainer = GetAndAssertTemplateChild<StackPanel>( "PART_AxisContainer" );
        _axisPanel = GetAndAssertTemplateChild<IAxisPanel>( "PART_AxisCanvas" );
        ( ( fx.Xaml.Charting.AxisPanel ) _axisPanel ).AddLabels = ( Action<AxisCanvas> ) ( canvas =>
        {
            if ( !IsValidForDrawing() || !IsShown() )
                return;
            DrawTickLabels( canvas, _tickCoords, _offset );
        } );
        _modifierAxisCanvas = GetAndAssertTemplateChild<fx.Xaml.Charting.ModifierAxisCanvas>(
