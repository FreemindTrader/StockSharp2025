...
//{
//    public abstract partial class EntitiesViewModel< TEntity, TProjection, TUnitOfWork > : EntitiesViewModelBase< TEntity, TProjection, TUnitOfWork >
//    where TEntity     :  class
...
//            ObservableCollection< TProjection > Entities
//            {
...
//                {
//                    owner.OnEntitiesLoaded( 
//                                                GetUnitOfWork( Repository ), 
//                                                new TProjection[ ]
//                                                { 
//                                                    projectionEntity
//                                                } 
...
//        /// <summary>
//        /// This property is binded to the WPF UI throught the following XAML. 
//        /// <dxg:GridControl Name="gridControl" ItemsSource="{Binding Entities}" ShowBorder="False" SelectedItem="{Binding SelectedEntity}" ShowLoadingPanel="{Binding IsLoading}" >
//        /// This WPF data binding caused this Property to be access which indirectly load information from the database.
//        /// </summary>
...
//        /// <summary>
//        /// This getRepositoryFunc is x => x.EURUSD01. In our case x = CreateUnitOfWork() which mean x = ForexDatabarsUnitOfWork
//        /// and x.EURUSD01 = ForeDatabarsUnitOfWork.EURUSD01
//        /// 
//        /// What it does is it actually invokes the ForexDatabarsUnitOfWork IForexDatabarsUnitOfWork.EURUSD01
//        /// </summary>
//        /// <returns></returns>
