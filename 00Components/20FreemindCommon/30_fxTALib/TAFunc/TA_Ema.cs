...
namespace fx.TALib
{
    ...
    {
        public static RetCode Ema( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outReal, out int outBegIdx, out int outNbElement,
            int optInTimePeriod = 30 )
        {
            ...
            return TA_INT_EMA( bars, startIdx, endIdx, outReal, out outBegIdx, out outNbElement, optInTimePeriod,
