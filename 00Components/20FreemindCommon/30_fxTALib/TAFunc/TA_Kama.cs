...
namespace fx.TALib
{
    ...
    {
        public static RetCode Kama( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outReal, out int outBegIdx, out int outNbElement,
            int optInTimePeriod = 30 )
        {
            ...
            if ( bars == null || outReal == null || optInTimePeriod < 2 || optInTimePeriod > 100000 )
            {
            ...
            double prevKAMA = (double) bars[ today - 1 ].Close;

            tempReal = ( double ) bars[ today ].Close;
            double tempReal2 = (double) bars[trailingIdx++].Close;
            ...
            prevKAMA = ( bars[ today++ ].Close - prevKAMA ) * tempReal + prevKAMA;
            while ( today <= startIdx )
            {
                tempReal = bars[ today ].Close;
                tempReal2 = bars[ trailingIdx++ ].Close;
                periodROC = tempReal - tempReal2;

                sumROC1 -= Math.Abs( trailingValue - tempReal2 );
                sumROC1 += Math.Abs( tempReal - bars[ today - 1 ].Close );
