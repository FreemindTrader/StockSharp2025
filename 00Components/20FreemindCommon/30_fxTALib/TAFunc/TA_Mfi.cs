...
namespace fx.TALib
{
    ...
    {
        public static RetCode Mfi( IHistoricBarsRepo bars, int startIdx, int endIdx,
            double[ ] outReal, out int outBegIdx, out int outNbElement, int optInTimePeriod = 14 )
        {
            ...
            if ( bars == null || outReal == null || optInTimePeriod < 2 ||
            ...
            double prevValue = (bars[today].High + bars[today].Low + bars[today].Close) / 3.0;
            ...
            {
                double tempValue1 = (bars[today].High + bars[today].Low + bars[today].Close) / 3.0;
                double tempValue2 = tempValue1 - prevValue;
                prevValue = tempValue1;
                tempValue1 *= bars[ today++ ].Volume;
                if ( tempValue2 < 0.0 )
                {
