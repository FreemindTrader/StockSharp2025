...
namespace fx.TALib
{
    ...
    {
        public static RetCode Bbands( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outRealUpperBand, double[ ] outRealMiddleBand,
            ...
            double optInNbDevUp = 2.0, double optInNbDevDn = 2.0 )
        {
            ...
            if ( bars == null || outRealUpperBand == null || outRealMiddleBand == null || outRealLowerBand == null ||
            ...
            RetCode retCode = Ma(bars, startIdx, endIdx, tempBuffer1, out outBegIdx, out outNbElement, optInMAType, optInTimePeriod);
            ...
            {
                TA_INT_StdDevUsingPrecalcMA( bars, tempBuffer1, outBegIdx, outNbElement, tempBuffer2, optInTimePeriod );
            }
            else
            {
                retCode = StdDev( bars, outBegIdx, endIdx, tempBuffer2, out outBegIdx, out outNbElement, optInTimePeriod );
