...
namespace fx.Algorithm
{
    ...
    public class IndicatorSignals : ISerializable
    {
        ...
        private int _actualResultSetStartingIndex = 0;
        private double[ ] _signals = new double[ ] { };
        ...
        public int StartingIndex
        {
            get
            {
                return _actualResultSetStartingIndex;
            }
            ...
            set
            {
                lock( this )
                {
                    _actualResultSetStartingIndex = value;
                }
            }
        }

        private int _lastCrossingIndex = 0;
        ...
        /// <summary>
        /// In an extremum search, how many periods before and after the extremum are required to indicate an extremum
        /// as one.
        /// </summary>
        private int _extremumAnalysisOutlinePeriod = 7;

        public int ExtremumAnalysisOutlinePeriod
        {
            get
            {
                return _extremumAnalysisOutlinePeriod;
            }
            set
            {
                _extremumAnalysisOutlinePeriod = value;
            }
        }
        ...
        ///
        /// </summary>
        public int PerformCrossingResultAnalysis( int line1Index, double line1Last, double line1Now, int line2Index, double line2Last, double line2Now )
        {
            if( ( line1Last >= line2Last && line1Now <= line2Now ) )
            {
                _lastCrossingIndex = line1Index;
                return ( ( int )_indicator.OnResultAnalysisCrossingFound( line1Index, line1Now, line2Index, line2Now, false, _signals[ line1Index ] ) );
            }
            else if( line1Last <= line2Last &&
                      line1Now >= line2Now )
            {
                _lastCrossingIndex = line1Index;
                return ( ( int )_indicator.OnResultAnalysisCrossingFound( line1Index, line1Now, line2Index, line2Now, true, _signals[ line1Index ] ) );
            }
            ...
            lock( this )
            {
                ...
                for( int i = 0; i < inputLines.Length; i++ )
                {
                    for( int j = i + 1; j < inputLines.Length; j++ )
                    {
                        ...
                        _signals = new double[ line1.Length ];
        ...
        /// <summary>
        /// Keep this in mind : this will search backwards for an extremum, but will not mark anything if any other
        /// signals are found on the way. The baseMethod of searching is going back and looking for a point that is the
        /// biggest/smallest in the ExtremumAnalysisOutlinePeriod count ticks before and after.
        /// </summary>
