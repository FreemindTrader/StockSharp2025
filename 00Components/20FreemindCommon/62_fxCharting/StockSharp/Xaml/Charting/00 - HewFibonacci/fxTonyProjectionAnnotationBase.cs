...
namespace fx.Charting.HewFibonacci
{
    public class fxTonyProjectionAnnotationBase : MyTradingAnnotationBase, ITradingAnnotation, IfxFibonacciAnnotation
    {
        ...
        public fxTonyProjectionAnnotationBase( HewFibGannTargets fib, ref SBar lastBar ) : base( ref lastBar )
        {
            BasePointsCount = 2;
            _fibTarget      = fib;
            _lastBar        = lastBar;
        ...
        public fxTonyProjectionAnnotationBase( HewFibGannTargets fib, ref SBar lastBar, PooledList<SBar> targetPoints ) : base( ref lastBar )
        {
            BasePointsCount = 2;
            _fibTarget = fib;
            _lastBar = lastBar;
        ...
        protected override void SetBasePoint( IComparable xDataValue, IComparable yDataValue, int index )
        {
            ...
            //if ( coordinateCalculator != null )
            //{
            //    xDataValue = coordinateCalculator.TransformDataToIndex( xDataValue );
            //}
