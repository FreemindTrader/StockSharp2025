...
//    {
//        private readonly SciList< PriceLevel > _levels = new SciList< PriceLevel >( 4 );
...
//        public IEnumerable< PriceLevel > Values
//        {
//            get
//            {
//                return _levels;
...
//            PriceLevel priceLevel = GetPriceLevel( price );
...
//        private PriceLevel GetPriceLevel( double normPrice )
//        {
...
//            PriceLevel[ ] itemsArray = _levels.ItemsArray;
//            if( num == 1 )
//            {
//                PriceLevel priceLevel = itemsArray[ 0 ];
//                if( priceLevel == null )
//                {
//                    PriceLevel priceLevel1 = new PriceLevel( normPrice );
//                    PriceLevel priceLevel2 = priceLevel1;
//                    itemsArray[ 0 ] = priceLevel1;
//                    priceLevel = priceLevel2;
//                }
//                return priceLevel;
//            }
//            PriceLevel priceLevel3 = itemsArray[ 0 ];
//            if( priceLevel3 == null )
//            {
//                string str = string.Format( "ERROR: GetPriceLevel({0}): first item is null for time={1}", normPrice, Time );
//                SciChartDebugLogger.Instance.WriteLine( str, new object[ 0 ] );
...
//                        {
//                            itemsArray[ i ] = new PriceLevel( ( MinPrice + ( double )i * PriceStep ).NormalizePrice( PriceStep ) );
//                        }
//                    }
//                }
...
//                itemsArray[ j ] = ( j >= num1 ? itemsArray[ j - num1 ] ?? new PriceLevel( num2 ) : new PriceLevel( num2 ) );
//            }
//            return itemsArray[ 0 ];
//        }
...
//            if( num < 0 || num >= _levels.Capacity )
//            {
//                return ( long )0;
//            }
//            PriceLevel priceLevel = itemsArray[ num ];
//            if( priceLevel != null )
//            {
...
//            {
//                MaxValue = _levels.Max( ( PriceLevel l ) => l.Value );
