...
{
    public sealed class QuotesUI : ChartComponent<QuotesUI>, ICloneable<IChartElement>, INotifyPropertyChanged, IElementWithXYAxes, IDrawableChartElement, ICloneable, INotifyPropertyChanging, IChartElement
    {
