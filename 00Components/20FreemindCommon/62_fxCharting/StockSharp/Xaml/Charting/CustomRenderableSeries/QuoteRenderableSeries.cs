...
namespace fx.Charting
{
    public class QuoteRenderableSeries : CustomRenderableSeries
    {
        ...
        //public static readonly DependencyProperty StrokeDashArrayProperty = DependencyProperty.Register( nameof( StrokeDashArray ), typeof( double[ ] ), typeof( QuoteRenderableSeries ), new PropertyMetadata( ( object )null, new PropertyChangedCallback( BaseRenderableSeries.OnInvalidateParentSurface ) ) );
        ...
        //    get
        //    {
        //        return ( double[ ] )GetValue( QuoteRenderableSeries.StrokeDashArrayProperty );
        //    }
        //    set
        //    {
        //        SetValue( QuoteRenderableSeries.StrokeDashArrayProperty, ( object )value );
        //    }
        //}
        ...
        /// The render context. This is a graphics object which has methods to draw lines, quads and polygons to the
        /// screen
        /// </param>
        /// <param name="renderPassData">
        /// The render pass data. Contains a resampled  <see cref="IPointSeries"/>, the  <see cref="IndexRange"/> of
        /// points on the screen and the current YAxis and XAxis  <see cref="ICoordinateCalculator{T}"/> to convert
