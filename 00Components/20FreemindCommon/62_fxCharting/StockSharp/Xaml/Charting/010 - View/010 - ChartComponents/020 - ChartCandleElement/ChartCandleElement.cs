                                  ...
                                  IDrawableChartElement
{
    ...
    public ChartCandleElement()
    {
        ...
        this.DrawStyle = StockSharp.Charting.ChartCandleDrawStyles.CandleStick;
    }
    ...
    public StockSharp.Charting.ChartCandleDrawStyles DrawStyle
    {
        ...
        set
        {
            ...
            if ( this._drawStyle == StockSharp.Charting.ChartCandleDrawStyles.PnF )
            ...
            switch ( value )
            {
                ...
                case StockSharp.Charting.ChartCandleDrawStyles.Area:
                    if ( this._drawStyle == StockSharp.Charting.ChartCandleDrawStyles.Ohlc )
                    {
                        this.StrokeThickness = 1;
                        break;
                    }
    ...
    public override void Load(SettingsStorage storage)
    {
        ...
        this.DrawStyle = storage.GetValue<StockSharp.Charting.ChartCandleDrawStyles>("DrawStyle", this.DrawStyle);
