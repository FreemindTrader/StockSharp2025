...
{
    public class AnnotationUI : ChartComponent< AnnotationUI >, ICloneable< IfxChartElement >, INotifyPropertyChanged, IElementWithXYAxes, IDrawableChartElement, ICloneable, INotifyPropertyChanging, IfxChartElement
    {
