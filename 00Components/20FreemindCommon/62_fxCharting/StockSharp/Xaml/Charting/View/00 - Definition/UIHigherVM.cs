...
internal abstract class UIHigherVM< T > : UIChartBaseViewModel where T : ChartPart< T >, IDrawableChartElement
{
    ...
    {
        foreach( IChartComponent elementXY in _rootElementSet.ToArray( ) )
        {
    ...
    protected void AddPropertyEvents( IChartComponent root )
    {
    ...
    {
        RootElementPropertyChanging( ( IChartComponent )elementXY, string_0, object_1 );
    }
