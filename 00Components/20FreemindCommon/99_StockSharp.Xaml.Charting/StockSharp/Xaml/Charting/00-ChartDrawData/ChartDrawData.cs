...
public class ChartDrawData : IChartDrawData
{
    ...
    internal sealed class sTrade : ChartDrawData.IDrawValue
    {
        ...
        {
            DefaultInterpolatedStringHandler sHandler = new DefaultInterpolatedStringHandler(16 /*0x10*/, 6);
            sHandler.AppendFormatted("");
            sHandler.AppendLiteral("");
            sHandler.AppendFormatted(this.GetTransactionString());
            sHandler.AppendLiteral("");
            sHandler.AppendFormatted<DateTime>(this.UtcTime());
            sHandler.AppendLiteral("");
            sHandler.AppendFormatted<Sides>(this.OrderSides());
            sHandler.AppendLiteral("");
            sHandler.AppendFormatted<long>(this.Volume);
            sHandler.AppendLiteral("");
            sHandler.AppendFormatted<double>(this.Price());
            return sHandler.ToStringAndClear();
        }
    }
