...
namespace StockSharp.Algo.History.Forex
{
    public class MBTradingHistorySource : BaseDumpableHistorySource, ISecurityDownloader
    {
        ...
        {
            string[ ] array = string_2.Split( ',' ).Select< string, string >( MBTradingHistorySource.Class56.func_4 ?? ( MBTradingHistorySource.Class56.func_4 = new Func< string, string >( MBTradingHistorySource.Class56.class56_0.method_5 ) ) ).ToArray< string >( );
