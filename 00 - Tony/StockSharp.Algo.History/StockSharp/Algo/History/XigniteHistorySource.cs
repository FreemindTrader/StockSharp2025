    ...
    public class XigniteHistorySource : BaseHistorySource, ISecurityDownloader
    {
      ...
      DateTime endDate )
        {
            ...
            class150.securityId_0 = security.ToSecurityId( null );
            ...
            Header Header = new Header( )
      {
        Username = this.AuthToken
            ...
            class150.equityChartBars_0 = realTimeSoapClient.GetChartBars( Header, Identifier, IdentifierType, beginDate.ToString( "yyyy/MM/dd HH:mm", CultureInfo.InvariantCulture ), endDate.ToString( "yyyy/MM/dd HH:mm", CultureInfo.InvariantCulture ), tickPrecisions.To< string >( ), Period, "All", false );
            ...
            Header Header = new Header( )
      {
        Username = this.AuthToken
            ...
            if( code.IsEmpty( ) )
            {
                ...
                stringList.AddRange( exchangeList.ExchangeDescriptions.Select< ExchangeDescription, string >( XigniteHistorySource.Class151.func_0 ?? ( XigniteHistorySource.Class151.func_0 = new Func< ExchangeDescription, string >( XigniteHistorySource.Class151.class151_0.method_0 ) ) ) );
            }
            else
            {
                stringList.Add( code );
            ...
            foreach( string str in stringList )
            {
                            ...
                            StockSharp.BusinessEntities.Security security = new StockSharp.BusinessEntities.Security( )
              {
                ...
                Currency = securityDescription.Currency.FromMicexCurrencyName( null ),
                Board = this.ExchangeInfoProvider.GetOrCreateBoard( str, null )
              };
        ...
        private sealed class Class150
        {
            ...
            internal void method_0( )
            {
                ...
                {
                    DateTimeOffset dateTimeOffset = chartBar.StartDate.ToDateTime( "yyyy/MM/dd", null ).ApplyTimeZone( TimeSpan.FromHours( chartBar.UTCOffset ) ) + chartBar.StartTime.ToTimeSpan( "hh\\:mm", null );
