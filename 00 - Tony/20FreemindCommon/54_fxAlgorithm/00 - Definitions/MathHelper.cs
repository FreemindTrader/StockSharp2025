...
namespace fx.Algorithm
{
    ...
    public static class MathHelper
    {
        ...
        /// </summary>
        public static double[ ] CreateLineCrossings( double[ ] line1, double[ ] line2 )
        {
        ...
        ///
        /// </summary>
        public static double[ ] CreateFixedLineResultLength( double value, int count )
        {
        ...
        /// </summary>
        public static double[ ] CreateConnectionValues( double initialValue, double secondaryValue, int connectionValuesCount )
        {
        ...
        public static DirectionEnum[ ] EstablishDirection( double[ ] values )
        {
        ...
        /// <summary>
        /// This is a quick approximation of the Moving average. The formula used here is as follows : An estimate of
        /// the moving average if the bin size for moving average is n may be obtained by: NewAverage = (((n-1) *
        /// OldAverage) + newValue)/n This works once the bin is full (sample number >= n). The bin partially full is
        /// often dealt with by using a seed value for the initial moving average (OldAverage) and then using this
        /// calculation. This assumes normal distribution of values etc.
        /// </summary>
        public static double[ ] CalculateQuickMA( double[ ] values, int period )
        {
        ...
        /// <returns></returns>
        public static PooledDictionary< double, double > CalculateValueDistribution( IEnumerable< double > values, int periodsCount )
        {
            PooledList< double > list = new PooledList< double >( values );
            list.Sort( );
            ...
            PooledDictionary< double, double > results = new PooledDictionary< double, double >( );
