...
namespace fx.Algorithm
{
    ...
    /// </summary>
    public interface IPfzDictionary : IEnumerable
    {
        /// <summary>
    ...
    /// Also, it defines TrimExcess and SetCapacity, which are available in lists and hashsets but not in dictionaries.
    /// </summary>
    public interface IPfzDictionary< TKey, TValue > : IEnumerable< KeyValuePair< TKey, TValue > >, IPfzDictionary
    {
        /// <summary>
        ...
        /// Gets the equality comparer used by this dictionary to do key comparisons
        /// </summary>
        new IEqualityComparer< TKey > Comparer
        {
            get;
        }
