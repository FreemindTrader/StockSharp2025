...
namespace fx.Algorithm
{
    ...
    public class IndicatorParameters : ICloneable
    {
        ...
        /// </summary>
        private PooledDictionary< string, object > _coreValues = new PooledDictionary< string, object >( );

        /// <summary>
        /// Dynamic values are optional, and control additional indicator functionalities (for ex. "fixedLines")
        /// </summary>
        private PooledDictionary< string, object > _dynamicValues = new PooledDictionary< string, object >( );
        ...
        /// <summary>
/// A list of the *dynamic* values of this indicator. Use for reading purposes, since its a copy. Dynamic values
/// are optional, and control additional indicator functionalities (for ex. "fixedLines")
/// </summary>
        public PooledList< object > DynamicValues
        {
            get
            {
                lock( this )
        ...
        /// </summary>
        public PooledList< string > DynamicNames
        {
            get
            {
                lock( this )
        ...
        /// <summary>
        /// A list of the *core* values of this indicator. Use for reading purposes, since its a copy. Core values are
        /// actually used to control the calculation process.
        /// </summary>
        public PooledList< object > CoreValues
        {
            get
            {
                lock( this )
        ...
        /// </summary>
        public PooledList< string > CoreNames
        {
            get
            {
                lock( this )
...
/// </summary>
[field: NonSerialized]
        public event ParameterUpdatedValueDelegate IndicatorParameterUpdatedEvent;
        ...
        public void SetDynamic( string name, object value )
        {
            ...
            if( IndicatorParameterUpdatedEvent != null )
            {
                IndicatorParameterUpdatedEvent( name, value );
            }
        }
