...
namespace fx.Indicators
{
    public partial class FreemindIndicator : CustomPlatformIndicator /*, ILogSource, ILogReceiver*/
    {
        ...
        private OrderedDictionary< int, TASignal >                  _macdSignificantCross;
        
        private OrderedDictionary<int, Tuple<MacdSignal, double >>  _macdExtremumDict;
        private OrderedDictionary< int, TASignal >                  _stochasticsDictionary;
        private OrderedDictionary< int, TASignal >                  _smoothedStochasticsDictionary;
        private OrderedDictionary< int, TASignal >                  _overBoughtSoldDictionary;
