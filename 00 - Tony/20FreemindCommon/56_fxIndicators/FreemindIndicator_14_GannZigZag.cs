                    ...
                    if ( g._timeOfLastCheckedBar != Bars[ i ].LinuxTime )
                    {
                        ...
                        if ( g._trendDirection == TrendDirection.NoTrend )
                        {
                                    ...
                                    higerHighBarCount > nthHigherHighOrLowerLowForTrendChange )
                            {
                                ...
                                {
                                    this.AddErrorLog( "Gann Swing array Error _indexOfLastLowerLowBar < startIndex, _indexOfLastLowerLowBar = " + g._lastLowerLowIndex + ", startIndex = " + startIndex );
                                        ...
                                        lowerLowBarCount > nthHigherHighOrLowerLowForTrendChange )
                            {
                                ...
                                {
                                    this.AddErrorLog( "Gann Swing array Error _indexOfLastHigherHighBar < startIndex, _indexOfLastHigherHighBar = " + g._lastHigherHighIndex + ", startIndex = " + startIndex );
