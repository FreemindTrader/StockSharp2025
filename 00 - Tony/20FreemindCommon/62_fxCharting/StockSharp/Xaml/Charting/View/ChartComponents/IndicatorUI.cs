...
namespace fx.Charting
{
    ...
    public sealed class IndicatorUI : ChartComponent< IndicatorUI >
    {
        ...
        internal void CreateIndicatorPainter( IList< IndicatorType > indicatorTypeList, IIndicator indicator )
        {
            ...
            {
                Type painter = indicatorType.Painter;
                myPainter = ( object )painter != null ? TypeHelper.CreateInstance< IChartIndicatorPainter >( painter, new object[ 0 ] ) : null;
            }
