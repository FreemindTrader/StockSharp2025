...
{
    public sealed class BandsUI : ChartComponent< BandsUI >, ICloneable< IfxChartElement >, INotifyPropertyChanged, IElementWithXYAxes, IDrawableChartElement, ICloneable, INotifyPropertyChanging, IfxChartElement
    {
