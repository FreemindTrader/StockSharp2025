...
{
    public sealed class QuotesUI : ChartComponent<QuotesUI>, ICloneable<IfxChartElement>, INotifyPropertyChanged, IElementWithXYAxes, IDrawableChartElement, ICloneable, INotifyPropertyChanging, IfxChartElement
    {
