...
{    
    public class fxGannSquareOf9AnnotationBase : MyTradingAnnotationBase, ITradingAnnotation, IfxFibonacciAnnotation
    {
        ...
        public fxGannSquareOf9AnnotationBase( HewFibGannTargets fib, ref SBar lastBar ) : base( ref lastBar )
        {
            BasePointsCount = 2;
            _fibTarget = fib;
            _lastBar = lastBar;
        ...
        public fxGannSquareOf9AnnotationBase( HewFibGannTargets fib, ref SBar lastBar, PooledList<SBar> targetPoints ) : base( ref lastBar )
        {
            BasePointsCount = 2;
            _fibTarget = fib;
            _lastBar = lastBar;
