...
namespace fx.Definitions
{
    public static partial class WaveFibConstants
    {
        ...
        {
            new fxFibLevel( FibPercentage.Fib_50,       50f,                     FibonacciTargetType.AroundMinimumTarget,  40 ),
            new fxFibLevel( FibPercentage.Fib_61_8,     61.8f,                   FibonacciTargetType.AroundMinimumTarget,  40 ),
            new fxFibLevel( FibPercentage.Fib_66_66,    66.7f,                   FibonacciTargetType.AroundMinimumTarget,  20 ),
            new fxFibLevel( FibPercentage.Fib_76_4,     76.4f,                   FibonacciTargetType.MinimumTarget,  10 ),
            ...
            new fxFibLevel( FibPercentage.Fib_94_4,     94.4f,                   FibonacciTargetType.AverageTarget,  10 ),
            ...
            new fxFibLevel( FibPercentage.Fib_105_6,    105.6f,                  FibonacciTargetType.StrongTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_109_2,    109.2f,                  FibonacciTargetType.StrongTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_114_6,    114.6f,                  FibonacciTargetType.StrongTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_123_6,    123.6f,                  FibonacciTargetType.AroundStrongTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_127_2,    127.2f,                  FibonacciTargetType.AroundStrongTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_133_3,    133.3f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_138_2,    138.2f,                  FibonacciTargetType.ExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_141_4,    141.4f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_150,      150.4f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_161_8,    161.8f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_166_7,    166.7f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_176_4,    176.4f,                  FibonacciTargetType.ExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_185_4,    185.4f,                  FibonacciTargetType.ExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_190_2,    190.2f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_194_4,    194.4f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_198_4,    198.4f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),
            new fxFibLevel( FibPercentage.Fib_200,      200.0f,                  FibonacciTargetType.AroundExtremeTarget,  2 ),            
        };
    }
}
