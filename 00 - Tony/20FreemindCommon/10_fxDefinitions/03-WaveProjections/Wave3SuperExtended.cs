...
namespace fx.Definitions
{
    ...
    public static partial class GlobalConstants
    {
        ...
        public static readonly float[ ] SuperExtenedWave3ClassicProjectionLevels = new float[ ]
        {
        ...
        public static readonly int[ ] SuperExtenedWave3ClassicProjectionStrength = new int[ ]
        {
            0,                      // 50
            0,                      // 61.8
            0,                      // 66.7
        ...
        public static readonly FibPercentage[ ] SuperExtenedWave3FibLevelType = new FibPercentage[ ]
        {
