...
namespace fx.Definitions
{
    ...
    public class BTree<T> : ISortedCollection<T>
    {
        ...
        /// <param name="value">The value.</param>
        /// <returns>All items having values equal to or greater than the specified value.</returns>
        public IEnumerable<T> GetElementsRightOf( T value )
        {
            Contract.Ensures( Contract.Result<IEnumerable<T>>( ) != null );
        ...
        /// <param name="value">The key value.</param>
        /// <returns>All items having values equal to or greater than the specified value.</returns>
        public IEnumerable<T> GetElementsLeftOf( T value )
        {
            Contract.Ensures( Contract.Result<IEnumerable<T>>( ) != null );
        ...
        sealed class Node
        {
            ...
            /// </summary>
            public static void Insert( T key,
                                       Node leaf,
                                       int pos,
                                       ref Node root )
            {
            ...
            /// </summary>
            public static IEnumerable<T> ForwardFromIndex( Node leaf,
                                                             int pos )
            {
                Contract.Requires( leaf != null );
                Contract.Requires( leaf.IsLeaf );
            ...
            /// </summary>
            public static IEnumerable<T> BackwardFromIndex( Node leaf,
                                                              int pos )
            {
                Contract.Requires( leaf != null );
                Contract.Requires( leaf.IsLeaf );
            ...
            static void MoveToDuplicatesBoundary( T key,
                                                  IComparer<T> keyComparer,
                                                  int duplicatesBias,
                                                  ref Node node,
                                                  ref int pos )
