// https://www.codeproject.com/Articles/19550/Automated-Undo-Redo-library-Csharp-Generics-NET-C
using System;
...
{
    public class UndoRedoDictionary<TKey, TValue> : PooledDictionary<TKey, TValue>, IUndoRedoMember, IChangedNotification
    {
        /// <summary>
        ...
        { }
        /// <summary>
        /// Initializes a new instance of the System.Collections.Generic.PooledDictionary<TKey,TValue> class with serialized data.
        /// </summary>
        /// <param name="info">A System.Runtime.Serialization.SerializationInfo object containing the information required to serialize the System.Collections.Generic.PooledDictionary<TKey,TValue>.</param>
        /// <param name="context">A System.Runtime.Serialization.StreamingContext structure containing the source and destination of the serialized stream associated with the System.Collections.Generic.PooledDictionary<TKey,TValue>.</param>
