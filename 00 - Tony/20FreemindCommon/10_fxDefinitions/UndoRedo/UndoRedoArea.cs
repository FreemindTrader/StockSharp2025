...
namespace fx.Definitions.UndoRedo
{
    ...
    public class UndoRedoArea
    {
        ...
        private PooledList<Command> history = new PooledList<Command>( );
    ...
    {
        static PooledDictionary<IUndoRedoMember, object> owners = new PooledDictionary<IUndoRedoMember, object>( );
        ...
        static PooledDictionary<IUndoRedoMember, string> names = new PooledDictionary<IUndoRedoMember, string>( );
        ...
        static PooledDictionary<IUndoRedoMember, EventHandler<MemberChangedEventArgs>> subscriptions = new PooledDictionary<IUndoRedoMember, EventHandler<MemberChangedEventArgs>>( );
