...
namespace fx.TALib
{
    ...
    {
        public static RetCode Tema( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outReal, out int outBegIdx, out int outNbElement,
            int optInTimePeriod = 30 )
        {
            ...
            RetCode retCode = TA_INT_EMA(bars, startIdx - lookbackEMA * 2, endIdx, firstEMA, out var firstEMABegIdx,
