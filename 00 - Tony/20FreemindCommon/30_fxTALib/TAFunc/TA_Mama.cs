...
namespace fx.TALib
{
    ...
    {
        public static RetCode Mama( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outMama, double[ ] outFama, out int outBegIdx,
            out int outNbElement, double optInFastLimit = 0.5, double optInSlowLimit = 0.05 )
        {
            ...
            if ( bars == null || outMama == null || outFama == null || optInFastLimit < 0.01 || optInFastLimit > 0.99 ||
            ...
            double tempReal = bars[today++].Close;
            ...
            {
                tempReal = bars[ today++ ].Close;
                DoPriceWma( bars, ref trailingWMAIdx, ref periodWMASub, ref periodWMASum, ref trailingWMAValue, tempReal, out _ );
            } while ( --i != 0 );
            ...
            while ( today <= endIdx )
            {
                ...
                double todayValue = bars[today].Close;
                DoPriceWma( bars, ref trailingWMAIdx, ref periodWMASub, ref periodWMASum, ref trailingWMAValue,
