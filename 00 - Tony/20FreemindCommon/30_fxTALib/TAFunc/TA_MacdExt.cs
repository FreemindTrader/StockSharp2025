...
namespace fx.TALib
{
    ...
    {
        public static RetCode MacdExt( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outMacd, double[ ] outMacdSignal,
            ...
            int optInSignalPeriod = 9 )
        {
            ...
            if ( bars == null || outMacd == null || outMacdSignal == null || outMacdHist == null || optInFastPeriod < 2 ||
            ...
            RetCode retCode = Ma(bars, tempInteger, endIdx, slowMABuffer, out var outBegIdx1, out var outNbElement1, optInSlowMAType, optInSlowPeriod);
            if ( retCode != RetCode.Success )
            {
                return retCode;
            }

            retCode = Ma( bars, tempInteger, endIdx, fastMABuffer, out var outBegIdx2, out var outNbElement2, optInFastMAType,
                optInFastPeriod );
            if ( retCode != RetCode.Success )
            {
                return retCode;
            ...
            int optInSignalPeriod = 9 )
        {
            ...
            tempInteger = startIdx - lookbackSignal;
            RetCode retCode = Ma(inReal, tempInteger, endIdx, slowMABuffer, out var outBegIdx1, out var outNbElement1, optInSlowMAType, optInSlowPeriod);
            if ( retCode != RetCode.Success )
            {
                return retCode;
            }
