...
namespace fx.TALib
{
    ...
    {
        public static RetCode Trima( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outReal, out int outBegIdx, out int outNbElement,
            int optInTimePeriod = 30 )
        {
            ...
            if ( optInTimePeriod % 2 == 1 )
            {
                ...
                while ( todayIdx <= endIdx )
                {
                    numerator -= numeratorSub;
                    numeratorSub -= tempReal;
                    tempReal = bars[ middleIdx++ ].Close;
                    numeratorSub += tempReal;

                    numerator += numeratorAdd;
                    numeratorAdd -= tempReal;
                    tempReal = bars[ todayIdx++ ].Close;
                    numeratorAdd += tempReal;
