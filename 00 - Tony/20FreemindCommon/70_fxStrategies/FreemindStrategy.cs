...
namespace Freemind.Strategies
{
    public class FreemindStrategy : Strategy
    {
        ...
        {
            this.AddDebugLog( "MACD Changed, Period ={0}, Macd = {1} Signal ={2}", e.Period, e.Macd, e.MacdSignal );
        }

        private void _AdvAnalysisMgr_MacdCrossEvent( object sender, fx.Definitions.MacdCrossEventArgs e )
        {
            this.AddInfoLog( "MACD crossed detected, Period ={0}, Direction = {1} CrossIndex = {2}", e.Period, e.Direction, e.CrossIndex );
