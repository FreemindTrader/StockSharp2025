...
internal sealed class Class27
{
    private static readonly SynchronizedDictionary< TimeSpan, int > synchronizedDictionary_0 = new SynchronizedDictionary< TimeSpan, int >( )
  {
    ...
    {
        this.dictionary_0[ ( Class27.Enum0 ) 0 ] = new Func< string >( new Class27.Class32( )
    {
    ...
    public Class27 method_3( TimeSpan timeSpan_0, bool bool_0 )
    {
        ...
        {
            throw new ArgumentOutOfRangeException( "tf", ( object )class30.timeSpan_0, LocalizedStrings.Str2101 );
        }
    ...
    public Class27 method_4( Security security_0, INativeIdStorage inativeIdStorage_0 )
    {
        ...
        Tuple< long, long > bySecurityId = ( Tuple< long, long > ) inativeIdStorage_0.TryGetBySecurityId( "Finam", security_0.ToSecurityId( ( SecurityIdGenerator ) null ) );
        if( bySecurityId == null )
        {
            throw new ArgumentException( LocalizedStrings.Str2099Params.Put( ( object )security_0, ( object )"Finam" ) );
        }
    ...
    private sealed class Class28
    {
        ...
        {
            return "dt={0}&mt={1}&yt={2}".Put( ( object ) this.dateTime_0.Day.ToString( "#0" ), ( object ) ( this.dateTime_0.Month - 1 ).ToString( "#0" ), ( object ) this.dateTime_0.Year.ToString( "0000" ) );
        }
    }
  ...
  private sealed class Class29
  {
    ...
    private sealed class Class30
    {
        ...
        internal string method_0( )
        {
            return "p={0}&datf={1}".Put( ( object ) this.int_0, ( object ) ( this.timeSpan_0 == TimeSpan.Zero ? ( this.bool_0 ? 12 : 11 ) : 5 ) );
        }
    }
    ...
    private sealed class Class31
    {
        ...
        internal string method_0( )
        {
            return string.Format( "m={0}&em={1}", ( object ) this.long_0, ( object ) this.long_1 );
        }
    }
    ...
    private sealed class Class32
    {
        ...
        internal string method_0( )
        {
            return "df={0}&mf={1}&yf={2}".Put( ( object ) this.dateTime_0.Day.ToString( "#0" ), ( object ) ( this.dateTime_0.Month - 1 ).ToString( "#0" ), ( object ) this.dateTime_0.Year.ToString( "0000" ) );
        }
    }
}
