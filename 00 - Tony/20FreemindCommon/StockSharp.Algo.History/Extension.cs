...
{
    private static readonly SynchronizedDictionary< string, CachedSynchronizedList< SecurityInfo > > synchronizedDictionary_0 = new SynchronizedDictionary< string, CachedSynchronizedList< SecurityInfo > >( ( IEqualityComparer< string > )StringComparer.InvariantCultureIgnoreCase );
    private static readonly SynchronizedDictionary< string, SecurityInfo > synchronizedDictionary_1 = new SynchronizedDictionary< string, SecurityInfo >( ( IEqualityComparer< string > )StringComparer.InvariantCultureIgnoreCase );

    static Extension( )
    {
        using( ZipArchive zipArchive = new ZipArchive( ( Stream )Class38.smethod_6( ).To< MemoryStream >( ) ) )
        {
    ...
    public static SecurityInfo[ ] smethod_1( string string_0, string string_1 )
    {
        ...
        return ( ( IEnumerable< SecurityInfo > )securityInfoArray ).Where< SecurityInfo >( new Func< SecurityInfo, bool >( class15.method_0 ) ).ToArray< SecurityInfo >( );
    }
    ...
    private sealed class Class14
    {
        ...
        internal SecurityInfo method_0( XElement xelement_0 )
        {
            ...
            {
                Board = xelement_0.GetAttributeValue< string >( "board", ( string )null ),
                ...
                Code = xelement_0.GetAttributeValue< string >( "code", ( string )null ),
                ShortName = xelement_0.GetAttributeValue< string >( "shortName", ( string )null ),
                Name = xelement_0.GetAttributeValue< string >( "name", ( string )null ),
                Isin = xelement_0.GetAttributeValue< string >( "isin", ( string )null ),
                Asset = xelement_0.GetAttributeValue< string >( "asset", ( string )null ),
                Type = xelement_0.GetAttributeValue< string >( "type", ( string )null ),
                Currency = xelement_0.GetAttributeValue< string >( "currency", ( string )null ),
                IssueSize = xelement_0.GetAttributeValue< Decimal? >( "issueSize", new Decimal?( ) ),
                IssueDate = xelement_0.GetAttributeValue< string >( "issueDate", ( string )null ).TryToDateTime( "yyyyMMdd", ( CultureInfo )null ),
                LastDate = xelement_0.GetAttributeValue< string >( "lastDate", ( string )null ).TryToDateTime( "yyyyMMdd", ( CultureInfo )null )
            };
        }
    }
