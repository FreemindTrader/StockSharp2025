...
namespace StockSharp.Algo.History
{
    public class GoogleHistorySource : BaseHistorySource
    {
        ...
        public static IEnumerable< TimeSpan > TimeFrames
        {
            get
            {
                return ( IEnumerable< TimeSpan > ) GoogleHistorySource.cachedSynchronizedDictionary_0.CachedKeys;
            }
        }
            ...
            GoogleHistorySource.Class65 class65 = new GoogleHistorySource.Class65( )
      {
        ...
        timeSpan_0 = timeFrame
            ...
            {
                throw new ArgumentOutOfRangeException( nameof( timeFrame ), ( object )class65.timeSpan_0, LocalizedStrings.Str2079 );
            }

            class65.securityId_0 = class65.security_0.ToSecurityId( this.SecurityIdGenerator );
            return ( IEnumerable< TimeFrameCandleMessage > ) CultureInfo.InvariantCulture.DoInCulture< List< TimeFrameCandleMessage > >( new Func< List< TimeFrameCandleMessage > >( class65.method_0 ) );
        }
    ...
    private sealed class Class64
    {
                ...
                using( WebClient webClient = new WebClient( )
        {
          Encoding = Encoding.ASCII
                ...
                {
                    foreach( string str in ( ( IEnumerable< string > ) webClient.DownloadString( "http://www.google.com/finance/historical?q={0}&startdate={1:MMM dd, yyyy}&enddate={2:MMM dd, yyyy}&histperiod={3}&output=csv".Put( ( object ) this.googleHistorySource_0.GetSecurityCode( this.security_0 ).Remove( "/", false ), ( object ) this.dateTime_0, ( object ) this.dateTime_1, ( object ) this.string_0 ) ).Split( "\n", true ) ).Skip< string >( 1 ) )
                    {
