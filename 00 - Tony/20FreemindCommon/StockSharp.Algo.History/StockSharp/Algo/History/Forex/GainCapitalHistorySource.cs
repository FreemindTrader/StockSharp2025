...
namespace StockSharp.Algo.History.Forex
{
    public class GainCapitalHistorySource : BaseDumpableHistorySource, ISecurityDownloader
    {
        ...
        private readonly SynchronizedSet< string > synchronizedSet_0 = new SynchronizedSet< string >( ( IEqualityComparer< string > ) StringComparer.InvariantCultureIgnoreCase );
      ...
      IExchangeInfoProvider exchangeInfoProvider ) : base( nativeIdStorage, exchangeInfoProvider )
        ...
        private static Uri smethod_0( DateTime dateTime_0 )
        {
            ...
            {
                return new Uri( "http://ratedata.gaincapital.com/" + ( object )dateTime_0.Year );
            }

            return new Uri( "{0}{1:yyyy}/{1:MM}%20{2}".Put( ( object ) "http://ratedata.gaincapital.com/", ( object ) dateTime_0, ( object ) dateTime_0.ToString( "MMMM", ( IFormatProvider ) CultureInfo.InvariantCulture ) ) );
        }
      ...
      DateTime dateTime_0 )
        {
            ...
            SortedDictionary< string, SortedDictionary< DateTime, string > > dictionary = new SortedDictionary< string, SortedDictionary< DateTime, string > >( ( IComparer< string > ) StringComparer.InvariantCultureIgnoreCase );
            ...
            using( HttpRequest httpRequest = new HttpRequest( ) )
            {
                try
                {
                    httpRequest.Get( "http://ratedata.gaincapital.com/{0:yyyy}/".Put( ( object ) class50.dateTime_0 ), ( RequestParams ) null );
                }
                catch( HttpException ex )
                {
                    ...
                    throw new InvalidOperationException( LocalizedStrings.Str2078Params.Put( ( object ) ex.HttpStatusCode, ( object ) class50.dateTime_0 ) );
                }
            }
            if( !new HtmlWeb( ).Load( "http://ratedata.gaincapital.com/{0:yyyy}/".Put( ( object ) class50.dateTime_0 ) ).DocumentNode.SelectNodes( "//table[@id='Table1']/tr/td[@align='left']/a" ).Any< HtmlNode >( new Func< HtmlNode, bool >( class50.method_0 ) ) )
            {
                return dictionary;
            }
            ...
            using( HttpRequest httpRequest = new HttpRequest( ) )
            {
                ...
                string str1 = httpRequest.Get( address, ( RequestParams ) null ).ToString( );
                if( str1.IsEmpty( ) )
                {
                    return dictionary;
                }
                ...
                foreach( object match in GainCapitalHistorySource.regex_0.Matches( str1 ) )
                {
                    ...
                    string key = "{0}/{1}".Put( ( object ) strArray[ 0 ], ( object ) strArray[ 1 ] );
                    ...
                    dictionary.SafeAdd< string, SortedDictionary< DateTime, string > >( key )[ new DateTime( class50.dateTime_0.Year, class50.dateTime_0.Month, class50.dateTime_0.DaysInMonth( ).Min( 1 + 7 * num ) ) ] = "{0}/{1}".Put( ( object ) address.AbsoluteUri, ( object ) str2 );
                }
            }
            return dictionary;
        }
      ...
      Func< bool > isCancelled )
        {
            ...
            for( DateTime dateTime_0 = new DateTime( 2003, 1, 1 ); dateTime_0.Year < DateTime.Now.Year; dateTime_0 = dateTime_0.AddYears( 1 ) )
            {
                            ...
                            Security security = new Security( )
              {
                ...
                PriceStep = new Decimal?( new Decimal( 1, 0, 0, false, ( byte ) 5 ) ),
      ...
      object arg )
        {
            return this.method_0( security.ToSecurityId( ( SecurityIdGenerator ) null ), from, to, dataType );
        }
      ...
      Type type_0 )
        {
            ...
            {
                throw new ArgumentOutOfRangeException( "dataType", ( object )type_0, LocalizedStrings.Str1655 );
            }

            int num = dateTime_0.Day > 7 ? ( dateTime_0.Day > 14 ? ( dateTime_0.Day > 21 ? ( dateTime_0.Day > 28 ? 5 : 4 ) : 3 ) : 2 ) : 1;
            return Path.Combine( this.DumpFolder, "{0}_{1}_{2}.zip".Put( ( object ) securityId_0.SecurityCode.SecurityIdToFolderName( ), ( object ) type_0.Name.ToLowerInvariant( ), dateTime_0.Year <= 2002 ? ( object ) dateTime_0.ToString( "yyyy" ) : ( object ) ( dateTime_0.ToString( "yyyyMM" ) + "week" + ( object ) num ) ) );
        }
      ...
      DateTime date )
        {
            ...
            return this.LoadTickMessages( class47.security_0.ToSecurityId( ( SecurityIdGenerator ) null ), date ).Select< Level1ChangeMessage, MarketDepth >( new Func< Level1ChangeMessage, MarketDepth >( class47.method_0 ) );
        }
      ...
      DateTime dateTime_0 )
        {
            ...
            return ( IEnumerable< Level1ChangeMessage > ) this.method_4( "{0}{2}/{1}_{2}.zip".Put( ( object ) "http://ratedata.gaincapital.com/", ( object ) securityId_0.SecurityCode.Replace( '/', '_' ), ( object ) dateTime_0.Year ), securityId_0, dateTime_0, dateTime_0 );
        }
      ...
      DateTime dateTime_0 )
        {
            ...
            {
                return ( IEnumerable< Level1ChangeMessage > )source2;
            }
            ...
            foreach( KeyValuePair< DateTime, string > keyValuePair in source1.Where< KeyValuePair< DateTime, string > >( class48.func_0 ?? ( class48.func_0 = new Func< KeyValuePair< DateTime, string >, bool >( class48.method_0 ) ) ) )
            {
                ...
                {
                    return ( IEnumerable< Level1ChangeMessage > )source3;
                }
            }
      ...
      DateTime dateTime_1 )
        {
            ...
            if( !empty.IsEmpty( ) )
            {
                return ( IEnumerable< Level1ChangeMessage > )this.method_4( empty, securityId_0, dateTime_0, dateTime_1 );
            }
      ...
      DateTime dateTime_1 )
        {
            ...
            string str = this.CanDump ? this.method_0( class46.securityId_0, dateTime_0, dateTime_0, typeof( Level1ChangeMessage ) ) : ( string ) null;
            ...
            else
            {
                using( HttpRequest httpRequest = new HttpRequest( ) )
                {
                    try
                    {
                        class46.byte_0 = httpRequest.Get( string_1, ( RequestParams ) null ).ToBytes( );
                    }
                    catch( HttpException ex )
                    {
                        if( ex.HttpStatusCode != HttpStatusCode.NotFound )
                        {
                            throw new InvalidOperationException( LocalizedStrings.Str2078Params.Put( ( object )ex.HttpStatusCode, ( object )dateTime_0 ) );
                        }
      ...
      int int_2 )
        {
            ...
            message.ServerTime = str.ToDateTime( format, ( CultureInfo ) null ).ApplyTimeZone( TimeZoneInfo.Utc );
                            ...
                            using( Stream stream = entry.Open( ) )
                            {
                                using( StreamReader streamReader = new StreamReader( stream ) )
                                {
                                    ...
                                    if( !str1.IsEmpty( ) )
                                    {
                                        ...
                                        {
                                            string[] array = ( ( IEnumerable< string > ) str2.Split( ',' ) ).Select< string, string >( GainCapitalHistorySource.Class49.func_0 ?? ( GainCapitalHistorySource.Class49.func_0 = new Func< string, string >( GainCapitalHistorySource.Class49.class49_0.method_0 ) ) ).ToArray< string >( );
    ...
    private sealed class Class49
    {
        ...
        private sealed class Class50
        {
            ...
            {
                DateTime result;
                if( DateTime.TryParseExact( htmlNode_0.InnerText.Trim( ), "dd MMMM", ( IFormatProvider ) CultureInfo.InvariantCulture, DateTimeStyles.None, out result ) )
                {
