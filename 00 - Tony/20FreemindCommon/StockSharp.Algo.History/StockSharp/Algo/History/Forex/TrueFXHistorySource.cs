...
namespace StockSharp.Algo.History.Forex
{
    public class TrueFXHistorySource : BaseDumpableHistorySource, ISecurityDownloader
    {
        ...
        private static string smethod_0(
          ...
          out string string_2 )
        {
            string_2 = "http://www.truefx.com/?page=download&description={1}{0}&dir={0}/{2}-{0}".Put( ( object )dateTime_0.Year, ( object )dateTime_0.ToString( "MMMM" ).ToLowerInvariant( ), ( object )dateTime_0.ToString( "MMMM" ) );
            return "http://www.truefx.com/dev/data/{0:yyyy}/{2}-{0:yyyy}/{1}-{0:yyyy}-{0:MM}.zip".Put( ( object )dateTime_0, ( object )securityId_0.SecurityCode.Remove( "/", false ), ( object )dateTime_0.ToString( "MMMM" ).ToUpperInvariant( ) );
        }
            ...
            foreach( string str in strArray )
            {
                ...
                if( securityStorage.LookupById( id ) == null )
                {
                    StockSharp.BusinessEntities.Security security = new StockSharp.BusinessEntities.Security( )
                    {
                        Id = id,
                        Code = str,
                        PriceStep = new Decimal?( str.ContainsIgnoreCase( "JPY" ) ? new Decimal( 1, 0, 0, false, ( byte )3 ) : new Decimal( 1, 0, 0, false, ( byte )5 ) ),
        ...
        public override string GetDumpFile(
          ...
          object arg )
        {
            return this.method_0( security.ToSecurityId( ( SecurityIdGenerator )null ), from, to, dataType, arg );
        }
          ...
          object object_0 )
        {
            ...
            return Path.Combine( this.DumpFolder, "{0}_{1}_{2:yyyy_MM}.zip".Put( ( object )securityId_0.SecurityCode.SecurityIdToFolderName( ), ( object )type_0.Name.ToLowerInvariant( ), ( object )dateTime_0 ) );
        }
          ...
          DateTime date )
        {
            ...
            return this.LoadTickMessages( class63.security_0.ToSecurityId( ( SecurityIdGenerator )null ), date ).Select< Level1ChangeMessage, MarketDepth >( new Func< Level1ChangeMessage, MarketDepth >( class63.method_0 ) );
        }
          ...
          DateTime date )
        {
            ...
            string str = this.CanDump ? this.method_0( class60.securityId_0, class60.dateTime_1, class60.dateTime_1, typeof( Level1ChangeMessage ), ( object )null ) : ( string )null;
            ...
            return ( IEnumerable< Level1ChangeMessage > )CultureInfo.InvariantCulture.DoInCulture< Level1ChangeMessage[ ] >( new Func< Level1ChangeMessage[ ] >( class60.method_0 ) );
        }
          ...
          Func< HttpResponse, T > func_0 )
        {
            ...
            } )
            {
                ...
                return func_0( bool_0 ? httpRequest.Post( string_2 ) : httpRequest.Get( string_2, ( RequestParams )null ) );
            }
        }
        ...
        private sealed class Class60
        {
              ...
              ZipArchiveEntry zipArchiveEntry_0 )
            {
                ...
                {
                    return ( IEnumerable< Level1ChangeMessage > )this.trueFXHistorySource_0.method_1( stream_0, this.securityId_0, this.dateTime_0, this.dateTime_1 ).ToArray< Level1ChangeMessage >( );
                }
            }
        }
