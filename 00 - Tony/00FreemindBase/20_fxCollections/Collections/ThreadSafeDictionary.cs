...
namespace fx.Collections
{
    ...
    /// </summary>
    public sealed class ThreadSafeDictionary< TKey, TValue > : IThreadSafeDictionary< TKey, TValue >, IEnumerable< KeyValuePair< TKey, TValue > > where TKey : notnull 
    {
        ...
        /// </summary>
        public ThreadSafeDictionary( ) : this( 31 )
        {
        }
        ...
        /// </summary>
        public ThreadSafeDictionary( int capacity ) : this( capacity, null!, null! )
        {
        }
        ...
        /// </summary>
        public ThreadSafeDictionary( IReaderWriterLockSlim readerWriterLock ) : this( 31, readerWriterLock, null! )
        {
        }
        ...
        /// </summary>
        public ThreadSafeDictionary( IEqualityComparer< TKey > comparer ) : this( 31, null!, comparer )
        {
        }
        ...
        internal void _GetNodeAndPreviousNode(
            int bucketIndex, int hashCode, TKey key, out _ThreadSafeDictionaryNode< TKey, TValue > resultNode, out _ThreadSafeDictionaryNode< TKey, TValue > resultPrviousNode )
        {
