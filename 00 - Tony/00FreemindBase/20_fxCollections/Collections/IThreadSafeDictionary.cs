...
namespace fx.Collections
{
    ...
    /// </summary>
    public interface IThreadSafeDictionary : IPfzDictionary
    {
        /// <summary>
    ...
    /// Interface that must be implemented by thread-safe PfzDictionary implementations.
    /// </summary>
    public interface IThreadSafeDictionary< TKey, TValue > : IPfzDictionary< TKey, TValue >, IThreadSafeDictionary
    {
        /// <summary>
