...
namespace fx.Collections
{
    ...
    /// [DebuggerStepThrough]
    [Serializable]
    public class HotSwapDictionary< TKey, TValue > : IDictionary< TKey, TValue> where TKey : notnull
    {
        volatile PooledDictionary< TKey, TValue > _instance = new PooledDictionary< TKey, TValue >( );
        ...
        public bool AddRange( TKey[] keys, TValue[] values )
        {
            ...
            lock( this )
            {
                PooledDictionary< TKey, TValue > instance = new PooledDictionary< TKey, TValue >( _instance );
        ...
        //{
        //    PooledDictionary<TKey, TValue> instance = _instance;
        ...
        public void Clear( )
        {
            lock( this )
            {
                _instance = new PooledDictionary< TKey, TValue >( );
            }
        }
