...
namespace Disruptor
{
    ...
    public class TonyValueBatchEventProcessor<T, TDataProvider, TSequenceBarrier, TEventHandler, TBatchStartAware> : IValueBatchEventProcessor<T>
        where T : struct
        ...
        where TBatchStartAware : IBatchStartAware
    {
        ...
        public TonyValueBatchEventProcessor( TDataProvider dataProvider, TSequenceBarrier sequenceBarrier, TEventHandler eventHandler, TBatchStartAware batchStartAware )
        {
