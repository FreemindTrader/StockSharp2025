...
namespace Disruptor.Dsl
{
        ...
        where T : class
    {
        ...
        public EventHandlerGroup<T> TonyHandleEventsWith( params IEventHandler<T>[ ] handlers )
        {
            return CreateTonyEventProcessors( new ISequence[ 0 ], handlers );
        }
        ...
        internal EventHandlerGroup<T> CreateTonyEventProcessors( ISequence[ ] barrierSequences, IEventHandler<T>[ ] eventHandlers )
        {
            CheckNotStarted();
