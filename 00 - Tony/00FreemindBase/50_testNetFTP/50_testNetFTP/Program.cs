...
namespace Tests
{
    ...
    class Program
    {
        static readonly string m_host = "192.168.4.9";
        static readonly string m_user = "ftpuser";
        static readonly string m_pass = "admin@OE20210707";
        ...
        static void Upload( FtpClient cl )
        {
            ...
            foreach ( string s in Directory.GetFiles( root, "help.html", SearchOption.AllDirectories ) )
            {
                string file = s;
