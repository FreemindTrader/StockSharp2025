...
namespace fx.TimePeriod
{
	...
	public class TimeLineMomentCollection : ITimeLineMomentCollection
	{
		...
		// ----------------------------------------------------------------------
		// members
		private readonly PooledList<ITimeLineMoment> timeLineMoments = new PooledList<ITimeLineMoment>();
		private readonly PooledDictionary<DateTime, ITimeLineMoment> timeLineMomentLookup = new PooledDictionary<DateTime, ITimeLineMoment>();
