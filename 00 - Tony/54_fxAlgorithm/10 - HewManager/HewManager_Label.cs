...
namespace fx.Algorithm
{
    public partial class HewManager
    {
                                                               ...
                                                               bool isOutsideBar )
        {
            ...
            //if ( bar.IsWavePeak() && bar.IsWaveTrough() )
            //{
            //    // Since this bar is both wave Peak and also wave Trough, we can only find out the waves by the previous and current label.
            //}
            //else
            //{
