...
namespace fx.Algorithm
{
    public partial class HewManager
    {
                    ...
                    while ( ( waveNameToBeAdded == ElliottWaveEnum.Wave5C ) || ( waveNameToBeAdded == ElliottWaveEnum.Wave5 ) )
                    {
                        ...
                        if ( lastHigherWave != null )
                        {
                            ...
                            if ( waveNameToBeAdded != ElliottWaveEnum.NONE )
                            {
                                ...
                                // Tony: Here we need to validate if this wave count fulfil the Wave Projection whatever requirement.

                                CheckWave5CRelationshipToWave4( changedWavedCycle, waveNameToBeAdded, labelPosition );
        ...
        public bool CheckWave5CRelationshipToWave4( ElliottWaveCycle changedWavedCycle, ElliottWaveEnum waveNameToBeAdded, WaveLabelPosition labelPosition )
        {
            return true;
        }
