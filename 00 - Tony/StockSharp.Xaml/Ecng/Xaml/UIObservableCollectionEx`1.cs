...
namespace Ecng.Xaml
{
    ...
    public class UIObservableCollectionEx<TItem> : ObservableCollectionEx<TItem>
    {
        /// <summary>
        /// </summary>
        protected override void ProcessCollectionChanged( IEnumerable<NotifyCollectionChangedEventHandler> subscribers, NotifyCollectionChangedAction action, IList<TItem> items, int index )
        {
