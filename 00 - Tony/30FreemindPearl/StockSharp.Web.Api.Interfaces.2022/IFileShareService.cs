...
{
    public interface IFileShareService : IBaseEntityService<FileShare>, IBaseService
    {
        ...
        Task<FileShare> GetByTokenAsync(string token, CancellationToken cancellationToken = default(CancellationToken));
