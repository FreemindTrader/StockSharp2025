...
// Type: StockSharp.Web.Api.Interfaces.IDiagramStrategyService
...
{
    public interface IDiagramStrategyService : IBaseEntityService<DiagramStrategy>, IBaseService
    {
        Task<BaseEntitySet<DiagramStrategy>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
