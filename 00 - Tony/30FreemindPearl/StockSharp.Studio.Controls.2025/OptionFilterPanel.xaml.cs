...
{
    public partial class OptionFilterPanel : UserControl, IPersistable, IDisposable
    {
        ...
        public DateTime? CurrentDate
        {
            ...
            private set
            {
                this.CurrentDateCtrl.EditValue =  value;
            }
        }
        ...
        public Decimal? AssetPrice
        {
            ...
            private set
            {
                this.AssetPriceCtrl.EditValue =  value;
            }
        }
        ...
        public bool UseBlackModel
        {
            get
            {
                return this.UseBlackModelCtrl.IsChecked.GetValueOrDefault();
            }
            private set
            {
        ...
        public DateTime? ExpiryDate
        {
            ...
            private set
            {
                this.ExpiryDateComboCtrl.SelectedItem =  value;
            }
        }
        ...
        public Decimal? MinStrike
        {
            ...
            private set
            {
                this.MinStrikeCtrl.EditValue =  value;
            }
        }
        ...
        public Decimal? MaxStrike
        {
            ...
            private set
            {
                this.MaxStrikeCtrl.EditValue =  value;
            }
        }
        ...
        public void Load( SettingsStorage storage )
        {
            ...
            this.MinStrike = ( Decimal? ) storage.GetValue<Decimal?>( "MinStrike",  new Decimal?() );
            this.MaxStrike = ( Decimal? ) storage.GetValue<Decimal?>( "MaxStrike",  new Decimal?() );
            this.UseBlackModel = ( bool ) storage.GetValue<bool>( "UseBlackModel",  false);
            this.CurrentDate = ( DateTime? ) storage.GetValue<DateTime?>( "CurrentDate",  new DateTime?() );
            this.AssetPrice = ( Decimal? ) storage.GetValue<Decimal?>( "AssetPrice",  new Decimal?() );
            ...
            if ( ( ( SynchronizedDictionary<string, object> ) storage ).ContainsKey( "UnderlyingAsset" ) )
            {
                ...
                try
                {
                    this.UnderlyingAsset = this.SecurityProvider.LookupById( ( string ) storage.GetValue<string>( "UnderlyingAsset",  null ) );
                }
                finally
                {
            ...
            if ( !( ( SynchronizedDictionary<string, object> ) storage ).ContainsKey( "Options" ) )
                return;
            string[] strArray = StringHelper.SplitByComma((string) storage.GetValue<string>("Options",  null), false);
        ...
        private void UnderlyingAssetCtrl_OnSecuritySelected( object sender, EditValueChangedEventArgs e )
        {
            ...
            if ( this._underlyingAsset != null )
            {
                if ( !this._changeFromCode )
                    ( ( SynchronizedSet<Security> ) this._options ).AddRange( this._underlyingAsset.GetDerivatives( this.SecurityProvider, new DateTimeOffset?() ) );
                this.UpdateSelectOptionsTitle();
                foreach ( Security option in this._options.Cache )
                    this.SubscribeMarketData( option );
        ...
        {
            this.ExpiryDateComboCtrl.ItemsSource =  ( ( IEnumerable<Security> ) this._options.Cache ).Select<Security, DateTime>( ( Func<Security, DateTime> ) ( o => o.ExpiryDate.Value.Date ) ).Distinct<DateTime>().OrderBy<DateTime, DateTime>( ( Func<DateTime, DateTime> ) ( d => d ) ).ToArray<DateTime>();
        }
          ...
          RoutedPropertyChangedEventArgs<double> e )
        {
            ...
            try
            {
                this.AssetPrice = new Decimal?( this._minAssetPrice.Value + this.UnderlyingAsset.ShrinkPrice( newValue / new Decimal( 100 ) * num ) );
            }
            finally
            {
        ...
        {
            this.AssetPriceReset.IsEnabled = false;
            this.AssetPriceCtrl.EditValue =  null;
        }
        ...
        {
            this.CurrentDateReset.IsEnabled = false;
            this.CurrentDateCtrl.EditValue =  null;
        }
        ...
        {
            this.ExpiryDateComboCtrl.EditValue =  null;
        }
