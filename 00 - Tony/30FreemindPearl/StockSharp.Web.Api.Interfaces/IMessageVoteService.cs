...
// Type: StockSharp.Web.Api.Interfaces.IMessageVoteService
...
{
    public interface IMessageVoteService : IBaseEntityService<MessageVote>, IBaseService
    {
        Task<BaseEntitySet<MessageVote>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
