...
// Type: StockSharp.Web.Api.Interfaces.IProductVersionMapService
...
{
    public interface IProductVersionMapService : IBaseEntityService<ProductVersionMap>, IBaseService
    {
        Task<BaseEntitySet<ProductVersionMap>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
