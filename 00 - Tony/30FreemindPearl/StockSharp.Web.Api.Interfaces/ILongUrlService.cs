...
// Type: StockSharp.Web.Api.Interfaces.ILongUrlService
...
{
    public interface ILongUrlService : IBaseEntityService<LongUrl>, IBaseService
    {
        Task<BaseEntitySet<LongUrl>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
