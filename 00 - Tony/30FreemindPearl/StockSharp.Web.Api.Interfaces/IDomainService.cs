...
// Type: StockSharp.Web.Api.Interfaces.IDomainService
...
{
    public interface IDomainService : IBaseEntityService<Domain>, IBaseService
    {
        Task<BaseEntitySet<Domain>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
