...
// Type: StockSharp.Web.Api.Interfaces.IIpBanService
...
{
    public interface IIpBanService : IBaseEntityService<IpBan>, IBaseService
    {
        Task<BaseEntitySet<IpBan>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
