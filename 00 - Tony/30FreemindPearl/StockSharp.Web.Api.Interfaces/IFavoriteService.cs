...
// Type: StockSharp.Web.Api.Interfaces.IFavoriteService
...
{
    public interface IFavoriteService : IBaseEntityService<Favorite>, IBaseService
    {
        Task<BaseEntitySet<Favorite>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
