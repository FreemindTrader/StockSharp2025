...
// Type: StockSharp.Web.Api.Interfaces.IPayGatewayService
...
{
    public interface IPayGatewayService : IBaseEntityService<PayGateway>, IBaseService
    {
        Task<BaseEntitySet<PayGateway>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
