...
// Type: StockSharp.Web.Api.Interfaces.IProfileVisitService
...
{
    public interface IProfileVisitService : IBaseEntityService<ProfileVisit>, IBaseService
    {
        Task<BaseEntitySet<ProfileVisit>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
