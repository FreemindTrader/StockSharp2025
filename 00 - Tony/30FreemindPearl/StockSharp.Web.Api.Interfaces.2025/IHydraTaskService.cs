...
// Type: StockSharp.Web.Api.Interfaces.IHydraTaskService
...
{
    public interface IHydraTaskService : IBaseEntityService<HydraTask>, ICommandService<HydraTask>
    {
        Task<BaseEntitySet<HydraTask>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
