...
// Type: StockSharp.Web.Api.Interfaces.IStrategyPositionService
...
{
    public interface IStrategyPositionService : IBaseEntityService<StrategyPosition>
    {
        Task<BaseEntitySet<StrategyPosition>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
