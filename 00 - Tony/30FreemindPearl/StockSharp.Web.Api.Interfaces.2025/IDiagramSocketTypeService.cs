...
// Type: StockSharp.Web.Api.Interfaces.IDiagramSocketTypeService
...
{
    public interface IDiagramSocketTypeService : IBaseEntityService<DiagramSocketType>
    {
        Task<BaseEntitySet<DiagramSocketType>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
