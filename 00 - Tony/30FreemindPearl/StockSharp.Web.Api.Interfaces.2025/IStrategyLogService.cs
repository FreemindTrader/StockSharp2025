...
// Type: StockSharp.Web.Api.Interfaces.IStrategyLogService
...
{
    public interface IStrategyLogService : IBaseEntityService<StrategyLog>
    {
        Task<BaseEntitySet<StrategyLog>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
