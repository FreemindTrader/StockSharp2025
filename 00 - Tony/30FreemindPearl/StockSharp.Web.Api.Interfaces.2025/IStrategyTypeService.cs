...
// Type: StockSharp.Web.Api.Interfaces.IStrategyTypeService
...
{
    public interface IStrategyTypeService : IBaseEntityService<StrategyType>
    {
        Task<BaseEntitySet<StrategyType>> FindAsync(
          long skip = 0,
          long? count = null,
          bool? deleted = null,
          string orderBy = null,
