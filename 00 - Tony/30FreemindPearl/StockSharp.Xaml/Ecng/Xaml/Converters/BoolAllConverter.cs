...
// Type: Ecng.Xaml.Converters.BoolAllConverter
...
namespace Ecng.Xaml.Converters
{
    ...
    public class BoolAllConverter : IMultiValueConverter
    {
        ...
        object IMultiValueConverter.Convert( object[ ] _param1, Type _param2, object _param3, CultureInfo _param4 )
        {
            return ( object )( ( IEnumerable<object> )_param1 ).All<object>( new Func<object, bool>( this.IsBoolEqual ) );
        }
