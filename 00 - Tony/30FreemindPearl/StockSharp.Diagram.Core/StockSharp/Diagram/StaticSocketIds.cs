...
{
    /// <summary>Socket ids for static sockets.</summary>
    public enum StaticSocketIds
    {
        ...
        Portfolio,
        /// <summary>Underlying asset.</summary>
        UnderlyingAsset,
        /// <summary>Unrealized profit.</summary>
        PnLUnreal,
        /// <summary>Realized profit.</summary>
        PnLRealized,
