namespace StockSharp.FxConnectFXCM
{
    ...
    public partial class FxConnectFxcmMsgAdapter
    {
        ...
        [Display( Description = LocalizedStrings.Str1440Key, GroupName = LocalizedStrings.Str1435Key, Name = LocalizedStrings.Str1440Key, Order = 0, ResourceType = typeof( LocalizedStrings ) )]
        public string Proxy
        {
            get
            {
        ...
        [Display( Description = LocalizedStrings.Str3720Key, GroupName = LocalizedStrings.Str1435Key, Name = LocalizedStrings.Str3720Key, Order = 1, ResourceType = typeof( LocalizedStrings ) )]
