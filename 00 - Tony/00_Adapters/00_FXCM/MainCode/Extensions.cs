...
namespace StockSharp.FxConnectFXCM
{
    ...
    internal static class FxcmFxconnectHelper
    {
        ...
        public static string ToSidesString( this Sides sides_0 )
        {
            ...
            {
                throw new ArgumentOutOfRangeException( "side", sides_0, LocalizedStrings.InvalidArgumentValueKey );
            }
        ...
        public static Sides ToSides( this string buySell )
        {
            ...
            throw new ArgumentOutOfRangeException( "side", buySell, LocalizedStrings.InvalidArgumentValueKey );
        }
        ...
        public static string ToFxcmTIF( this TimeInForce? tif, DateTimeOffset? offset )
        {
            if ( tif.HasValue )
            {
                switch ( tif.GetValueOrDefault( ) )
                {
                    ...
                    default:
                        throw new ArgumentOutOfRangeException( "tif", tif, LocalizedStrings.InvalidArgumentValueKey );
                }
            }
            if ( !offset.HasValue )
            {
        ...
        public static TimeInForce ToSxTIF( this string string_0 )
        {
            ...
            if ( !( string_0 == "IOC" ) )
            {
                throw new ArgumentOutOfRangeException( "value", string_0, LocalizedStrings.InvalidArgumentValueKey );
            }
        ...
        public static O2GTimeframe ToFxcmTimeFrame( this TimeSpan ts, O2GTimeframeCollection tc )
        {
            switch ( ts.Ticks )
            {
                ...
                case 25920000000000:
                    return tc[ "M1" ];
                default:
                    throw new ArgumentOutOfRangeException( "value", ts, LocalizedStrings.InvalidArgumentValueKey );
            }
        }
          ...
          this FxcmExtendedOrderTypes orderType )
        {
            switch ( orderType )
            {
                ...
                case FxcmExtendedOrderTypes.CloseLimit:
                    return "CL";
                default:
                    throw new ArgumentOutOfRangeException( "type", orderType, LocalizedStrings.InvalidArgumentValueKey );
            }
        }
        ...
        public static OrderStates ToSxOrderStates( this string fxcmStatus )
        {
            ...
            throw new ArgumentOutOfRangeException( "value", fxcmStatus, LocalizedStrings.InvalidArgumentValueKey );
        ...
        public static OrderTypes ToSxOrderType( this string fxcmOrder, out FxcmExtendedOrderTypes? extOrderType )
        {
            ...
            throw new ArgumentOutOfRangeException( "value", fxcmOrder, LocalizedStrings.InvalidArgumentValueKey );
        }
