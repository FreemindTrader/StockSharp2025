...
{
    public class DetailedOrderDB : IDetailedOrder, IFxcm, IEquatable<IDetailedOrder>
    {
        ...
        public DetailedOrderDB( string mainLoginName, O2GOrderRow fxOrder )
        {
            AccountID         = fxOrder.AccountID;
            AccountKind       = fxOrder.AccountKind;
            MainLoginName     = mainLoginName;
            AccountName       = fxOrder.AccountName;
            Amount            = fxOrder.Amount;
            AtMarket          = fxOrder.AtMarket;
            BuySell           = fxOrder.BuySell;
            ContingencyType   = fxOrder.ContingencyType.To<int>( );
            ContingentOrderID = fxOrder.ContingentOrderID;
            ExecutionRate     = fxOrder.ExecutionRate;
            ExpireDate        = fxOrder.ExpireDate.ToLinuxTime( );
            FilledAmount      = fxOrder.FilledAmount;
            NetQuantity       = fxOrder.NetQuantity;
            OfferID           = fxOrder.OfferID;
            OrderID           = fxOrder.OrderID;
            OriginAmount      = fxOrder.OriginAmount;
            Parties           = fxOrder.Parties;
            PegOffset         = fxOrder.PegOffset;
            PegType           = fxOrder.PegType;
            PrimaryID         = fxOrder.PrimaryID;
            Rate              = fxOrder.Rate;
            RateMax           = fxOrder.RateMax;
            RateMin           = fxOrder.RateMin;
            RequestID         = fxOrder.RequestID;
            RequestTXT        = fxOrder.RequestTXT;
            Stage             = fxOrder.Stage;
            Status            = fxOrder.Status;
            StatusTime        = fxOrder.StatusTime.ToLinuxTime( );
            StatusTimeDT      = StatusTime.FromLinuxTime( );
            TimeInForce       = fxOrder.TimeInForce;
            TradeID           = fxOrder.TradeID;
            TrailRate         = fxOrder.TrailRate;
            TrailStep         = fxOrder.TrailStep;
            Type              = fxOrder.Type;
            ValueDate         = fxOrder.ValueDate;
            WorkingIndicator  = fxOrder.WorkingIndicator;
        }
