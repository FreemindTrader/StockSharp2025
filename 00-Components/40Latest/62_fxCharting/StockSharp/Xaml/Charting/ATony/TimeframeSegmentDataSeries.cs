...
//        private readonly FifoBuffer< TimeframeDataSegment > _segments = new FifoBuffer< TimeframeDataSegment >( 128 );
//        private readonly FifoBuffer< DateTime > _segmentDates = new FifoBuffer< DateTime >( 128 );
...
//        internal ISciList< TimeframeDataSegment > Segments
//        {
//            get
//            {
//                return ( ISciList< TimeframeDataSegment > )this._segments;
//            }
//        }
...
//            get
//            {
//                return ( IList< DateTime > )this._segmentDates;
//            }
//        }
...
//        public void Clear( )
//        {
//            SciChartDebugLogger.Instance.WriteLine( "ERROR: TimeframeSegmentDataSeries.Clear(): not supported" );
//        }
...
//            SciChartDebugLogger.Instance.WriteLine( "GetIndicesRange(timeframesegment): Min={0}, Max={1}", ( object )indexRange.Min, ( object )indexRange.Max );
//            return indexRange;
//        }
...
//        public DataSeriesType DataSeriesType => throw new NotImplementedException( );
...
//        public IPointSeries ToPointSeries( ResamplingParams resamplingParams, ResamplingMode resamplingMode, IPointResamplerFactory factory, IPointSeries lastPointSeries )
//        {
//            throw new NotImplementedException( );
//        }
