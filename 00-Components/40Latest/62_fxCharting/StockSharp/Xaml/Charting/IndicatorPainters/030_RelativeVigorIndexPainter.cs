...
public class RelativeVigorIndexPainter : BaseChartIndicatorPainter<RelativeVigorIndex>
{
    ...
    public RelativeVigorIndexPainter()
    {
        ...
        _average = (IChartLineElement)new ChartLineElement()
        {
            Color = indicatorColorProvider.GetNextColor()
        };
        AddChildElement((IChartElement)Signal);
        AddChildElement((IChartElement)Average);
    }
    ...
    public override void Load(SettingsStorage storage)
    {
        ...
        PersistableHelper.Load((IPersistable)Average, storage, "Average");
    }
    ...
    public override void Save(SettingsStorage storage)
    {
        ...
        storage.SetValue<SettingsStorage>("Average", PersistableHelper.Save((IPersistable)Average));
    }
}
