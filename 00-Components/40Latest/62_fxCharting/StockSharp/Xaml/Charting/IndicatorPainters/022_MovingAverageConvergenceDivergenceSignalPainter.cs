  ...
  BaseChartIndicatorPainter<MovingAverageConvergenceDivergenceSignal>
{
    ...
    public MovingAverageConvergenceDivergenceSignalPainter()
    {
        ...
        AddChildElement((IChartElement)SignalMa);
    }
    ...
    public override void Load(SettingsStorage storage)
    {
        ...
        PersistableHelper.Load((IPersistable)SignalMa, storage, "SignalMa");
    }
    ...
    public override void Save(SettingsStorage storage)
    {
        ...
        storage.SetValue<SettingsStorage>("SignalMa", PersistableHelper.Save((IPersistable)SignalMa));
    }
}
