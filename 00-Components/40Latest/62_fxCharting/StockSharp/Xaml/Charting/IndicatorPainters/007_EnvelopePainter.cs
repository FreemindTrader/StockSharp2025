...
public class EnvelopePainter : BaseChartIndicatorPainter<Envelope>
{
    ...
    public EnvelopePainter()
    {
        ...
        AddChildElement( ( IChartElement ) ( _band = ( IChartBandElement ) chartBandElement ) );
        AddChildElement( ( IChartElement ) ( _movingAverage = ( IChartLineElement ) chartLineElement ) );
    ...
    public IChartBandElement Band => _band;
    ...
    public IChartLineElement MovingAverage => _movingAverage;

    protected override bool OnDraw(
      Envelope indicator,
      IDictionary<IIndicator, IList<ChartDrawData.IndicatorData>> data )
    {
        return ( 0 | ( DrawValues( data[ ( IIndicator ) indicator.Upper ], data[ ( IIndicator ) indicator.Lower ], ( IChartElement ) Band ) ? 1 : 0 ) | ( DrawValues( data[ ( IIndicator ) indicator.Middle ], ( IChartElement ) MovingAverage ) ? 1 : 0 ) ) != 0;
    }
