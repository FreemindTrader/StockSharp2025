...
public class IndicatorColorProvider : IIndicatorColorProvider
{
    ...
    {
        _isDarkTheme = StockSharp.Xaml.ThemeExtensions.IsCurrDark();
    ...
    {
        int num = CollectionHelper.SyncGet(_indicatorColorProviderSeedMap, p=>
        {
        ...
        Color[] colorArray = _isDarkTheme ? IndicatorColorProvider._lightColorMap : IndicatorColorProvider._darkColorMap;
