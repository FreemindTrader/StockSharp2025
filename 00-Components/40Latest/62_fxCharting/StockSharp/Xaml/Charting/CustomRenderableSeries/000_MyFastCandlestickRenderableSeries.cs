...
/// <summary>
/// The reason that I created this class is to have two version of custom drawing for the derived class
/// 
///     methods:    DrawReduced - we can custom draw when we have a lot of points and resampling is required
///                 DrawVanilla - this is the default normal view of the chart
/// </summary>
