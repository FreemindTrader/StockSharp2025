...
/// <summary>
/// A ThemedWindow that shows <see cref="Subscription"/> settings.
/// </summary>
public partial class CandleSettingsWindow : ThemedWindow, IComponentConnector
{
    ...
    public Subscription Subscription
    {
        ...
        {
            _subscription = value;
            SubscriptionCtrl.SelectedObject = value == null ? null : new SubscriptionNotifiableObject( value );
    ...
    private void OkButtonClicked( object _param1, RoutedEventArgs e )
    {
    ...
    /// <summary>
    /// An bindable object for <see cref="Subscription"/> settings.
    /// 
    /// It will notify the following changes.
    ///     - CandleType
    ///     - Security
    ///     - IsCalcVolumeProfile
    ///     
    /// </summary>
    private sealed class SubscriptionNotifiableObject : NotifiableObject
    {
        ...
        public SubscriptionNotifiableObject( Subscription subscription )
        {
            _marketDataMsg = subscription != null ? subscription.MarketData : throw new ArgumentNullException( "subscription" );
            
            if ( _marketDataMsg.From.HasValue )
                return;
            
            if ( _marketDataMsg.To.HasValue )
                return;
        ...
        public Messages.DataType CandleType
        {
            ...
            set
            {
                ...
                if ( value == null || value.MessageType.IsBuildOnly() == false )
                    return;                
