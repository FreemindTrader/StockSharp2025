...
//            else
//            {
//                propertyDescriptors = new List<PropertyDescriptor>( ChartComponentChartSettings.Create( _someStringMethod001( element?.GetName( myChartComponentProp ) ?? Extensions.GetDisplayName( s, null ) ), element, myChartComponentProp, _propertyDescSelector ) );
//            }
...
//        {
//            return !TypeHelper.Is<StockSharp.Charting.IChartElement>( _param1.PropertyType, true ) ? _param1 : ChartComponentChartSettings.Create( SomeMoreMEthod34313413413._someStringMethod001( Extensions.GetDisplayName( _param1, ( string ) null ) ), _IChartIndicatorPainter, ( IChartComponent ) _param1.GetValue( _IChartIndicatorPainter ), SomeMoreMEthod34313413413._ChartComponentChartSettings001._propertyDescSelector );
//        }
//    }
...
//            string str = s;
//            int num = 0;
//            while ( !_hashsetstring001.Add( str ) )
//                str = s + ( ++num ).ToString();
//            return str;
//        }
...
//        {
//            Func<IChartComponent, PropertyDescriptor, bool> _someInstance0034 = _ChartComponentChartSettings001._propertyDescSelector;
//            if ( ( _someInstance0034 != null ? ( _someInstance0034( _IChartComponent001, p ) ? 1 : 0 ) : 1 ) == 0 )
//                return false;
//            IChartComponent zLiCojrU = _IChartComponent001;
...
//        {
//            object obj = _param1.GetValue((object) _IChartComponent001);
//            ChartComponentChartSettings.SomeSealClass0365 d295Ww4skLs1HZBq = new ChartComponentChartSettings.SomeSealClass0365();
//            d295Ww4skLs1HZBq.SomeMoreMEthod34313413413 = this;
//            IEnumerable<PropertyDescriptor> propertyDescriptors;
...
//            }
//            else
//                propertyDescriptors = ( IEnumerable<PropertyDescriptor> ) new List< PropertyDescriptor > ( ChartComponentChartSettings.Create( _someStringMethod001( _IChartComponent001?.GetName(  myChartComponentProp ) ?? Extensions.GetDisplayName( _param1, ( string ) null ) ), _IChartComponent001, myChartComponentProp, _ChartComponentChartSettings001._propertyDescSelector ) );
//            return propertyDescriptors;
//        }
//    }
