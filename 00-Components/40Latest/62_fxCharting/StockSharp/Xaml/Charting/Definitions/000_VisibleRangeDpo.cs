...
public sealed class VisibleRangeDpo : DependencyObject
{
    ...
    {
        _chartAxisType = _param1;
        InitRangeDepProperty(_param2);
    }
    ...
    public IndexRange CategoryDateTimeRange
    {
        ...
        set
        {
            SetValue(CategoryDateTimeRangeProperty, (object) value);
        }
    }
    ...
    public DoubleRange NumericRange
    {
        ...
        set
        {
            SetValue(NumericRangeProperty, (object) value);
        }
    }
    ...
    public DateRange DateTimeRange
    {
        ...
        set
        {
            SetValue(DateTimeRangeProperty, (object) value);
        }
    }
