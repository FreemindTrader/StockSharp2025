...
// Type: StockSharp.Web.Api.Interfaces.ITopicVisitService
...
public interface ITopicVisitService : IBaseEntityService<TopicVisit>
{
    Task<BaseEntitySet<TopicVisit>> FindAsync(
      long skip = 0,
      long? count = null,
      bool? deleted = null,
      string orderBy = null,
