...
// Type: StockSharp.Web.Api.Interfaces.IAccessTokenService
...
public interface IAccessTokenService : IBaseEntityService<AccessToken>
{
    Task<BaseEntitySet<AccessToken>> FindAsync(
      long skip = 0,
      long? count = null,
      bool? deleted = null,
      string orderBy = null,
      ...
      long? clientId = null,
      AccessTokenScopes? scopeMask = null,
      string like = null,
