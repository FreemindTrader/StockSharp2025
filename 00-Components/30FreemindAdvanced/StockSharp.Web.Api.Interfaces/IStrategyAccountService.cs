...
// Type: StockSharp.Web.Api.Interfaces.IStrategyAccountService
...
public interface IStrategyAccountService : IBaseEntityService<StrategyAccount>
{
    Task<BaseEntitySet<StrategyAccount>> FindAsync(
      long skip = 0,
      long? count = null,
      bool? deleted = null,
      string orderBy = null,
