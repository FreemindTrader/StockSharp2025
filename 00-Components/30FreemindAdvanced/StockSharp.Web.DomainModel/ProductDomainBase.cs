...
public abstract class ProductDomainBase : BaseEntity, IDomainEntity, INameEntity
{
    ...
    public override void Load(SettingsStorage storage)
    {
        ...
        this.AllApps = storage.GetValue<ProductDomainBasePrices>("AllApps", (ProductDomainBasePrices)null);
        this.OneApps = storage.GetValue<ProductDomainBasePrices>("OneApps", (ProductDomainBasePrices)null);
