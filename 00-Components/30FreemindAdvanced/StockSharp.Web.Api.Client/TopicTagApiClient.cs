...
internal class TopicTagApiClient :
  BaseApiEntityClient<TopicTag>,
  ITopicTagService,
  IBaseEntityService<TopicTag>
{
    ...
    Task<TopicTag> ITopicTagService.GetByNameAsync(string name, CancellationToken cancellationToken)
    {
