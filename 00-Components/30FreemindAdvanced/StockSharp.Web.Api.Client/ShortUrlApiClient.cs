...
internal class ShortUrlApiClient :
  BaseApiEntityClient<ShortUrl>,
  IShortUrlService,
  IBaseEntityService<ShortUrl>
{
    ...
    Task<ShortUrl> IShortUrlService.GetByShortAsync(string url, CancellationToken cancellationToken)
    {
