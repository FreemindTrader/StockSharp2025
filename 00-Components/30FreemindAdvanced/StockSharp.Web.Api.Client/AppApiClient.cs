...
internal class AppApiClient :
  BaseApiEntityClient<App>,
  IAppService,
  IBaseEntityService<App>,
  ICommandService<App>
{
    ...
    Task<bool> IAppService.DeleteByUserIdAsync(string userId, CancellationToken cancellationToken)
    {
    ...
    Task ICommandService<App>.UpdateStatusAsync(App status, CancellationToken cancellationToken)
    {
