...
//        public PooledList<MatchedSRinfo> GetWavePeakToPivotStatus( IBarEx bar )
//        {
...
//            {
//                var matched = bar.GetUpperShadowSRInfo( _timePeriod, pivot.Key.ToString( ), pivot.Value );
...
//        public PooledList<MatchedSRinfo> GetWaveTroughToPivotStatus( IBarEx bar )
//        {
//            var output = new PooledList< MatchedSRinfo >( );
//            var candleRange = bar.WholeCandle;
...
//            foreach ( var pivot in _pivotsDictionary )
//            {
//                var matched = bar.GetLowerShadowSRInfo( _timePeriod, pivot.Key.ToString( ), pivot.Value );
//                if (matched != null)
//                {
//                    output.Add(matched);
//                }
