...
////	/// </summary>
////	public class fxfxLocalMarketDataDrive : BaseMarketDataDrive
////	{
////		private sealed class fxfxLocalMarketDataStorageDrive : IMarketDataStorageDrive
////		{
...
////			public fxfxLocalMarketDataStorageDrive( DataType dataType, string path, StorageFormats format, fxfxLocalMarketDataDrive drive )
////			{
...
////			private readonly fxfxLocalMarketDataDrive _drive;
...
////            public Stream LoadStream( DateTime date, bool readOnly = false )
////            {
////                throw new NotImplementedException();
////            }
////        }

////		private readonly SynchronizedDictionary<Tuple<SecurityId, DataType, StorageFormats>, fxfxLocalMarketDataStorageDrive> _drives = new SynchronizedDictionary<Tuple<SecurityId, DataType, StorageFormats>, fxfxLocalMarketDataStorageDrive>();

////		/// <summary>
////		/// Initializes a new instance of the <see cref="fxfxLocalMarketDataDrive"/>.
////		/// </summary>
////		public fxfxLocalMarketDataDrive() : this( Directory.GetCurrentDirectory() )
////		{
////		}
...
////		public fxfxLocalMarketDataDrive( string path )
////		{
...
////				key => new fxfxLocalMarketDataStorageDrive( dataType, GetSecurityPath( securityId ), format, this ) );
////		}
...
////								.OrderBy(f => IOPath.GetExtension(f).EqualsIgnoreCase(".bin") ))
////							.FirstOrDefault();
...
//{
//    private class fxLocalMarketDataStorageDrive : IMarketDataStorageDrive
//    {
...
//        public fxLocalMarketDataStorageDrive( DataType dataType, SecurityId secId, StorageFormats format, fxLocalMarketDataDrive drive )
//        {
//            _dataType = dataType ?? throw new ArgumentNullException( nameof( dataType ) );
//            _secId = secId;
//            _format = format;
...
//    private readonly SynchronizedDictionary<(SecurityId, DataType, StorageFormats), fxLocalMarketDataStorageDrive> _drives = [];

//    /// <summary>
//    /// Initializes a new instance of the <see cref="fxLocalMarketDataDrive"/>.
//    /// </summary>
//    public fxLocalMarketDataDrive()
...
//    public static IEnumerable<SecurityId> GetAvailableSecurities( string path )
//    {
//        using var drive = new fxLocalMarketDataDrive(path);
...
//            key => new fxLocalMarketDataStorageDrive( dataType, securityId, format, this ) );
//    }
