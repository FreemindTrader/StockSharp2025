...
//        /// </summary>
//        /// <param name="unitOfWorkFactory">A factory used to create the unit of work instance. ( unitOfWorkFactory ?? UnitOfWorkSource.GetUnitOfWorkFactory() )</param>
//        /// <param name="getRepositoryFunc">A function that returns the repository representing entities of a given type.( x => x.EURUSD01 )</param>
//        /// <param name="getEntityDisplayNameFunc">An optional parameter that provides a function to obtain the display text for a given entity. If ommited, the primary key value is used as a display text. ( x => x.StartDate )</param>
//        protected SingleObjectViewModel( 
...
//        protected CollectionViewModel< TDetailEntity , TDetailPrimaryKey , TUnitOfWork > 
//            GetDetailsCollectionViewModel< TViewModel , TDetailEntity , TDetailPrimaryKey , TForeignKey >
//            (
...
//        {
//            return  GetCollectionViewModelCore< CollectionViewModel< TDetailEntity , TDetailPrimaryKey , TUnitOfWork > , TDetailEntity , TDetailEntity , TForeignKey >
//                    ( 
//                        propertyExpression , 
...
//            GetDetailProjectionsCollectionViewModel< TViewModel , TDetailEntity , TDetailProjection , TDetailPrimaryKey , TForeignKey >
//            (
...
//        {
//            return GetCollectionViewModelCore< CollectionViewModel< TDetailEntity , TDetailProjection , TDetailPrimaryKey , TUnitOfWork > , TDetailEntity , TDetailProjection , TForeignKey >
//                   ( 
//                        propertyExpression , 
//                        foreignKeyExpression ,
//                        () => CollectionViewModel< TDetailEntity , TDetailProjection , TDetailPrimaryKey , TUnitOfWork >.CreateProjectionCollectionViewModel( 
//                                                                                                                                                                UnitOfWorkFactory , 
//                                                                                                                                                                getRepositoryFunc , 
//                                                                                                                                                                projection , 
//                                                                                                                                                                CreateForeignKeyPropertyInitializer( setMasterEntityKeyAction , PrimaryKey ) , 
...
//        protected ReadOnlyCollectionViewModel< TDetailEntity , TUnitOfWork > 
//            GetReadOnlyDetailsCollectionViewModel< TViewModel , TDetailEntity , TForeignKey >
//            (
...
//            where TDetailProjection : class
//        {
//            return GetCollectionViewModelCore< ReadOnlyCollectionViewModel< TDetailEntity , TDetailProjection , TUnitOfWork > , TDetailEntity , TDetailProjection , TForeignKey >
//                   ( 
//                        propertyExpression , 
//                        foreignKeyExpression ,
//                        () => ReadOnlyCollectionViewModel< TDetailEntity , TDetailProjection , TUnitOfWork >.CreateReadOnlyProjectionCollectionViewModel( 
//                                                                                                                                                            UnitOfWorkFactory , 
//                                                                                                                                                            getRepositoryFunc , 
//                                                                                                                                                            projection 
//                                                                                                                                                        ) 
...
//        protected IEntitiesViewModel< TLookUpEntity > 
//            GetLookUpEntitiesViewModel< TViewModel , TLookUpEntity , TLookUpEntityKey >
//            ( 
...
//        protected virtual IEntitiesViewModel< TLookUpProjection > 
//            GetLookUpProjectionsViewModel< TViewModel , TLookUpEntity , TLookUpProjection , TLookUpEntityKey >
//            ( 
...
//        static Action< TDetailEntity > 
//            CreateForeignKeyPropertyInitializer< TDetailEntity , TForeignKey >
//            ( 
//                Action< TDetailEntity , TPrimaryKey > setMasterEntityKeyAction , 
//                TForeignKey                           masterEntityKey 
//            ) 
//            where TDetailEntity : class
//        {
...
//                   where TDetailProjection : class
//        {
//            return GetEntitiesViewModelCore< TViewModel , TDetailProjection >
//                   ( 
//                        propertyExpression ,
//                        () => CreateAndInitializeCollectionViewModel< TViewModel , TDetailEntity , TDetailProjection , TForeignKey >( 
//                                                                                                                                        createViewModelCallback , 
//                                                                                                                                        foreignKeyExpression 
//                                                                                                                                    ) 
//                   );
//        }

//        TViewModel CreateAndInitializeCollectionViewModel< TViewModel , TDetailEntity , TDetailProjection , TForeignKey >
//                   ( 
//                        Func< TViewModel > createViewModelCallback , 
//                        Expression< Func< TDetailEntity , TForeignKey > > foreignKeyExpression 
//                   )
