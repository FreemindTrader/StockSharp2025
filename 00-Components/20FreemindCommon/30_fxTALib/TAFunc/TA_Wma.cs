...
namespace fx.TALib
{
    ...
    {
        public static RetCode Wma( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outReal, out int outBegIdx, out int outNbElement,
            int optInTimePeriod = 30 )
        {
            ...
            {
                double tempReal = bars[inIdx++].Close;
                periodSub += tempReal;
            ...
            while ( inIdx <= endIdx )
            {
                ...
                trailingValue = bars[ trailingIdx++ ].Close;
