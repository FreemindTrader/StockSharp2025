...
namespace fx.TALib
{
    ...
    {
        public static RetCode Aroon( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outAroonDown, double[ ] outAroonUp,
            out int outBegIdx, out int outNbElement, int optInTimePeriod = 14 )
        {
            ...
            if ( bars == null || outAroonDown == null || outAroonUp == null || optInTimePeriod < 2 ||
