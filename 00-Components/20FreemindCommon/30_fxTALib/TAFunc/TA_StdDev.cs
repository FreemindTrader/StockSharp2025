...
namespace fx.TALib
{
    ...
    {
        public static RetCode StdDev( IHistoricBarsRepo bars, int startIdx, int endIdx, double[ ] outReal, out int outBegIdx, out int outNbElement,
            int optInTimePeriod = 5, double optInNbDev = 1.0 )
        {
            ...
            RetCode retCode = TA_INT_VAR(bars, startIdx, endIdx, outReal, out outBegIdx, out outNbElement, optInTimePeriod);
