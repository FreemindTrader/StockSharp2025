...
namespace fx.Collections
{
    ...
    [Serializable]
    public class RefpList<T> : IEnumerable<T>, IList, IDisposable, IDeserializationCallback
    {
        ...
        /// as required.
        /// </summary>
        public RefpList() : this(ClearMode.Auto, ArrayPool<T>.Shared) { }
        ...
        /// as required.
        /// </summary>
        public RefpList(ClearMode clearMode) : this(clearMode, ArrayPool<T>.Shared) { }
        ...
        /// as required.
        /// </summary>
        public RefpList(ArrayPool<T> customPool) : this(ClearMode.Auto, customPool) { }
        ...
        /// as required.
        /// </summary>
        public RefpList(ClearMode clearMode, ArrayPool<T> customPool)
        {
            _items = s_emptyArray;
        ...
        /// </summary>
        public RefpList(int capacity) : this(capacity, ClearMode.Auto, ArrayPool<T>.Shared) { }
        ...
        /// before any reallocations are required.
        /// </summary>
        public RefpList(int capacity, bool sizeToCapacity) : this(capacity, ClearMode.Auto, ArrayPool<T>.Shared, sizeToCapacity) { }
        ...
        /// before any reallocations are required.
        /// </summary>
        public RefpList(int capacity, ClearMode clearMode) : this(capacity, clearMode, ArrayPool<T>.Shared) { }
        ...
        /// before any reallocations are required.
        /// </summary>
        public RefpList(int capacity, ClearMode clearMode, bool sizeToCapacity) : this(capacity, clearMode, ArrayPool<T>.Shared, sizeToCapacity) { }
        ...
        /// before any reallocations are required.
        /// </summary>
        public RefpList(int capacity, ArrayPool<T> customPool) : this(capacity, ClearMode.Auto, customPool) { }
        ...
        /// before any reallocations are required.
        /// </summary>
        public RefpList(int capacity, ArrayPool<T> customPool, bool sizeToCapacity) : this(capacity, ClearMode.Auto, customPool, sizeToCapacity) { }
        ...
        /// before any reallocations are required.
        /// </summary>
        public RefpList(int capacity, ClearMode clearMode, ArrayPool<T> customPool) : this(capacity, clearMode, customPool, false) { }
        ...
        public RefpList(int capacity, ClearMode clearMode, ArrayPool<T> customPool, bool sizeToCapacity)
        {
            if (capacity < 0)
        ...
        public Span<T> GetSpan( int start, int end )
        {
            Span<T> output = _items;

            return output.Slice(start, end - start + 1 );
        }

        public Span<T> GetSpan(uint start, uint end)
        {
            Span<T> output = _items;
        ...
        /// given collection.
        /// </summary>
        public RefpList(T[] array) : this(array.AsSpan(), ClearMode.Auto, ArrayPool<T>.Shared) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(T[] array, ClearMode clearMode) : this(array.AsSpan(), clearMode, ArrayPool<T>.Shared) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(T[] array, ArrayPool<T> customPool) : this(array.AsSpan(), ClearMode.Auto, customPool) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(T[] array, ClearMode clearMode, ArrayPool<T> customPool) : this(array.AsSpan(), clearMode, customPool) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(ReadOnlySpan<T> span) : this(span, ClearMode.Auto, ArrayPool<T>.Shared) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(ReadOnlySpan<T> span, ClearMode clearMode) : this(span, clearMode, ArrayPool<T>.Shared) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(ReadOnlySpan<T> span, ArrayPool<T> customPool) : this(span, ClearMode.Auto, customPool) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(ReadOnlySpan<T> span, ClearMode clearMode, ArrayPool<T> customPool)
        {
            _pool = customPool ?? ArrayPool<T>.Shared;
            _clearOnFree = ShouldClear(clearMode);
        ...
        /// given collection.
        /// </summary>
        public RefpList(IEnumerable<T> collection) : this(collection, ClearMode.Auto, ArrayPool<T>.Shared) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(IEnumerable<T> collection, ClearMode clearMode) : this(collection, clearMode, ArrayPool<T>.Shared) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(IEnumerable<T> collection, ArrayPool<T> customPool) : this(collection, ClearMode.Auto, customPool) { }
        ...
        /// given collection.
        /// </summary>
        public RefpList(IEnumerable<T> collection, ClearMode clearMode, ArrayPool<T> customPool)
        {
            _pool = customPool ?? ArrayPool<T>.Shared;
            _clearOnFree = ShouldClear(clearMode);
...
#nullable restore
        ...
        public RefpList<TOutput> ConvertAll<TOutput>(Func<T, TOutput> converter)
        {
            if (converter == null)
            {
            ...
            var list = new RefpList<TOutput>(_size);
        ...
        public RefpList<T> FindAll(Func<T, bool> match)
        {
            if (match == null)
                ThrowHelper.ThrowArgumentNullException(ExceptionArgument.match);

            var list = new RefpList<T>();
            for (int i = 0; i < _size; i++)
            {
                if (match(_items[i]))
                {
        ...
        {
            private readonly RefpList<T> _list;
            private int _index;
            private readonly int _version;
            private T _current;

            internal Enumerator(RefpList<T> list)
            {
                _list = list;
                _index = 0;
