...
namespace fx.Collections
{
    ...
    /// <remarks>
    /// A <see cref="RefPDictionary{TKey,TValue}"/> can support multiple readers concurrently, as long as the collection is not modified. 
...
#endif
    public class RefPDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>,
        ISerializable, IDeserializationCallback, IDisposable where TKey: notnull
        
    {
        /// <summary>
        /// Used internally to control behavior of insertion into a <see cref="RefPDictionary{TKey, TValue}"/>.
        /// </summary>
...
#pragma warning restore IDE0044
        ...
        /// </summary>
        public RefPDictionary() : this( 0, ClearMode.Auto, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( ClearMode clearMode ) : this( 0, clearMode, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( int capacity ) : this( capacity, ClearMode.Auto, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( int capacity, ClearMode clearMode ) : this( capacity, clearMode, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEqualityComparer<TKey> comparer ) : this( 0, ClearMode.Auto, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( int capacity, IEqualityComparer<TKey>? comparer ) : this( capacity, ClearMode.Auto, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( ClearMode clearMode, IEqualityComparer<TKey>? comparer ) : this( 0, clearMode, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( int capacity, ClearMode clearMode, IEqualityComparer<TKey>? comparer )
        {
        ...
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IDictionary<TKey, TValue> dictionary ) : this( dictionary, ClearMode.Auto, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IDictionary<TKey, TValue> dictionary, ClearMode clearMode ) : this( dictionary, clearMode, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer ) : this( dictionary, ClearMode.Auto, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IDictionary<TKey, TValue> dictionary, ClearMode clearMode, IEqualityComparer<TKey>? comparer ) :
            this( dictionary?.Count ?? 0, clearMode, comparer )
        {
            if ( dictionary is null )
                ThrowHelper.ThrowArgumentNullException( ExceptionArgument.dictionary );

            // It is likely that the passed-in dictionary is RefPDictionary<TKey,TValue>. When this is the case,
            // avoid the enumerator allocation and overhead by looping through the entries array directly.
            // We only do this when dictionary is RefPDictionary<TKey,TValue> and not a subclass, to maintain
            // back-compat with subclasses that may have overridden the enumerator behavior.
            if ( dictionary is RefPDictionary<TKey, TValue> pooled )
            {
        ...
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEnumerable<KeyValuePair<TKey, TValue>> collection )
            : this( collection, ClearMode.Auto, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEnumerable<KeyValuePair<TKey, TValue>> collection, ClearMode clearMode )
            : this( collection, clearMode, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer )
            : this( collection, ClearMode.Auto, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEnumerable<KeyValuePair<TKey, TValue>> collection, ClearMode clearMode, IEqualityComparer<TKey>? comparer ) :
        ...
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEnumerable<(TKey key, TValue value)> collection )
            : this( collection, ClearMode.Auto, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEnumerable<(TKey key, TValue value)> collection, ClearMode clearMode )
            : this( collection, clearMode, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEnumerable<(TKey key, TValue value)> collection, IEqualityComparer<TKey>? comparer )
            : this( collection, ClearMode.Auto, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( IEnumerable<(TKey key, TValue value)> collection, ClearMode clearMode, IEqualityComparer<TKey>? comparer )
        ...
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( (TKey key, TValue value)[ ] array )
            : this( array.AsSpan(), ClearMode.Auto, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( (TKey key, TValue value)[ ] array, ClearMode clearMode )
            : this( array.AsSpan(), clearMode, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( (TKey key, TValue value)[ ] array, IEqualityComparer<TKey>? comparer )
            : this( array.AsSpan(), ClearMode.Auto, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( (TKey key, TValue value)[ ] array, ClearMode clearMode, IEqualityComparer<TKey>? comparer )
            : this( array.AsSpan(), clearMode, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( ReadOnlySpan<(TKey key, TValue value)> span )
            : this( span, ClearMode.Auto, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( ReadOnlySpan<(TKey key, TValue value)> span, ClearMode clearMode )
            : this( span, clearMode, null ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( ReadOnlySpan<(TKey key, TValue value)> span, IEqualityComparer<TKey>? comparer )
            : this( span, ClearMode.Auto, comparer ) { }

        /// <summary>
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        public RefPDictionary( ReadOnlySpan<(TKey key, TValue value)> span, ClearMode clearMode, IEqualityComparer<TKey>? comparer )
        ...
        /// Creates a new instance of RefPDictionary.
        /// </summary>
        protected RefPDictionary( SerializationInfo info, StreamingContext _ )
        {
...
#nullable restore
        ...
        {
            private readonly RefPDictionary<TKey, TValue> _dictionary;
            ...
            internal Enumerator( RefPDictionary<TKey, TValue> dictionary, int getEnumeratorRetType )
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection( RefPDictionary<TKey, TValue> dictionary )
            {
            ...
            public struct Enumerator : IEnumerator<TKey>, IEnumerator
            {
                ...
                internal Enumerator( RefPDictionary<TKey, TValue> dictionary )
                {
                    _dictionary = dictionary;
                    _version = dictionary._version;
                    _index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            /// </summary>
            public ValueCollection( RefPDictionary<TKey, TValue> dictionary )
            {
                if ( dictionary is null )
                {
                    ThrowHelper.ThrowArgumentNullException( ExceptionArgument.dictionary );
