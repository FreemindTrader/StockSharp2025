...
internal static class Class3
{
    ...
    {
        if( Assembly.GetCallingAssembly() != ( object ) typeof( Class3 ).Assembly || !Class3.smethod_1( ) )
        {
            return 0;
        }
        ...
        lock( Class3.class4_0 )
        {
            ...
            if( long_0 == 0L )
            {
                ...
                {
                    ulong num4 = num3 + byteList[index];
    ...
    private static bool smethod_2( )
    {
        ...
        Type type = ( object ) methodBase == null ? null : methodBase.DeclaringType;
        return type != ( object ) typeof( RuntimeMethodHandle ) && ( object ) type != null && type.Assembly == ( object ) typeof( Class3 ).Assembly;
    }
    ...
    private sealed class Class4
    {
        ...
        {
            if( Assembly.GetCallingAssembly() != ( object ) typeof( Class3.Class4 ).Assembly || !Class3.smethod_1( ) )
            {
                return 2918384;
            }
