...
// Type: StockSharp.Web.Api.Interfaces.IProductBugReportService
...
{
    public interface IProductBugReportService : IBaseEntityService<ProductBugReport>, IBaseService
    {
        Task<BaseEntitySet<ProductBugReport>> FindAsync(
          long skip = 0,
          long? count = 20,
          bool? deleted = null,
          string orderBy = null,
        ...
        Task<ProductBugReport> TryProposeAsync(
