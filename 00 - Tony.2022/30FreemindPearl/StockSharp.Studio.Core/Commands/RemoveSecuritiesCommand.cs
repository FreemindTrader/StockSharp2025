...
// Type: StockSharp.Studio.Core.Commands.RemoveSecuritiesCommand
...
{
    public class RemoveSecuritiesCommand : BaseStudioCommand
    {
        ...
        public RemoveSecuritiesCommand( IEnumerable<Security> securities )
        {
