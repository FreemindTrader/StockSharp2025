...
namespace StockSharp.FxConnectFXCM.Freemind
{
    ...
    public class DbClosedTrade : IFxcm, IEquatable<DbClosedTrade>
    {
        ...
        public DbClosedTrade( string mainLoginName, O2GClosedTradeRow row )
        {
            Id                      = 0;
            TradeID                 = row.TradeID;
            TradeIDRemain           = row.TradeIDRemain;
            TradeIDOrigin           = row.TradeIDOrigin;
            CloseOrderParties       = row.CloseOrderParties;
            CloseOrderRequestTXT    = row.CloseOrderRequestTXT;
            CloseOrderReqID         = row.CloseOrderReqID;
            CloseOrderID            = row.CloseOrderID;
            CloseTime               = row.CloseTime;
            CloseQuoteID            = row.CloseQuoteID;
            CloseRate               = row.CloseRate;
            OpenOrderParties        = row.OpenOrderParties;
            OpenOrderRequestTXT     = row.OpenOrderRequestTXT;
            OpenOrderReqID          = row.OpenOrderReqID;
            OpenOrderID             = row.OpenOrderID;
            OpenTime                = row.OpenTime;
            OpenQuoteID             = row.OpenQuoteID;
