...
//    {
//        public static CollectionViewModel< TEntity, TPrimaryKey, TUnitOfWork > 
...
//                // ForexDatabarsUnitOfWork.IForexDatabarsUnitOfWork.EURUSD01  will return IRepository<EURUSD01, DateTime>
//                // The input x => x.EURUSD01 is an lambda expression with the following signature.
//                // x          = TUnitOfWork
//                // x.EURUSD01 will return  IRepository< TEntity, TPrimaryKey >
//                Func< TUnitOfWork, IRepository< TEntity, TPrimaryKey > >   getRepositoryFunc,
...
//    where TUnitOfWork : IUnitOfWork
//    {
//        EntitiesChangeTracker< TPrimaryKey > ChangeTrackerWithKey
//        {
//            get 
//            { 
//                return ( EntitiesChangeTracker< TPrimaryKey > ) ChangeTracker; 
//            }
//        }
...
//            get 
//            { 
//                return ( IRepository< TEntity, TPrimaryKey > ) ReadOnlyRepository; 
//            }
//        }
