...
namespace StockSharp.Algo.History.Russian.Rts
{
    public class Competition : BaseHistorySource
    {
        ...
        public static IEnumerable< DateTime > AllYears
        {
            get
            {
                return ( IEnumerable< DateTime > ) Competition.dateTime_0;
            }
        }
...
security2.Id = this.competition_0.SecurityIdGenerator.GenerateId( security2.Code, security2.Board );
        ...
        DateTime date )
            {
                ...
                {
                    throw new ArgumentOutOfRangeException( nameof( date ), ( object )class134.dateTime_0, LocalizedStrings.Str2105 );
                }
                        ...
                        Competition.CompetitionYear.Class135 class135 = new Competition.CompetitionYear.Class135( )
            {
              class131_0 = class131
                        ...
                        {
                            throw new ArgumentException( LocalizedStrings.Str2106Params.Put( ( object )class135.class131_0.class134_0.string_0 ), nameof( member ) );
                        }

                        return ( IEnumerable< ExecutionMessage > ) ( ( IEnumerable< FtpListItem > ) class135.class131_0.ftpClient_0.GetListing( "pub/info/stats_contest/{0:yyyy}/{0:yyyyMMdd}".Put( ( object ) class135.class131_0.class134_0.dateTime_0 ) ) ).Where< FtpListItem >( new Func< FtpListItem, bool >( class135.method_0 ) ).SelectMany< FtpListItem, ExecutionMessage >( new Func< FtpListItem, IEnumerable< ExecutionMessage > >( class135.class131_0.method_0 ) ).ToArray< ExecutionMessage >( );
                    }
                    finally
                    {
                    ...
                    Competition.CompetitionYear.Class132 class132 = new Competition.CompetitionYear.Class132( )
          {
            class134_0 = class134
                    ...
                    class132.htmlDocument_0 = Competition.CompetitionYear.smethod_0( ).Load( "http://investor.moex.com/ru/statistics/{0}/?act=deals&nick={1}&date={2:yyyyMMdd}".Put( ( object ) this.Year.Year, ( object ) class132.class134_0.string_0, ( object ) class132.class134_0.dateTime_0 ) );
            ...
            private void method_1( )
            {
                if( this.Year.Year >= 2013 )
                {
                    using( System.Net.FtpClient.FtpClient ftpClient = new System.Net.FtpClient.FtpClient( ) )
                    {
                        ...
                        ftpClient.Connect( );
                        FtpListItem ftpListItem = ( ( IEnumerable< FtpListItem > ) ftpClient.GetListing( "pub/info/stats_contest/" ) ).FirstOrDefault< FtpListItem >( new Func< FtpListItem, bool >( this.method_2 ) );
                        if( ftpListItem == null )
                        {
                            throw new InvalidOperationException( "Для {0} года нет данных.".Put( ( object )this.Year.Year ) );
                        }

                        this.ienumerable_1 = ( IEnumerable< DateTime > ) ( ( IEnumerable< FtpListItem > ) ftpClient.GetListing( ftpListItem.FullName ) ).Where< FtpListItem >( Competition.CompetitionYear.Class136.func_2 ?? ( Competition.CompetitionYear.Class136.func_2 = new Func< FtpListItem, bool >( Competition.CompetitionYear.Class136.class136_0.method_2 ) ) ).Select< FtpListItem, DateTime >( Competition.CompetitionYear.Class136.func_3 ?? ( Competition.CompetitionYear.Class136.func_3 = new Func< FtpListItem, DateTime >( Competition.CompetitionYear.Class136.class136_0.method_3 ) ) ).Where< DateTime >( new Func< DateTime, bool >( this.method_3 ) ).ToArray< DateTime >( );
                        System.Net.FtpClient.FtpClient ftpClient_0 = ftpClient;
                        string string_0 = "pub/info/stats_contest/{0}/trader.csv".Put( ( object ) this.Year.Year );
                        ...
                        this.ienumerable_0 = ( IEnumerable< string > ) this.synchronizedDictionary_0.Keys.ToArray< string >( );
                    }
                }
                else
                {
                    HtmlDocument htmlDocument = Competition.CompetitionYear.smethod_0( ).Load( "http://investor.rts.ru/ru/statistics/{0}/default.aspx?act=deals".Put( ( object ) this.Year.Year ) );
                    if( this.Year.Year == 2012 )
                    {
                        this.ienumerable_0 = ( IEnumerable< string > ) Class38.smethod_5( ).Split( Environment.NewLine, true );
                    }
                    else
                    {
                        HtmlNode htmlNode = htmlDocument.DocumentNode.SelectSingleNode( "//select[@name='nick']" );
                        this.ienumerable_0 = ( htmlNode != null ? ( IEnumerable< string > ) htmlNode.Descendants( "option" ).Select< HtmlNode, string >( Competition.CompetitionYear.Class136.func_4 ?? ( Competition.CompetitionYear.Class136.func_4 = new Func< HtmlNode, string >( Competition.CompetitionYear.Class136.class136_0.method_4 ) ) ).ToArray< string >( ) : ( IEnumerable< string > ) ( string[] ) null ) ?? Enumerable.Empty< string >( );
                    }
                    this.ienumerable_1 = ( IEnumerable< DateTime > ) htmlDocument.DocumentNode.SelectSingleNode( "//select[@name='date']" ).Descendants( "option" ).Select< HtmlNode, DateTime >( Competition.CompetitionYear.Class136.func_5 ?? ( Competition.CompetitionYear.Class136.func_5 = new Func< HtmlNode, DateTime >( Competition.CompetitionYear.Class136.class136_0.method_5 ) ) ).OrderBy< DateTime >( ).ToArray< DateTime >( );
                }
            }
                ...
                return new HtmlWeb( )
        {
                    ...
                    return ( IEnumerable< ExecutionMessage > ) CultureInfo.InvariantCulture.DoInCulture< ExecutionMessage[] >( new Func< ExecutionMessage[] >( new Competition.CompetitionYear.Class133( )
          {
            ...
            private sealed class Class132
            {
                ...
                internal IEnumerable< ExecutionMessage > method_0( )
                {
                    ...
                    return ( IEnumerable< ExecutionMessage > ) source.Last< HtmlNode >( ).Descendants( "tr" ).Skip< HtmlNode >( 1 ).Select< HtmlNode, ExecutionMessage >( this.func_0 ?? ( this.func_0 = new Func< HtmlNode, ExecutionMessage >( this.method_1 ) ) ).ToArray< ExecutionMessage >( );
                }
                    ...
                    return new ExecutionMessage( )
          {
            ...
            SecurityId = this.class134_0.competitionYear_0.method_0( this.class134_0.isecurityStorage_0, string_0 ).ToSecurityId( ( SecurityIdGenerator ) null ),
            TradePrice = new Decimal?( num2 ),
            OrderPrice = num2,
            OrderVolume = new Decimal?( Math.Abs( num1 ) ),
            ServerTime = ( this.class134_0.dateTime_0 + HttpUtility.HtmlDecode( array[ 4 + this.int_1 ].InnerText ).ReplaceWhiteSpaces( ).Trim( ).ToTimeSpan( "c", ( CultureInfo ) null ) ).ApplyTimeZone( TimeHelper.Moscow ),
          ...
          ZipArchiveEntry zipArchiveEntry_0 )
                {
                    ...
                    {
                        return ( IEnumerable< ExecutionMessage > )stream.EnumerateLines( ( Encoding )null ).Select< string, ExecutionMessage >( this.func_0 ?? ( this.func_0 = new Func< string, ExecutionMessage >( this.method_1 ) ) ).ToArray< ExecutionMessage >( );
                    }
                }
                ...
                internal ExecutionMessage method_1( string string_1 )
                {
                    ...
                    SecurityId securityId = this.competitionYear_0.method_0( this.isecurityStorage_0, strArray[ 1 ].Trim( ) ).ToSecurityId( ( SecurityIdGenerator ) null );
                    ...
                    return new ExecutionMessage( )
          {
            ...
            ServerTime = strArray[ 0 ].ToDateTime( "yyyy-MM-dd HH:mm:ss.fff", ( CultureInfo ) null ).ApplyTimeZone( TimeHelper.Moscow ),
            ...
            private sealed class Class135
            {
                ...
                {
                    return ftpListItem_0.Name.ContainsIgnoreCase( "_{0}.zip".Put( ( object ) this.nullable_0 ) );
                }
            }
      ...
      private sealed class Class136
      {
          ...
          {
              if( ( Equatable< ExchangeBoard > ) security_0.Board != ExchangeBoard.Finam )
              {
                  return ( Equatable< ExchangeBoard > )security_0.Board != ExchangeBoard.Forts;
              }
          ...
          {
              return ( Equatable< ExchangeBoard > ) security_0.Board != ExchangeBoard.Finam;
          }
          ...
          {
              return ftpListItem_0.Name.ToDateTime( "yyyyMMdd", ( CultureInfo ) null );
          }
          ...
          {
              return htmlNode_0.Attributes[ "value" ].Value.ToDateTime( "yyyyMMdd", ( CultureInfo ) null );
          }
      }
        }
    }
